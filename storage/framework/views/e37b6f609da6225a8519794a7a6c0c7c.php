...
<?php $__env->startSection('title', __('frontend.invoice') . ' #' . $invoice->invoice_number . ' - ' . config('app.name')); ?>
...
<div class="min-h-screen py-8 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Back Button -->
        <div class="mb-6">
            <a href="<?php echo e(route('client.invoices')); ?>" class="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                ...
                <span><?php echo e(__('frontend.back_to_invoices')); ?></span>
            </a>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 px-8 py-8 bg-gray-50/50 dark:bg-gray-900/50">
                <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                    <div class="space-y-3">
                        <div>
                            <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2"><?php echo e(__('frontend.invoice')); ?></p>
                        ...
                        <?php elseif($invoice->status === 'cancelled'): ?>
                            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-full bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400">
                                ...
                                <?php echo e(__('frontend.cancelled')); ?>
                    ...
                    <div class="flex gap-2">
                        <?php if($invoice->status !== 'paid' && $canRetryPayment): ?>
                        <button type="button" onclick="openPaymentModal()" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md">
                            ...
                            <span><?php echo e(__('frontend.pay_now')); ?></span>
                        </button>
                        <?php elseif($invoice->status !== 'paid' && !$canRetryPayment): ?>
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('client.invoices.download', $invoice->id)); ?>" target="_blank" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            <span><?php echo e(__('frontend.download_pdf')); ?></span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <?php if($hasDomainRegistration && !$canRetryPayment && $invoice->status !== 'paid'): ?>
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 pb-8 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div>
                        <h2 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">
                            <?php echo e(__('frontend.pay_to')); ?>

                        </h2>
                        
                        <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-5 space-y-2.5">
                            <div class="text-base font-semibold text-gray-900 dark:text-white">
                                <?php echo e(config('app.name', 'Company Name')); ?>

                            </div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                <span class="font-medium"><?php echo e(__('frontend.reg_no')); ?>:</span> 90088
                            </div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                <span class="font-medium"><?php echo e(__('frontend.vat')); ?>:</span> 755-552-334
                            </div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg px-4 py-3.5 border-l-2 border-blue-500">
                        <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1.5">
                            <?php echo e(__('frontend.invoice_date')); ?>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg px-4 py-3.5 border-l-2 border-purple-500">
                        <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1.5">
                            <?php echo e(__('frontend.due_date')); ?>
                    ...
                    <div class="bg-green-50 dark:bg-green-900/20 rounded-lg px-4 py-3.5 border-l-2 border-green-500">
                        <div class="text-xs font-semibold text-green-700 dark:text-green-400 uppercase tracking-wide mb-1.5">
                            <?php echo e(__('frontend.paid_date')); ?>

                        </div>
                        <div class="text-sm font-semibold text-green-700 dark:text-green-400">
                            <?php echo e($invoice->paid_at->format('M d, Y')); ?>
                ...
                <div class="mb-8">
                    <h2 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">
                        <?php echo e(__('frontend.order_items')); ?>
                            ...
                            <thead class="bg-gray-50 dark:bg-gray-900/50">
                                <tr>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                                        <?php echo e(__('frontend.item')); ?>

                                    </th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                                        <?php echo e(__('frontend.qty')); ?>
                                ...
                                <tr>
                                    <td class="px-4 py-3">
                                        <div class="text-sm text-gray-900 dark:text-white">
                                            <?php echo e($item->product_name ?? $item->item_name ?? 'N/A'); ?>
                ...
                <div class="flex justify-end mb-8">
                    <div class="w-full md:w-96 bg-gray-50 dark:bg-gray-900/50 rounded-lg p-6 space-y-3">
                        <div class="flex justify-between py-2 text-sm">
                            <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('frontend.subtotal')); ?></span>
                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($invoice->subtotal, 2)); ?> <?php echo e($invoice->currency ?? 'EGP'); ?></span>
                        </div>
                        
                        <?php if($invoice->tax > 0): ?>
                        <div class="flex justify-between py-2 text-sm">
                            <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('frontend.tax')); ?></span>
                            <span class="font-medium text-gray-900 dark:text-white"><?php echo e(number_format($invoice->tax, 2)); ?> <?php echo e($invoice->currency ?? 'EGP'); ?></span>
                        </div>
                        <?php endif; ?>
                        
                        <?php if($invoice->discount > 0): ?>
                        <div class="flex justify-between py-2 text-sm">
                            <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('frontend.discount')); ?></span>
                            <span class="font-medium text-green-600 dark:text-green-400">-<?php echo e(number_format($invoice->discount, 2)); ?> <?php echo e($invoice->currency ?? 'EGP'); ?></span>
                        </div>
                        <?php endif; ?>
                        
                        <div class="flex justify-between pt-4 mt-3 border-t-2 border-gray-300 dark:border-gray-600">
                            <span class="text-base font-bold text-gray-900 dark:text-white"><?php echo e(__('frontend.total')); ?></span>
                            <span class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e(number_format($invoice->total, 2)); ?> <?php echo e($invoice->currency ?? 'EGP'); ?></span>
                        </div>
                        
                        <?php if($invoice->paid_amount > 0): ?>
                        <div class="flex justify-between py-2.5 text-sm bg-green-100/80 dark:bg-green-900/30 px-4 -mx-6 mt-3 rounded-lg">
                            <span class="font-medium text-green-700 dark:text-green-400"><?php echo e(__('frontend.paid_amount')); ?></span>
                            <span class="font-bold text-green-700 dark:text-green-400"><?php echo e(number_format($invoice->paid_amount, 2)); ?> <?php echo e($invoice->currency ?? 'EGP'); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex justify-between py-2.5 text-sm bg-red-100/80 dark:bg-red-900/30 px-4 -mx-6 rounded-lg">
                            <span class="font-medium text-red-700 dark:text-red-400"><?php echo e(__('frontend.balance_due')); ?></span>
                            <span class="font-bold text-red-700 dark:text-red-400"><?php echo e(number_format($invoice->balance, 2)); ?> <?php echo e($invoice->currency ?? 'EGP'); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                    <h2 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">
                        <?php echo e(__('frontend.transaction_history')); ?>
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-900/50">
                                <tr>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                                        <?php echo e(__('frontend.date')); ?>

                                    </th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                                        <?php echo e(__('frontend.gateway')); ?>

                                    </th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                                        <?php echo e(__('frontend.transaction_id')); ?>

                                    </th>
                                    <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                                        <?php echo e(__('frontend.amount')); ?>
...
<div id="paymentModal" class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm z-50 hidden items-center justify-center p-4">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full transform transition-all">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(__('frontend.select_payment_method')); ?></h3>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><?php echo e(__('frontend.choose_payment_method')); ?></p>
        </div>
        
        <form id="paymentForm" action="<?php echo e(route('order.retry-payment', $invoice->order_id)); ?>" method="POST" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-3">
                ...
                <label class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-green-500 dark:hover:border-green-500 cursor-pointer transition-all group">
                    ...
                    <div class="ml-3 <?php echo e(app()->getLocale() == 'ar' ? 'mr-3' : 'ml-3'); ?> flex-1">
                        <div class="flex items-center gap-2">
                            <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                            </svg>
                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(__('frontend.account_wallet')); ?></span>
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            <?php if(app()->getLocale() == 'ar'): ?>
                                الرصيد المتاح: $<?php echo e(number_format(Auth::guard('client')->user()->wallet_balance ?? 0, 2)); ?>

                            <?php else: ?>
                                Available Balance: $<?php echo e(number_format(Auth::guard('client')->user()->wallet_balance ?? 0, 2)); ?>
                ...
                <label class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-500 dark:hover:border-blue-500 cursor-pointer transition-all group">
                    ...
                    <div class="ml-3 <?php echo e(app()->getLocale() == 'ar' ? 'mr-3' : 'ml-3'); ?> flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(__('frontend.credit_card')); ?></span>
                        </div>
                ...
                <label class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-500 dark:hover:border-blue-500 cursor-pointer transition-all group">
                    ...
                    <div class="<?php echo e(app()->getLocale() == 'ar' ? 'mr-3' : 'ml-3'); ?> flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(__('frontend.fawry')); ?></span>
                        </div>
                ...
                <label class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-500 dark:hover:border-blue-500 cursor-pointer transition-all group">
                    ...
                    <div class="<?php echo e(app()->getLocale() == 'ar' ? 'mr-3' : 'ml-3'); ?> flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(__('frontend.mobile_wallet')); ?></span>
                        </div>
            ...
            <div class="flex gap-3 mt-6">
                ...
                <button type="submit" class="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-lg transition-all">
                    <?php echo e(__('frontend.proceed_payment')); ?>
...
<?php echo $__env->make('frontend.client.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\resources\views/frontend/client/invoices/show.blade.php ENDPATH**/ ?>