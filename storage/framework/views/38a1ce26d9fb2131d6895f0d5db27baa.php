...
<div class="min-h-screen bg-slate-50/50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="flex-1 space-y-4">
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <span class="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-slate-200 rounded-full text-xs font-semibold text-slate-700 shadow-sm">
                                <span class="w-2 h-2 rounded-full <?php echo e($status['bg']); ?> ring-4 <?php echo e($status['ring']); ?>"></span>
                        ...
                        <!-- Title -->
                        <h1 class="text-2xl lg:text-3xl font-bold text-slate-900 leading-tight"><?php echo e($ticket->subject); ?></h1>
                        ...
                        <div class="flex flex-wrap items-center gap-6 text-sm">
                            <div class="flex items-center gap-2 text-slate-500">
                                ...
                                <span class="font-mono font-medium text-slate-700"><?php echo e($ticket->ticket_number); ?></span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 text-slate-500">
                                ...
                                <span class="font-medium text-slate-700"><?php echo e($ticket->department->name); ?></span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 text-slate-500">
                                ...
                                <span><?php echo e($ticket->created_at->diffForHumans()); ?></span>
                            </div>
                            ...
                            <?php if($ticket->service): ?>
                                <div class="flex items-center gap-2 text-slate-500">
                                    ...
                                    <span class="font-medium text-slate-700"><?php echo e($ticket->service->domain ?? $ticket->service->service_name); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="relative">
            <!-- Timeline Line -->
            <div class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'right-6' : 'left-6'); ?> top-0 bottom-0 w-px bg-gradient-to-b from-slate-200 via-slate-200 to-transparent hidden lg:block"></div>
            
            <div class="space-y-6">
                <!-- Original Message -->
                <div class="relative">
                    <div class="lg:<?php echo e(app()->getLocale() == 'ar' ? 'pr-16' : 'pl-16'); ?>">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-slate-700 to-slate-900 flex items-center justify-center shadow-lg shadow-slate-900/20">
                                            <span class="text-white font-bold text-sm"><?php echo e(strtoupper(substr($ticket->client->first_name, 0, 1) . substr($ticket->client->last_name, 0, 1))); ?></span>
                                        </div>
                                        <div>
                                            <h4 class="font-semibold text-slate-900"><?php echo e($ticket->client->first_name); ?> <?php echo e($ticket->client->last_name); ?></h4>
                                            <p class="text-xs text-slate-500"><?php echo e($ticket->created_at->format('M d, Y • h:i A')); ?></p>
                                        </div>
                                    </div>
                                    <span class="px-3 py-1 bg-slate-100 text-slate-600 text-xs font-medium rounded-full">
                                        <?php echo e(app()->getLocale() == 'ar' ? 'الرسالة الأصلية' : 'Original'); ?>
                                ...
                                <?php if($ticket->attachments->count() > 0): ?>
                                    <div class="mt-6 pt-6 border-t border-slate-100">
                                        <h5 class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2">
                                            ...
                                            <?php echo e(__('tickets.attachments')); ?> (<?php echo e($ticket->attachments->count()); ?>)
                                        </h5>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            <?php $__currentLoopData = $ticket->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    ...
                                                    $isPdf = $ext === 'pdf';
                                                ?>
                                                <a href="<?php echo e(route('client.tickets.attachment.download', $attachment)); ?>" 
                                                   class="group flex items-center gap-3 p-3 bg-slate-50 hover:bg-blue-50 border border-slate-200 hover:border-blue-300 rounded-xl transition-all duration-200">
                                                    <div class="w-10 h-10 rounded-lg <?php echo e($isImage ? 'bg-purple-100' : ($isPdf ? 'bg-red-100' : 'bg-slate-100')); ?> flex items-center justify-center flex-shrink-0">
                                                        <?php if($isImage): ?>
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <p class="text-sm font-medium text-slate-700 group-hover:text-blue-700 truncate"><?php echo e($attachment->filename); ?></p>
                                                        <p class="text-xs text-slate-400"><?php echo e(strtoupper($ext)); ?> • <?php echo e($attachment->human_size ?? 'N/A'); ?></p>
                                                    </div>
                ...
                <!-- Replies -->
                <?php $__currentLoopData = $ticket->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative">

                        
                        <div class="lg:<?php echo e(app()->getLocale() == 'ar' ? 'pr-16' : 'pl-16'); ?>">
                            <div class="bg-white rounded-2xl shadow-sm border <?php echo e($reply->isFromAdmin() ? 'border-blue-200/80 ring-1 ring-blue-100' : 'border-slate-200/80'); ?> overflow-hidden hover:shadow-md transition-shadow duration-300">
                                <!-- Reply Header -->
                                <div class="px-6 py-4 <?php echo e($reply->isFromAdmin() ? 'bg-gradient-to-r from-blue-50 via-indigo-50/30 to-white' : 'bg-gradient-to-r from-slate-50 to-white'); ?> border-b <?php echo e($reply->isFromAdmin() ? 'border-blue-100' : 'border-slate-100'); ?>">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            <div class="relative">
                                                <?php if($reply->isFromAdmin()): ?>
                                                    <div class="w-12 h-12 rounded-full border-2 border-blue-200 shadow-lg shadow-blue-500/10 overflow-hidden">
                                                        <img src="<?php echo e(asset('logo/pro Gineous Blue_defult icon.png')); ?>" alt="Support" class="w-full h-full object-cover rounded-full">
                                                    </div>
                                                    <div class="absolute -bottom-1 -<?php echo e(app()->getLocale() == 'ar' ? 'left' : 'right'); ?>-1 w-5 h-5 rounded-full bg-blue-500 border-2 border-white shadow-sm flex items-center justify-center">
                                            ...
                                            <div>
                                                <div class="flex items-center gap-2">
                                                    <h4 class="font-semibold <?php echo e($reply->isFromAdmin() ? 'text-blue-900' : 'text-slate-900'); ?>">
                                                        <?php echo e($reply->isFromAdmin() ? ($reply->user->name ?? __('tickets.support_team')) : ($ticket->client->first_name . ' ' . $ticket->client->last_name)); ?>
                                                    ...
                                                    <?php if($reply->isFromAdmin()): ?>
                                                        <span class="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full">
                                                            ...
                                                            <?php echo e(app()->getLocale() == 'ar' ? 'الدعم الفني' : 'Support'); ?>

                                                        </span>
                                                    <?php endif; ?>
                                                </div>
                                                <p class="text-xs text-slate-500"><?php echo e($reply->created_at->format('M d, Y • h:i A')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Reply Body -->
                                <div class="p-6">
                                    <div class="prose prose-slate prose-sm max-w-none leading-relaxed <?php echo e($reply->isFromAdmin() ? 'prose-blue' : ''); ?>">
                                    ...
                                    <?php if($reply->isFromAdmin()): ?>
                                        <div class="mt-6 pt-4 border-t <?php echo e($reply->isFromAdmin() ? 'border-blue-100' : 'border-slate-100'); ?>">
                                            <?php if($reply->rating): ?>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <?php if($reply->rating === 'helpful'): ?>
                                                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounded-xl text-sm text-emerald-700">
                                                            ...
                                                            <?php echo e(__('tickets.you_rated_helpful')); ?>
                                                    ...
                                                    <?php else: ?>
                                                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 border border-slate-200 rounded-xl text-sm text-slate-600">
                                                            ...
                                                            <?php echo e(__('tickets.you_rated_not_helpful')); ?>

                                                        </div>
                                                    <?php endif; ?>
                                                    <span class="text-xs text-slate-400"><?php echo e(__('tickets.thanks_for_feedback')); ?></span>
                                                </div>
                                            <?php else: ?>
                                                
                                                <div class="flex items-center gap-4">
                                                    <span class="text-sm text-slate-500"><?php echo e(__('tickets.was_helpful')); ?></span>
                                                    <div class="flex items-center gap-2">
                                                        <form action="<?php echo e(route('client.tickets.reply.rate', $reply)); ?>" method="POST" class="inline">
                                                            <?php echo csrf_field(); ?>
                                    ...
                                    <?php if($reply->attachments->count() > 0): ?>
                                        <div class="mt-6 pt-6 border-t <?php echo e($reply->isFromAdmin() ? 'border-blue-100' : 'border-slate-100'); ?>">
                                            <h5 class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13"/>
                                                </svg>
                                                <?php echo e(__('tickets.attachments')); ?> (<?php echo e($reply->attachments->count()); ?>)
                                            </h5>
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div class="mt-8 bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-slate-50 to-white border-b border-slate-100">
                    <h3 class="font-semibold text-slate-900 flex items-center gap-3">
                        ...
                        <?php echo e(app()->getLocale() == 'ar' ? 'أضف رداً' : 'Write a Reply'); ?>

                    </h3>
                </div>
                
                <div class="p-6">
                    <form action="<?php echo e(route('client.tickets.reply', $ticket)); ?>" method="POST" enctype="multipart/form-data" x-data="{ files: [] }">
                        <?php echo csrf_field(); ?>
                        
                        <div class="relative">
                            <textarea name="message" rows="5" required
                                      placeholder="<?php echo e(__('tickets.reply_placeholder')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-4 border-t border-slate-100">
                            <div class="flex items-center gap-3">
                                <label class="cursor-pointer">
                                    ...
                                    <span class="inline-flex items-center gap-2 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium rounded-xl transition-all duration-200 cursor-pointer">
                                        ...
                                        <?php echo e(app()->getLocale() == 'ar' ? 'إرفاق ملفات' : 'Attach files'); ?>
                            ...
                            <button type="submit" 
                                ...
                                <svg class="w-5 h-5 transition-transform duration-300 group-hover:scale-110 <?php echo e(app()->getLocale() == 'ar' ? '-rotate-90' : 'rotate-90'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z"/>
                                </svg>
                                <?php echo e(__('tickets.submit_reply')); ?>
        ...
        <?php else: ?>
            ...
            <div class="mt-8 bg-white rounded-2xl shadow-sm border border-slate-200/80 p-8 lg:p-12 text-center">
                <div class="max-w-md mx-auto">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-2"><?php echo e(app()->getLocale() == 'ar' ? 'تم إغلاق هذه التذكرة' : 'This Ticket is Closed'); ?></h3>
                    <p class="text-slate-500 mb-6"><?php echo e(app()->getLocale() == 'ar' ? 'شكراً لتواصلك معنا. إذا كنت بحاجة إلى مساعدة إضافية، يرجى فتح تذكرة جديدة.' : 'Thank you for contacting us. If you need further assistance, please open a new ticket.'); ?></p>
                    <a href="<?php echo e(route('client.tickets.create')); ?>" 
                       class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30">
                        ...
                        <?php echo e(app()->getLocale() == 'ar' ? 'فتح تذكرة جديدة' : 'Open New Ticket'); ?>
...
<div id="closeTicketModal" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-md overflow-hidden text-<?php echo e(app()->getLocale() == 'ar' ? 'right' : 'left'); ?> bg-white shadow-2xl rounded-2xl">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-slate-900" id="modal-title">
                            <?php echo e(app()->getLocale() == 'ar' ? 'إغلاق التذكرة' : 'Close Ticket'); ?>

                        </h3>
                        <p class="text-sm text-slate-500">#<?php echo e($ticket->ticket_number); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-5">
                <p class="text-slate-600 leading-relaxed">
                    <?php echo e(app()->getLocale() == 'ar' ? 'هل أنت متأكد من إغلاق هذه التذكرة؟ يمكنك إعادة فتحها لاحقاً إذا كنت بحاجة إلى مساعدة إضافية.' : 'Are you sure you want to close this ticket? You can reopen it later if you need further assistance.'); ?>
            ...
            <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                ...
                <form action="<?php echo e(route('client.tickets.close', $ticket)); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
                    <button type="submit" 
                        ...
                        <?php echo e(app()->getLocale() == 'ar' ? 'نعم، إغلاق التذكرة' : 'Yes, Close Ticket'); ?>
...
<script>
    ...
    document.getElementById('file-input')?.addEventListener('change', function() {
        ...
        if (count > 0) {
            countEl.textContent = count + ' <?php echo e(app()->getLocale() == "ar" ? "ملف مرفق" : "file(s) attached"); ?>';
        } else {
            countEl.textContent = '';
        }
    });
...
<?php echo $__env->make('frontend.client.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\resources\views/frontend/client/tickets/show.blade.php ENDPATH**/ ?>