...
<section class="relative pt-32 pb-24 overflow-hidden min-h-[85vh] flex items-center glass-hero-section">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <!-- Floating Glass Orbs -->
        <div class="absolute top-0 <?php echo e(app()->getLocale() == 'ar' ? 'left-0' : 'right-0'); ?> w-96 h-96 bg-blue-400/20 dark:bg-blue-500/10 rounded-full blur-3xl animate-float"></div>
        <div class="absolute bottom-0 <?php echo e(app()->getLocale() == 'ar' ? 'right-0' : 'left-0'); ?> w-[500px] h-[500px] bg-cyan-400/15 dark:bg-cyan-500/10 rounded-full blur-3xl animate-float animation-delay-2000"></div>
        ...
        <!-- Glass Shards Effect -->
        <div class="absolute top-20 <?php echo e(app()->getLocale() == 'ar' ? 'right-20' : 'left-20'); ?> w-32 h-32 bg-blue-400/10 dark:bg-blue-500/5 rounded-2xl rotate-12 backdrop-blur-sm animate-float animation-delay-1000"></div>
        <div class="absolute top-40 <?php echo e(app()->getLocale() == 'ar' ? 'left-40' : 'right-40'); ?> w-24 h-24 bg-cyan-400/10 dark:bg-cyan-500/5 rounded-2xl -rotate-12 backdrop-blur-sm animate-float"></div>
        <div class="absolute bottom-40 <?php echo e(app()->getLocale() == 'ar' ? 'right-60' : 'left-60'); ?> w-28 h-28 bg-blue-300/10 dark:bg-blue-600/5 rounded-2xl rotate-45 backdrop-blur-sm animate-float animation-delay-2000"></div>
        
        <!-- Sparkle Dots -->
        <div class="absolute top-20 <?php echo e(app()->getLocale() == 'ar' ? 'right-20' : 'left-20'); ?> w-2 h-2 bg-blue-400/60 dark:bg-blue-300/40 rounded-full animate-ping"></div>
        <div class="absolute top-40 <?php echo e(app()->getLocale() == 'ar' ? 'left-40' : 'right-40'); ?> w-3 h-3 bg-cyan-400/60 dark:bg-cyan-300/40 rounded-full animate-ping animation-delay-1000"></div>
        <div class="absolute bottom-40 <?php echo e(app()->getLocale() == 'ar' ? 'right-60' : 'left-60'); ?> w-2 h-2 bg-blue-300/60 dark:bg-blue-200/40 rounded-full animate-ping animation-delay-2000"></div>
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-5xl mx-auto text-center">
            ...
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-black text-slate-900 dark:text-white mb-6 leading-tight animate-fade-in-up drop-shadow-sm">
                <?php echo e(__('frontend.find_your_perfect_domain')); ?>
            ...
            <p class="text-xl md:text-2xl text-slate-700 dark:text-slate-300 mb-12 animate-fade-in-up animation-delay-200 font-medium drop-shadow-sm">
                <?php echo e(__('frontend.domain_search_subtitle')); ?>
            ...
            <div class="animate-fade-in-up animation-delay-400">
                <div class="relative glass-card rounded-3xl shadow-2xl p-6 max-w-4xl mx-auto border border-white/20 dark:border-slate-700/50">
                    ...
                    <div x-data="{ activeTab: 'search' }" class="w-full">
                        ...
                        <div class="flex gap-3 mb-6 p-2 bg-slate-100/50 dark:bg-slate-800/50 rounded-2xl backdrop-blur-sm">
                            ...
                            >
                                ...
                                <span><?php echo e(__('frontend.search_domain')); ?></span>
                            </button>
                            <button 
                            ...
                            >
                                ...
                                <span><?php echo e(__('frontend.transfer_domain')); ?></span>
                            </button>
                        </div>
                        ...
                        <div x-show="activeTab === 'search'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                            <form id="domainSearchForm" class="flex flex-col md:flex-row gap-3">
                                ...
                                <div class="flex-1 relative">
                                    <div class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'right-6' : 'left-6'); ?> top-1/2 -translate-y-1/2 pointer-events-none">
                                ...
                                >
                                    ...
                                    <span id="searchText"><?php echo e(__('frontend.search_now')); ?></span>
                                </button>
                            </form>
                        ...
                        <div x-show="activeTab === 'transfer'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                            <form id="domainTransferForm" class="space-y-4">
                                ...
                                <div class="flex flex-col md:flex-row gap-3">
                                    <div class="flex-1 relative">
                                        ...
                                        <input 
                                            ...
                                            placeholder="<?php echo e(__('frontend.enter_domain_to_transfer')); ?>" 
                                            class="w-full <?php echo e(app()->getLocale() == 'ar' ? 'pr-14 pl-6' : 'pl-14 pr-6'); ?> py-5 bg-slate-50 dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent text-lg font-medium transition-all"
                                            required
                                        >
                                    </div>
                                    <div class="flex-1 relative">
                                        ...
                                        <input 
                                            ...
                                            name="auth_code"
                                            id="authCodeInput"
                                            placeholder="<?php echo e(__('frontend.enter_auth_code')); ?>" 
                                            class="w-full <?php echo e(app()->getLocale() == 'ar' ? 'pr-14 pl-6' : 'pl-14 pr-6'); ?> py-5 bg-slate-50 dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent text-lg font-medium transition-all"
                                            required
                                        >
                                    </div>
                                ...
                                >
                                    ...
                                    <span id="transferText"><?php echo e(__('frontend.start_transfer')); ?></span>
                                </button>
                            </form>
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-3 mt-6 px-3">
                        <span class="text-sm text-slate-700 dark:text-slate-300 font-semibold"><?php echo e(__('frontend.popular_tlds')); ?></span>
                        <div class="flex flex-wrap gap-3 justify-center">
                            ...
                            <?php $__currentLoopData = $featuredDomains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $domain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $price = number_format($domain->progineous_register, 2);
                                    $badgeClass = $badgeClasses[$index % count($badgeClasses)];
                                ?>
                                <a href="#" onclick="document.getElementById('domainInput').value='<?php echo e($domain->tld); ?>'; document.getElementById('domainSearchForm').requestSubmit(); return false;" 
                                   class="group px-4 py-2 <?php echo e($badgeClass); ?> rounded-xl text-sm font-bold border-2 transition-all hover:scale-105 hover:shadow-lg cursor-pointer">
                                    <span class="flex items-center gap-2">
                                        <?php if(app()->getLocale() == 'ar'): ?>
                                            <?php echo e($domain->tld); ?>.
                                        <?php else: ?>
                                            .<?php echo e($domain->tld); ?>

                                        <?php endif; ?>
                                        <span class="text-xs opacity-70">$<?php echo e($price); ?>/y</span>
                                    </span>
                                </a>
                ...
                <div class="flex flex-wrap items-center justify-center gap-6 mt-8 text-slate-700 dark:text-slate-300">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="font-semibold"><?php echo e(__('frontend.free_whois_privacy')); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <span class="font-semibold"><?php echo e(__('frontend.easy_dns_management')); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 rounded-full glass-icon bg-blue-500/20 dark:bg-blue-400/20 backdrop-blur-sm flex items-center justify-center border border-blue-400/30">
                            <svg class="w-5 h-5 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="font-semibold"><?php echo e(__('frontend.instant_activation')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 animate-fade-in-up animation-delay-600">
                <div class="text-center glass-stat p-6 rounded-2xl backdrop-blur-sm border border-white/20 dark:border-slate-700/30">
                    ...
                    <div class="text-slate-700 dark:text-slate-300 font-semibold"><?php echo e(__('frontend.domain_extensions')); ?></div>
                </div>
                <div class="text-center glass-stat p-6 rounded-2xl backdrop-blur-sm border border-white/20 dark:border-slate-700/30">
                    <div class="text-5xl font-black text-cyan-600 dark:text-cyan-400 mb-2">10K+</div>
                    <div class="text-slate-700 dark:text-slate-300 font-semibold"><?php echo e(__('frontend.registered_domains')); ?></div>
                </div>
                <div class="text-center glass-stat p-6 rounded-2xl backdrop-blur-sm border border-white/20 dark:border-slate-700/30">
                    <div class="text-5xl font-black text-blue-600 dark:text-blue-400 mb-2">24/7</div>
                    <div class="text-slate-700 dark:text-slate-300 font-semibold"><?php echo e(__('frontend.expert_support')); ?></div>
                </div>
                <div class="text-center glass-stat p-6 rounded-2xl backdrop-blur-sm border border-white/20 dark:border-slate-700/30">
                    <div class="text-5xl font-black text-cyan-600 dark:text-cyan-400 mb-2">99.9%</div>
                    <div class="text-slate-700 dark:text-slate-300 font-semibold"><?php echo e(__('frontend.uptime_guarantee')); ?></div>
                </div>
            </div>
        </div>
    </div>
