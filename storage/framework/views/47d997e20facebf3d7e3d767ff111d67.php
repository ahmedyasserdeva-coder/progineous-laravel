...
<?php $__env->startSection('title', __('frontend.home') . ' - ' . config('app.name')); ?>
<?php $__env->startSection('description', __('frontend.hero_subtitle')); ?>
    ...
    <div id="searchResultsPanel" class="absolute left-0 right-0 bg-white rounded-t-3xl shadow-2xl pointer-events-auto" style="top: 100%; height: calc(100vh - 60px); transition: top 1.2s cubic-bezier(0.16, 1, 0.3, 1);">
        ...
        <div class="sticky top-0 bg-white rounded-t-3xl border-b border-gray-100 px-6 py-4 z-10">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h3 class="text-lg font-bold text-gray-900"><?php echo e(__('frontend.domain_search_results')); ?></h3>
            ...
            <form id="modalDomainSearchForm" class="flex items-center gap-2">
                <div class="relative flex-1">
                    <div class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'right-4' : 'left-4'); ?> top-1/2 -translate-y-1/2 pointer-events-none">
                    ...
                    <input 
                        type="text" 
                        id="modalDomainInput" 
                        placeholder="<?php echo e(__('frontend.search_another_domain')); ?>" 
                        class="w-full <?php echo e(app()->getLocale() == 'ar' ? 'pr-12 pl-4' : 'pl-12 pr-4'); ?> py-2.5 bg-gray-50 border border-gray-200 rounded-full text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                    >
                </div>
                <button 
                    type="submit"
        ...
        <div id="searchResultsLoading" class="hidden p-8 text-center">
            ...
            <p class="mt-4 text-gray-600"><?php echo e(__('frontend.searching')); ?>...</p>
        </div>
        ...
        <form id="stickyDomainSearchForm" class="flex items-center w-full md:w-auto">
            ...
            <div class="relative w-full md:w-[320px] lg:w-[400px] xl:w-[500px]">
                ...
                <input 
                    ...
                    class="w-full <?php echo e(app()->getLocale() == 'ar' ? 'pr-24 pl-4' : 'pl-12 pr-24'); ?> py-2.5 bg-white border border-gray-200 rounded-full text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                >
                <button 
                    type="submit"
                    class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'left-1' : 'right-1'); ?> top-1/2 -translate-y-1/2 px-4 py-1.5 bg-blue-500 hover:bg-blue-600 text-white font-medium text-sm rounded-full transition-all"
                >
                    <?php echo e(__('frontend.search')); ?>
        ...
        <div class="flex items-center gap-2 md:gap-3 flex-wrap justify-center lg:justify-end">
            <?php
                ...
                $displayDomains = $featuredDomains->count() > 0 
                    ...
                    : collect($defaultTlds);
            ?>
            <?php $__currentLoopData = $displayDomains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="px-3 md:px-4 py-1.5 md:py-2 rounded-full text-xs md:text-sm bg-sky-50">
                    <span class="text-sky-700">.<?php echo e($domain['tld']); ?></span>
                    <span class="text-sky-900 font-bold ml-1">$<?php echo e(number_format($domain['price'], 2)); ?> USD</span>
                </div>
...
<section class="relative min-h-[85vh] flex items-center overflow-hidden" style="background: linear-gradient(135deg, #0f172a 0%, #1e3a5f 40%, #2d5a7b 70%, #3d7a9e 100%);">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'left-[10%]' : 'right-[10%]'); ?> top-1/2 -translate-y-1/2 w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
    ...
    <div class="container mx-auto px-4 relative z-10 py-20">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="<?php echo e(app()->getLocale() == 'ar' ? 'text-right' : 'text-left'); ?>">
                <!-- Trust Badges -->
                <div class="flex flex-wrap items-center gap-3 mb-8 <?php echo e(app()->getLocale() == 'ar' ? 'justify-end' : 'justify-start'); ?>">
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
                        <span class="text-white text-sm font-medium">+50,000 <?php echo e(__('frontend.happy_clients')); ?></span>
                    </div>
                </div>

                <!-- Main Heading -->
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                    <span class="text-blue-300"><?php echo e(__('frontend.hero_title_speed')); ?></span><br>
                    <?php echo e(__('frontend.hero_title_hosting')); ?>

                </h1>
                
                <!-- Subtitle -->
                <p class="text-lg md:text-xl text-white/80 mb-8 max-w-xl">
                    <?php echo e(__('frontend.hero_subtitle_new')); ?>

                </p>

                <!-- Features -->
                <div class="flex flex-wrap items-center gap-6 mb-10 <?php echo e(app()->getLocale() == 'ar' ? 'justify-end' : 'justify-start'); ?>">
                    <div class="flex items-center gap-2 text-white/80">
                        <svg class="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                        </svg>
                        <span class="text-sm font-medium"><?php echo e(__('frontend.ultra_fast')); ?></span>
                    </div>
                    <div class="flex items-center gap-2 text-white/80">
                        <svg class="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                        </svg>
                        <span class="text-sm font-medium"><?php echo e(__('frontend.full_security')); ?></span>
                    </div>
                    <div class="flex items-center gap-2 text-white/80">
                        <svg class="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="text-sm font-medium"><?php echo e(__('frontend.support_247')); ?></span>
                    </div>
                </div>

                <!-- CTA Buttons -->
                <div class="flex flex-wrap items-center gap-4 <?php echo e(app()->getLocale() == 'ar' ? 'justify-end' : 'justify-start'); ?>">
                    <a href="<?php echo e(route('hosting.shared')); ?>" class="group inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full transition-all shadow-lg hover:shadow-xl">
                        <?php echo e(__('frontend.start_now')); ?> $2
                        <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform <?php echo e(app()->getLocale() == 'ar' ? 'rotate-180' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <h2 class="text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white">
                <?php echo e(__('frontend.choose_hosting_plan')); ?>

            </h2>
            <p class="mt-3 text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                <?php echo e(__('frontend.hosting_plans_description')); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            ...
            <!-- Shared Hosting -->
            <a href="<?php echo e(route('hosting.shared')); ?>" class="group relative rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-slate-100 dark:border-slate-700">
                ...
                <h3 class="mt-4 text-lg font-bold text-slate-900 dark:text-white"><?php echo e(__('frontend.shared_hosting')); ?></h3>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.shared_hosting_desc')); ?></p>
                <div class="mt-4">
                    <span class="text-xs text-slate-500 dark:text-slate-500"><?php echo e(__('frontend.starting_at')); ?></span>
                    <div class="flex items-baseline gap-0.5">
                        <span class="text-3xl font-bold text-slate-900 dark:text-white">$2</span>
                        <span class="text-sm text-slate-500 dark:text-slate-500">/<?php echo e(__('frontend.month')); ?></span>
                    </div>
                </div>
                <ul class="mt-4 space-y-2">
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-blue-600"></span><?php echo e(__('frontend.unlimited_ssd')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-blue-600"></span><?php echo e(__('frontend.free_ssl')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-blue-600"></span><?php echo e(__('frontend.unlimited_bandwidth')); ?>
                ...
                <div class="mt-4 flex items-center gap-1 text-blue-600 dark:text-blue-400 font-medium text-sm group-hover:gap-2 transition-all">
                    <?php echo e(__('frontend.learn_more')); ?>

                    <svg class="h-4 w-4 <?php echo e(app()->getLocale() == 'ar' ? 'rotate-180' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Cloud Hosting -->
            <a href="<?php echo e(route('hosting.cloud')); ?>" class="group relative rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-slate-100 dark:border-slate-700">
                ...
                <h3 class="mt-4 text-lg font-bold text-slate-900 dark:text-white"><?php echo e(__('frontend.cloud_hosting')); ?></h3>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.cloud_hosting_desc')); ?></p>
                <div class="mt-4">
                    <span class="text-xs text-slate-500 dark:text-slate-500"><?php echo e(__('frontend.starting_at')); ?></span>
                    <div class="flex items-baseline gap-0.5">
                ...
                <ul class="mt-4 space-y-2">
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-purple-600"></span><?php echo e(__('frontend.dedicated_resources')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-purple-600"></span><?php echo e(__('frontend.auto_scaling')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-purple-600"></span><?php echo e(__('frontend.daily_backups')); ?>
            ...
            <!-- Reseller Hosting -->
            <a href="<?php echo e(route('hosting.reseller')); ?>" class="group relative rounded-2xl bg-gradient-to-br from-cyan-50 to-cyan-100 dark:from-cyan-900/20 dark:to-cyan-800/20 p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-slate-100 dark:border-slate-700">
                ...
                <h3 class="mt-4 text-lg font-bold text-slate-900 dark:text-white"><?php echo e(__('frontend.reseller_hosting')); ?></h3>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.reseller_hosting_desc')); ?></p>
                <div class="mt-4">
                    <span class="text-xs text-slate-500 dark:text-slate-500"><?php echo e(__('frontend.starting_at')); ?></span>
                    <div class="flex items-baseline gap-0.5">
                ...
                <ul class="mt-4 space-y-2">
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-cyan-600"></span><?php echo e(__('frontend.free_whm')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-cyan-600"></span><?php echo e(__('frontend.white_label')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-cyan-600"></span><?php echo e(__('frontend.unlimited_accounts')); ?>
            ...
            <!-- VPS Hosting -->
            <a href="<?php echo e(route('hosting.vps')); ?>" class="group relative rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-slate-100 dark:border-slate-700">
                ...
                <h3 class="mt-4 text-lg font-bold text-slate-900 dark:text-white"><?php echo e(__('frontend.vps_hosting')); ?></h3>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.vps_hosting_desc')); ?></p>
                <div class="mt-4">
                    <span class="text-xs text-slate-500 dark:text-slate-500"><?php echo e(__('frontend.starting_at')); ?></span>
                    <div class="flex items-baseline gap-0.5">
                ...
                <ul class="mt-4 space-y-2">
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-emerald-600"></span><?php echo e(__('frontend.full_root_access')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-emerald-600"></span><?php echo e(__('frontend.choice_of_os')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-emerald-600"></span><?php echo e(__('frontend.dedicated_ip')); ?>
            ...
            <!-- Dedicated Servers -->
            <a href="<?php echo e(route('hosting.dedicated')); ?>" class="group relative rounded-2xl bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-slate-100 dark:border-slate-700">
                ...
                <h3 class="mt-4 text-lg font-bold text-slate-900 dark:text-white"><?php echo e(__('frontend.dedicated_servers')); ?></h3>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.dedicated_servers_desc')); ?></p>
                <div class="mt-4">
                    <span class="text-xs text-slate-500 dark:text-slate-500"><?php echo e(__('frontend.starting_at')); ?></span>
                    <div class="flex items-baseline gap-0.5">
                ...
                <ul class="mt-4 space-y-2">
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-amber-600"></span><?php echo e(__('frontend.entire_server')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-amber-600"></span><?php echo e(__('frontend.ultra_fast_performance')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-amber-600"></span><?php echo e(__('frontend.expert_support')); ?>
            ...
            <!-- Migrate Now -->
            <a href="<?php echo e(route('hosting.shared')); ?>?migrate=1" class="group relative rounded-2xl bg-gradient-to-br from-rose-50 to-rose-100 dark:from-rose-900/20 dark:to-rose-800/20 p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-slate-100 dark:border-slate-700">
                <div class="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-rose-600 shadow-lg">
                    <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>
                    </svg>
                </div>
                <h3 class="mt-4 text-lg font-bold text-slate-900 dark:text-white"><?php echo e(__('frontend.migrate_now')); ?></h3>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.migrate_now_desc')); ?></p>
                <div class="mt-4">
                    <div class="flex items-baseline gap-0.5">
                        <span class="text-3xl font-bold text-rose-600 dark:text-rose-400"><?php echo e(__('frontend.free')); ?></span>
                    </div>
                </div>
                <ul class="mt-4 space-y-2">
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-rose-600"></span><?php echo e(__('frontend.zero_downtime')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-rose-600"></span><?php echo e(__('frontend.expert_team')); ?>

                    </li>
                    <li class="flex items-center gap-2 text-xs text-slate-600 dark:text-slate-400">
                        <span class="h-1 w-1 rounded-full bg-rose-600"></span><?php echo e(__('frontend.money_back_guarantee')); ?>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-1">
                                <?php echo e(__('frontend.benefit_247_title')); ?>

                            </h3>
                            <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                <?php echo e(__('frontend.benefit_247_desc')); ?>
            ...
            <div class="benefit-stack-card benefit-stack-2 absolute inset-x-0 bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg cursor-pointer" onclick="toggleCard(this)">
                <div class="benefit-border border-2 border-slate-200 dark:border-slate-700 hover:border-cyan-400 dark:hover:border-cyan-400 rounded-2xl p-6 -m-6 transition-all">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-1">
                                <?php echo e(__('frontend.benefit_reach_title')); ?>

                            </h3>
                            <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                <?php echo e(__('frontend.benefit_reach_desc')); ?>
            ...
            <div class="benefit-stack-card benefit-stack-3 absolute inset-x-0 bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg cursor-pointer" onclick="toggleCard(this)">
                <div class="benefit-border border-2 border-slate-200 dark:border-slate-700 hover:border-green-400 dark:hover:border-green-400 rounded-2xl p-6 -m-6 transition-all">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-1">
                                <?php echo e(__('frontend.benefit_cost_title')); ?>

                            </h3>
                            <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                <?php echo e(__('frontend.benefit_cost_desc')); ?>
            ...
            <div class="benefit-stack-card benefit-stack-4 absolute inset-x-0 bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg cursor-pointer" onclick="toggleCard(this)">
                <div class="benefit-border border-2 border-slate-200 dark:border-slate-700 hover:border-purple-400 dark:hover:border-purple-400 rounded-2xl p-6 -m-6 transition-all">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-1">
                                <?php echo e(__('frontend.benefit_insights_title')); ?>

                            </h3>
                            <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                <?php echo e(__('frontend.benefit_insights_desc')); ?>
            ...
            <div class="benefit-stack-card benefit-stack-5 absolute inset-x-0 bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg cursor-pointer" onclick="toggleCard(this)">
                <div class="benefit-border border-2 border-slate-200 dark:border-slate-700 hover:border-orange-400 dark:hover:border-orange-400 rounded-2xl p-6 -m-6 transition-all">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-1">
                                <?php echo e(__('frontend.benefit_trust_title')); ?>

                            </h3>
                            <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                <?php echo e(__('frontend.benefit_trust_desc')); ?>
            ...
            <div class="benefit-stack-card benefit-stack-6 absolute inset-x-0 bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg cursor-pointer" onclick="toggleCard(this)">
                <div class="benefit-border border-2 border-slate-200 dark:border-slate-700 hover:border-indigo-400 dark:hover:border-indigo-400 rounded-2xl p-6 -m-6 transition-all">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-1">
                                <?php echo e(__('frontend.benefit_updates_title')); ?>

                            </h3>
                            <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                <?php echo e(__('frontend.benefit_updates_desc')); ?>
        ...
        <div class="text-center mt-16">
            <a href="#domain-search" 
               class="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold text-lg rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                <span><?php echo e(__('frontend.start_your_journey')); ?></span>
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="max-w-5xl mx-auto text-center mb-24">
            ...
            <h2 class="text-5xl md:text-7xl font-black text-slate-900 dark:text-white mb-8 leading-tight">
                <?php echo e(__('frontend.why_pro_gineous_title')); ?>

            </h2>
            
            <p class="text-xl md:text-2xl text-slate-600 dark:text-slate-400 max-w-4xl mx-auto font-light">
                <?php echo e(__('frontend.why_pro_gineous_subtitle')); ?>
        ...
        <div class="max-w-6xl mx-auto space-y-2">
                ...
                <div class="flex items-center gap-8 px-8 py-12 border-b border-slate-200 dark:border-slate-800 hover:bg-blue-50 dark:hover:bg-slate-900/50 transition-all duration-300">
                    ...
                    <div class="flex-grow">
                        <h3 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-colors">
                            <?php echo e(__('frontend.feature_support_title')); ?>

                        </h3>
                        <p class="text-lg text-slate-600 dark:text-slate-400 font-light">
                            <?php echo e(__('frontend.feature_support_desc')); ?>
            ...
            <div class="group relative overflow-hidden">
                <div class="flex items-center gap-8 px-8 py-12 border-b border-slate-200 dark:border-slate-800 hover:bg-blue-50 dark:hover:bg-slate-900/50 transition-all duration-300">
                    ...
                    <div class="flex-grow">
                        <h3 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-colors">
                            <?php echo e(__('frontend.feature_performance_title')); ?>

                        </h3>
                        <p class="text-lg text-slate-600 dark:text-slate-400 font-light">
                            <?php echo e(__('frontend.feature_performance_desc')); ?>
            ...
            <div class="group relative overflow-hidden">
                <div class="flex items-center gap-8 px-8 py-12 border-b border-slate-200 dark:border-slate-800 hover:bg-blue-50 dark:hover:bg-slate-900/50 transition-all duration-300">
                    ...
                    <div class="flex-grow">
                        <h3 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-colors">
                            <?php echo e(__('frontend.feature_security_title')); ?>

                        </h3>
                        <p class="text-lg text-slate-600 dark:text-slate-400 font-light">
                            <?php echo e(__('frontend.feature_security_desc')); ?>
            ...
            <div class="group relative overflow-hidden">
                <div class="flex items-center gap-8 px-8 py-12 border-b border-slate-200 dark:border-slate-800 hover:bg-blue-50 dark:hover:bg-slate-900/50 transition-all duration-300">
                    ...
                    <div class="flex-grow">
                        <h3 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-colors">
                            <?php echo e(__('frontend.feature_pricing_title')); ?>

                        </h3>
                        <p class="text-lg text-slate-600 dark:text-slate-400 font-light">
                            <?php echo e(__('frontend.feature_pricing_desc')); ?>
            ...
            <div class="group relative overflow-hidden">
                <div class="flex items-center gap-8 px-8 py-12 border-b border-slate-200 dark:border-slate-800 hover:bg-blue-50 dark:hover:bg-slate-900/50 transition-all duration-300">
                    ...
                    <div class="flex-grow">
                        <h3 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-colors">
                            <?php echo e(__('frontend.feature_control_title')); ?>

                        </h3>
                        <p class="text-lg text-slate-600 dark:text-slate-400 font-light">
                            <?php echo e(__('frontend.feature_control_desc')); ?>
            ...
            <div class="group relative overflow-hidden">
                <div class="flex items-center gap-8 px-8 py-12 border-b border-slate-200 dark:border-slate-800 hover:bg-blue-50 dark:hover:bg-slate-900/50 transition-all duration-300">
                    ...
                    <div class="flex-grow">
                        <h3 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-colors">
                            <?php echo e(__('frontend.feature_uptime_title')); ?>

                        </h3>
                        <p class="text-lg text-slate-600 dark:text-slate-400 font-light">
                            <?php echo e(__('frontend.feature_uptime_desc')); ?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-3xl mx-auto text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">
                <?php echo e(__('frontend.why_choose_us')); ?>

            </h2>
            <p class="text-lg text-slate-600 dark:text-slate-400">
                <?php echo e(__('frontend.why_choose_us_desc')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-600">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2"><?php echo e(__('frontend.fast_performance')); ?></h3>
                <p class="text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.fast_performance_desc')); ?></p>
            </div>
            ...
            <div class="group p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-600">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2"><?php echo e(__('frontend.high_security')); ?></h3>
                <p class="text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.high_security_desc')); ?></p>
            </div>
            ...
            <div class="group p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-600">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2"><?php echo e(__('frontend.support_247')); ?></h3>
                <p class="text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.support_247_desc')); ?></p>
            </div>
            ...
            <div class="group p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-600">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2"><?php echo e(__('frontend.easy_management')); ?></h3>
                <p class="text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.easy_management_desc')); ?></p>
            </div>
            ...
            <div class="group p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-600">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2"><?php echo e(__('frontend.auto_backup')); ?></h3>
                <p class="text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.auto_backup_desc')); ?></p>
            </div>
            ...
            <div class="group p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-600">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2"><?php echo e(__('frontend.ssl_certificate')); ?></h3>
                <p class="text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.ssl_certificate_desc')); ?></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-lg text-blue-100 mb-8">
                <?php echo e(__('frontend.ready_to_start_desc')); ?>
            ...
            <a href="#plans" class="inline-flex items-center gap-2 px-8 py-4 bg-white hover:bg-slate-50 text-blue-600 font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200">
                <?php echo e(__('frontend.start_now')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchForm.addEventListener('submit', async function(e) {
        ...
        if (!domain) {
            showError('<?php echo e(__("frontend.please_enter_domain")); ?>');
            return;
        }
        
        // Show loading state
        searchButton.disabled = true;
        searchText.textContent = '<?php echo e(__("frontend.searching_domains")); ?>';
        ...
        try {
            const response = await fetch(`<?php echo e(route('domains.search')); ?>?domain=${encodeURIComponent(domain)}`, {
                method: 'GET',
                headers: {
            ...
            if (data.success && data.results && data.results.length > 0) {
                ...
                showError(data.message || '<?php echo e(__("frontend.no_results_found")); ?>');
            }
        } catch (error) {
            console.error('Search error:', error);
            showError('<?php echo e(__("frontend.domain_search_error")); ?>');
        } finally {
            // Reset button state
            searchButton.disabled = false;
            searchText.textContent = '<?php echo e(__("frontend.search_now")); ?>';
    ...
    function createDomainListItem(result, available) {
        const statusBadge = available 
            ? `<span class="px-3 py-1 bg-green-500/20 text-green-700 dark:text-green-300 rounded-lg font-bold text-xs border border-green-500/30 inline-flex items-center gap-1">
                ...
                <?php echo e(__("frontend.domain_available")); ?>
            ...
            : `<span class="px-3 py-1 bg-red-500/20 text-red-700 dark:text-red-300 rounded-lg font-bold text-xs border border-red-500/30 inline-flex items-center gap-1">
                ...
                <?php echo e(__("frontend.domain_unavailable")); ?>
        ...
        const priceSection = available 
            ? `<div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div>
                        <div class="text-xs text-slate-600 dark:text-slate-400"><?php echo e(__("frontend.register_price")); ?></div>
                        <div class="text-xl font-bold text-blue-600 dark:text-blue-400">
                            ${formatPrice(result.price)}
                        </div>
                    </div>
                    ${result.renew_price ? `<div>
                        <div class="text-xs text-slate-600 dark:text-slate-400"><?php echo e(__("frontend.renew_price")); ?></div>
    ...
    transferForm.addEventListener('submit', async function(e) {
        ...
        if (!domain || !authCode) {
            showTransferError('<?php echo e(__("frontend.please_enter_domain")); ?>');
            return;
        }
        
        // Show loading state
        transferButton.disabled = true;
        transferText.textContent = '<?php echo e(__("frontend.checking_transfer_eligibility")); ?>';
        ...
        try {
            const response = await fetch('<?php echo e(route("domains.transfer.validate")); ?>', {
                method: 'POST',
                headers: {
            ...
            if (data.success && data.data.eligible) {
                ...
                showTransferError(data.data.message || '<?php echo e(__("frontend.transfer_check_failed")); ?>');
            }
        } catch (error) {
            console.error('Transfer validation error:', error);
            showTransferError('<?php echo e(__("frontend.transfer_validation_error")); ?>');
        } finally {
            // Reset button state
            transferButton.disabled = false;
            transferText.textContent = '<?php echo e(__("frontend.start_transfer")); ?>';
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-2xl font-bold text-green-800 dark:text-green-300 mb-2">
                            <?php echo e(__('frontend.transfer_validated')); ?>
                        ...
                        <div class="bg-white/70 dark:bg-slate-800/70 rounded-xl p-4 mb-4">
                            <div class="flex items-center justify-between">
                                <div>
                                    <div class="text-sm text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.domain')); ?></div>
                                    <div class="text-xl font-bold text-slate-900 dark:text-white">${escapeHtml(data.display_domain || data.domain)}</div>
                                </div>
                                ${data.transfer_price ? `
                                <div class="text-right">
                                    <div class="text-sm text-slate-600 dark:text-slate-400"><?php echo e(__('frontend.transfer_price')); ?></div>
                        ...
                        >
                            ...
                            <?php echo e(__('frontend.proceed_to_cart')); ?>
...
async function searchDomain(domain) {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route("domains.check")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
        ...
        searchResultsContent.innerHTML = `
            <div class="text-center py-8">
                ...
                <p class="mt-4 text-gray-600"><?php echo e(__('frontend.search_error')); ?></p>
            </div>
        `;
    }
}
...
function displayDomainResults(searchedDomain, data) {
    ...
    // Translation strings
    const translations = {
        available: '<?php echo e(__("frontend.available_for_registration")); ?>',
        notAvailable: '<?php echo e(__("frontend.not_available")); ?>',
        addToCart: '<?php echo e(__("frontend.add_to_cart")); ?>',
        add: '<?php echo e(__("frontend.add")); ?>',
        otherExtensions: '<?php echo e(__("frontend.other_available_extensions")); ?>'
    };
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\resources\views/frontend/home.blade.php ENDPATH**/ ?>