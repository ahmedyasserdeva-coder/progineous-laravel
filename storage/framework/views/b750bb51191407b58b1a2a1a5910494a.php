...
<head>
    ...
    <title><?php echo e($locale == 'ar' ? '404 - الصفحة غير موجودة' : '404 - Page Not Found'); ?></title>
...
<body>
    ...
    <a href="<?php echo e(url('/')); ?>" class="logo">
        <img src="<?php echo e(asset('logo/pro Gineous_white logo.svg')); ?>" alt="Pro Gineous">
    </a>
    ...
    <div class="container">
        ...
        <!-- Title -->
        <h1 class="title">
            <?php echo e($locale == 'ar' ? 'عفواً! الصفحة غير موجودة' : 'Oops! Page Not Found'); ?>

        </h1>
        
        <!-- Description -->
        <p class="description">
            <?php echo e($locale == 'ar' 
        ...
        <div class="buttons">
            <a href="<?php echo e(url('/')); ?>" class="btn btn-primary">
                ...
                <?php echo e($locale == 'ar' ? 'العودة للرئيسية' : 'Back to Home'); ?>
            ...
            <button onclick="goBack()" class="btn btn-secondary">
                ...
                <?php echo e($locale == 'ar' ? 'الرجوع للخلف' : 'Go Back'); ?>
...
<?php /**PATH C:\laragon\www\resources\views/errors/404.blade.php ENDPATH**/ ?>