...
<?php $__env->startSection('title', __('tickets.my_tickets')); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900"><?php echo e(__('tickets.my_tickets')); ?></h1>
                <p class="text-gray-500 mt-1 text-sm"><?php echo e(app()->getLocale() == 'ar' ? 'تتبع وإدارة طلبات الدعم الفني الخاصة بك' : 'Track and manage your support requests'); ?></p>
            </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100 hover:border-gray-200 transition-all duration-200 group">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500"><?php echo e(__('tickets.total_tickets')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 border border-emerald-100 hover:border-emerald-200 transition-all duration-200 group">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-bold text-emerald-600"><?php echo e($stats['open']); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e(__('tickets.open_tickets')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 border border-blue-100 hover:border-blue-200 transition-all duration-200 group">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-bold text-blue-600"><?php echo e($stats['answered']); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e(__('tickets.answered_tickets')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100 hover:border-gray-200 transition-all duration-200 group">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-bold text-gray-600"><?php echo e($stats['closed']); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e(__('tickets.closed_tickets')); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div class="px-5 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
            <form action="<?php echo e(route('client.tickets.index')); ?>" method="GET" class="flex flex-col lg:flex-row items-stretch lg:items-center gap-3">
                <!-- Search Input -->
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" 
                           ...
                           class="w-full <?php echo e(app()->getLocale() == 'ar' ? 'pr-10 pl-4' : 'pl-10 pr-4'); ?> py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all">
                </div>

                <!-- Status Filter -->
                <div class="relative">
                    <select name="status" onchange="this.form.submit()" 
                            class="appearance-none w-full lg:w-44 px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 cursor-pointer <?php echo e(app()->getLocale() == 'ar' ? 'pl-10' : 'pr-10'); ?>">
                    ...
                    <div class="absolute inset-y-0 <?php echo e(app()->getLocale() == 'ar' ? 'left-0 pl-3' : 'right-0 pr-3'); ?> flex items-center pointer-events-none">
                ...
                <?php if(request('search') || request('status') || request('department')): ?>
        ...
        <?php if($tickets->count() > 0): ?>
            <div class="divide-y divide-gray-100">
                <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('client.tickets.show', $ticket)); ?>" 
                       class="flex items-center gap-4 px-5 py-4 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-transparent transition-all duration-200 group">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <?php elseif($ticket->status == 'on_hold'): ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex flex-wrap items-center gap-2 mb-1.5">
                                ...
                                <span class="text-xs text-gray-500 font-medium"><?php echo e($ticket->department->name); ?></span>
                            ...
                            <div class="flex items-center gap-2 mt-1.5">
                                ...
                                <span class="text-xs text-gray-500">
                                    <?php echo e($ticket->last_reply_at ? $ticket->last_reply_at->diffForHumans() : $ticket->created_at->diffForHumans()); ?>
                        ...
                        <div class="flex items-center gap-4 flex-shrink-0">
                            <span class="hidden sm:inline-flex px-2.5 py-1 text-xs font-semibold rounded-lg <?php echo e($ticket->status_class); ?>">
                            ...
                            <div class="w-8 h-8 rounded-lg bg-gray-100 group-hover:bg-blue-100 flex items-center justify-center transition-colors">
                                <svg class="w-4 h-4 text-gray-400 group-hover:text-blue-600 transition-colors <?php echo e(app()->getLocale() == 'ar' ? 'rotate-180' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php else: ?>
            ...
            <div class="py-20 px-4">
                <div class="max-w-sm mx-auto text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2"><?php echo e(__('tickets.messages.no_tickets')); ?></h3>
                    <p class="text-sm text-gray-500 mb-8">
                        <?php echo e(app()->getLocale() == 'ar' ? 'لم يتم العثور على أي تذاكر دعم. أنشئ تذكرة جديدة للحصول على المساعدة من فريقنا.' : 'No support tickets found. Create a new ticket to get help from our team.'); ?>
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="group relative bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-lg hover:border-blue-200 transition-all duration-300 cursor-pointer overflow-hidden">
            ...
            <div class="relative flex items-start gap-4">
                ...
                <div class="flex-1">
                    <h4 class="text-sm font-semibold text-gray-900 group-hover:text-blue-600 transition-colors"><?php echo e(app()->getLocale() == 'ar' ? 'قاعدة المعرفة' : 'Knowledge Base'); ?></h4>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e(app()->getLocale() == 'ar' ? 'اعثر على إجابات للأسئلة الشائعة' : 'Find answers to common questions'); ?></p>
                </div>
                <svg class="w-5 h-5 text-gray-300 group-hover:text-blue-500 transition-colors <?php echo e(app()->getLocale() == 'ar' ? 'rotate-180' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
            </div>
        </div>
            ...
            <div class="relative flex items-start gap-4">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-2">
                        <h4 class="text-sm font-semibold text-gray-900 group-hover:text-emerald-600 transition-colors"><?php echo e(app()->getLocale() == 'ar' ? 'الدردشة المباشرة' : 'Live Chat'); ?></h4>
                        <span class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold bg-emerald-100 text-emerald-700">
                            ...
                            <?php echo e(app()->getLocale() == 'ar' ? 'متاح' : 'Online'); ?>

                        </span>
                    </div>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e(app()->getLocale() == 'ar' ? 'تحدث مع فريق الدعم مباشرة' : 'Chat with our support team'); ?></p>
                </div>
                <svg class="w-5 h-5 text-gray-300 group-hover:text-emerald-500 transition-colors <?php echo e(app()->getLocale() == 'ar' ? 'rotate-180' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
            </div>
        </div>
...
<?php echo $__env->make('frontend.client.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\resources\views/frontend/client/tickets/index.blade.php ENDPATH**/ ?>