...
<head>
    ...
    <title><?php echo app('translator')->get('CRM Admin Portal'); ?> - Progineous</title>
    ...
    <style>
        ...
        .language-toggle {
            position: fixed;
            top: 8px;
            <?php echo e(app()->getLocale() == 'ar' ? 'left: 8px' : 'right: 8px'); ?>;
            z-index: 1000;
        }
        ...
        @media (min-width: 640px) {
            .language-toggle {
                top: 12px;
                <?php echo e(app()->getLocale() == 'ar' ? 'left: 12px' : 'right: 12px'); ?>;
            }
        }
        ...
        @media (min-width: 768px) {
            .language-toggle {
                top: 16px;
                <?php echo e(app()->getLocale() == 'ar' ? 'left: 16px' : 'right: 16px'); ?>;
            }
        }
        ...
        @media (min-width: 1024px) {
            .language-toggle {
                top: 20px;
                <?php echo e(app()->getLocale() == 'ar' ? 'left: 20px' : 'right: 20px'); ?>;
            }
        }
        ...
        @media (min-width: 1280px) {
            .language-toggle {
                top: 24px;
                <?php echo e(app()->getLocale() == 'ar' ? 'left: 24px' : 'right: 24px'); ?>;
            }
        }
    ...
    <div class="language-toggle">
        <div class="flex items-center space-x-1 sm:space-x-1.5 md:space-x-2">
            <a href="<?php echo e(route('language.switch', 'ar')); ?>" 
               class="px-1.5 py-0.5 sm:px-2 sm:py-1 md:px-3 md:py-2 rounded-md md:rounded-lg text-[10px] sm:text-xs md:text-sm lg:text-base font-medium transition-all duration-300 <?php echo e(app()->getLocale() == 'ar' ? 'bg-white/20 text-white' : 'text-white/70 hover:text-white hover:bg-white/10'); ?>">
                العربية
            </a>
            <a href="<?php echo e(route('language.switch', 'en')); ?>" 
               class="px-1.5 py-0.5 sm:px-2 sm:py-1 md:px-3 md:py-2 rounded-md md:rounded-lg text-[10px] sm:text-xs md:text-sm lg:text-base font-medium transition-all duration-300 <?php echo e(app()->getLocale() == 'en' ? 'bg-white/20 text-white' : 'text-white/70 hover:text-white hover:bg-white/10'); ?>">
                English
            </a>
        </div>
    </div>
    ...
    <div class="glass-container p-3 sm:p-5 md:p-6 lg:p-8 xl:p-10 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[45%] max-w-2xl mx-auto slide-in">
        ...
        <div class="text-center mb-2 sm:mb-3 md:mb-4 lg:mb-5 xl:mb-6">
            ...
            <h1 class="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold text-white mb-1 sm:mb-1.5 md:mb-2">
                <?php echo e(__('crm.crm_admin_portal')); ?>
            ...
            <div class="mt-1.5 sm:mt-2 md:mt-2.5 lg:mt-3 xl:mt-3.5 text-white/60 text-[9px] sm:text-[10px] md:text-xs lg:text-sm">
                <span class="inline-flex items-center px-1.5 sm:px-2 md:px-2.5 lg:px-3 xl:px-3.5 py-0.5 sm:py-0.5 md:py-1 lg:py-1.5 rounded-full bg-white/10 backdrop-blur-sm">
                    <span class="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-green-400 rounded-full <?php echo e(app()->getLocale() == 'ar' ? 'ml-1 sm:ml-1.5' : 'mr-1 sm:mr-1.5'); ?> animate-pulse"></span>
        ...
        <!-- Login Form -->
        <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" class="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-5" id="loginForm" style="opacity: 0.5; pointer-events: none;">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-1 sm:space-y-1.5 md:space-y-2">
                ...
                <div class="relative">
                    <input type="email" 
                           ...
                           disabled
                           class="input-field w-full px-2.5 sm:px-3 md:px-4 lg:px-5 py-2 sm:py-2.5 md:py-3 lg:py-3.5 xl:py-4 <?php echo e(app()->getLocale() == 'ar' ? 'pr-8 sm:pr-9 md:pr-10 lg:pr-11 xl:pr-12' : 'pl-8 sm:pl-9 md:pl-10 lg:pl-11 xl:pl-12'); ?> rounded-lg md:rounded-xl text-xs sm:text-sm md:text-base text-white placeholder-white/50 focus:outline-none <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="<?php echo e(__('crm.enter_email')); ?>"
                           required>
                    <div class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'right-2.5 sm:right-3 md:right-3.5 lg:right-4' : 'left-2.5 sm:left-3 md:left-3.5 lg:left-4'); ?> top-1/2 transform -translate-y-1/2">
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="text-[10px] sm:text-xs md:text-sm text-red-300"><?php echo e($message); ?></p>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1 sm:space-y-1.5 md:space-y-2">
                ...
                <div class="relative">
                    <input type="password" 
                           ...
                           name="password"
                           disabled
                           class="input-field w-full px-2.5 sm:px-3 md:px-4 lg:px-5 py-2 sm:py-2.5 md:py-3 lg:py-3.5 xl:py-4 <?php echo e(app()->getLocale() == 'ar' ? 'pr-8 sm:pr-9 md:pr-10 lg:pr-11 xl:pr-12 pl-8 sm:pl-9 md:pl-10 lg:pl-11 xl:pl-12' : 'pl-8 sm:pl-9 md:pl-10 lg:pl-11 xl:pl-12 pr-8 sm:pr-9 md:pr-10 lg:pr-11 xl:pl-12'); ?> rounded-lg md:rounded-xl text-xs sm:text-sm md:text-base text-white placeholder-white/50 focus:outline-none <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400/50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="<?php echo e(__('crm.enter_password')); ?>"
                           required>
                    <div class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'right-2.5 sm:right-3 md:right-3.5 lg:right-4' : 'left-2.5 sm:left-3 md:left-3.5 lg:left-4'); ?> top-1/2 transform -translate-y-1/2">
                        <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4.5 md:h-4.5 lg:w-5 lg:h-5 text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button type="button" 
                            ...
                            class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'left-2.5 sm:left-3 md:left-3.5 lg:left-4' : 'right-2.5 sm:right-3 md:right-3.5 lg:right-4'); ?> top-1/2 transform -translate-y-1/2 text-white/60 hover:text-white transition-colors">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-between text-[10px] sm:text-xs md:text-sm">
                <label class="flex items-center">
                    ...
                    <span class="<?php echo e(app()->getLocale() == 'ar' ? 'mr-1.5 sm:mr-2 md:mr-2.5' : 'ml-1.5 sm:ml-2 md:ml-2.5'); ?> text-white/90">
                        <?php echo e(__('crm.remember_me')); ?>

                    </span>
                </label>
                <a href="<?php echo e(route('admin.password.request')); ?>" class="text-blue-300 hover:text-blue-200 transition-colors">
                    <?php echo e(__('crm.forgot_password')); ?>
            ...
            <button type="submit"
                ...
                <span class="relative z-10">
                    <?php echo e(__('crm.access_crm_portal')); ?>
        ...
        <?php if(session('error')): ?>
            <div class="mt-2 sm:mt-3 md:mt-4 lg:mt-5 p-2 sm:p-2.5 md:p-3 lg:p-3.5 rounded-lg md:rounded-xl bg-red-500/20 border border-red-400/30 backdrop-blur-sm">
                <div class="flex items-center">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4.5 md:h-4.5 lg:w-5 lg:h-5 text-red-300 <?php echo e(app()->getLocale() == 'ar' ? 'ml-1.5 sm:ml-2 md:ml-2.5' : 'mr-1.5 sm:mr-2 md:mr-2.5'); ?>" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                    </svg>
                    <span class="text-red-200 text-[10px] sm:text-xs md:text-sm"><?php echo e(session('error')); ?></span>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="mt-3 sm:mt-4 md:mt-5 lg:mt-6 pt-2 sm:pt-3 md:pt-4 lg:pt-5 border-t border-white/10 text-center">
            ...
            <p class="text-white/40 text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs mt-0.5 sm:mt-1">
                <?php echo e(__('crm.most_advanced_crm')); ?>
    ...
    <script>
        // Translation strings
        const translations = {
            locationAccessRequired: "<?php echo e(__('crm.location_access_required')); ?>",
            locationForSecurity: "<?php echo e(__('crm.location_for_security')); ?>",
            locationAccessGranted: "<?php echo e(__('crm.location_access_granted')); ?>",
            loginNowSecure: "<?php echo e(__('crm.login_now_secure')); ?>",
            locationAccessDenied: "<?php echo e(__('crm.location_access_denied')); ?>",
            locationPermissionDenied: "<?php echo e(__('crm.location_permission_denied')); ?>",
            locationUnavailable: "<?php echo e(__('crm.location_unavailable')); ?>",
            locationTimeout: "<?php echo e(__('crm.location_timeout')); ?>",
            locationUnknownError: "<?php echo e(__('crm.location_unknown_error')); ?>",
            canContinueWithoutLocation: "<?php echo e(__('crm.can_continue_without_location')); ?>",
            cannotLoginWithoutLocation: "<?php echo e(__('crm.cannot_login_without_location')); ?>",
            locationNotSupported: "<?php echo e(__('crm.location_not_supported')); ?>",
            browserNoLocation: "<?php echo e(__('crm.browser_no_location')); ?>"
        };
...
</html><?php /**PATH C:\laragon\www\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>