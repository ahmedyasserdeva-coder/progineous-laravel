...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('description', app()->getLocale() == 'ar' ? 'لوحة تحكم العميل - Pro Gineous' : 'Client Dashboard - Pro Gineous'); ?>">
    
    <!-- Favicon -->
    <?php if(setting('favicon')): ?>
        <link rel="icon" type="image/png" href="<?php echo e(asset('storage/' . setting('favicon'))); ?>">
        <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('storage/' . setting('favicon'))); ?>">
        <link rel="apple-touch-icon" href="<?php echo e(asset('storage/' . setting('favicon'))); ?>">
    <?php else: ?>
...
<body class="overflow-x-hidden">
    ...
    <div id="preloader">
        <div class="preloader-logo">
            <?php if(setting('customer_panel_logo')): ?>
                <img src="<?php echo e(asset('storage/' . setting('customer_panel_logo'))); ?>" 
                     alt="<?php echo e(setting('company_name', 'Pro Gineous')); ?>" 
                     class="w-full h-full object-contain">
            <?php else: ?>
                <img src="<?php echo e(asset('logo/pro Gineous Blue_defult icon.png')); ?>" 
                     alt="Pro Gineous" 
                     class="w-full h-full object-contain">
            <?php endif; ?>
        </div>
        ...
        <p class="preloader-text">
            <span class="preloader-dots"><?php echo e(app()->getLocale() == 'ar' ? 'جاري التحميل' : 'Loading'); ?></span>
        </p>
    </div>
    ...
    <div class="min-h-screen flex client-layout-container" x-data="sidebarController()" x-init="init()">
        ...
        <!-- Sidebar -->
        <div class="fixed inset-y-0 <?php echo e(app()->getLocale() == 'ar' ? 'right-0 border-l' : 'left-0 border-r'); ?> glass-dark shadow-2xl border-white/10 transition-all duration-300 ease-in-out z-50 lg:z-30 transform lg:translate-x-0 glow-blue client-sidebar"
             :class="{
            ...
            <div class="flex flex-col h-full relative">
                ...
                <div class="flex items-center justify-between h-16 px-4 pt-8 border-b border-white/10">
                    <div class="flex items-center space-x-3 <?php echo e(app()->getLocale() == 'ar' ? 'space-x-reverse' : ''); ?> overflow-hidden">
                        ...
                        <div x-show="!sidebarCollapsed" x-cloak
                            ...
                            <?php if(setting('customer_panel_logo')): ?>
                                <img src="<?php echo e(asset('storage/' . setting('customer_panel_logo'))); ?>" 
                                     alt="<?php echo e(setting('company_name', 'Client Panel')); ?>" 
                                     class="h-8 lg:h-10 w-auto object-contain max-w-[160px] lg:max-w-[200px]">
                            <?php else: ?>
                                <img src="<?php echo e(asset('logo/pro Gineous_blue logo.svg')); ?>" 
                                     alt="Pro Gineous" 
                        ...
                        <div x-show="sidebarCollapsed" x-cloak
                            ...
                            <?php if(setting('customer_panel_logo_collapsed')): ?>
                                <img src="<?php echo e(asset('storage/' . setting('customer_panel_logo_collapsed'))); ?>" 
                                     alt="<?php echo e(setting('company_name', 'Client')); ?>" 
                                     class="h-8 lg:h-10 w-8 lg:w-10 object-contain">
                            <?php elseif(setting('customer_panel_logo')): ?>
                                <img src="<?php echo e(asset('storage/' . setting('customer_panel_logo'))); ?>" 
                                     alt="<?php echo e(setting('company_name', 'Client')); ?>" 
                                     class="h-8 lg:h-10 w-8 lg:w-10 object-contain">
                            <?php else: ?>
                ...
                <nav class="flex-1 px-3 py-6 space-y-2 overflow-y-auto sidebar-scroll">
                    ...
                    <a href="<?php echo e(route('client.dashboard')); ?>" 
                       class="menu-item group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 relative overflow-hidden shadow-depth <?php echo e(request()->routeIs('client.dashboard') ? 'bg-blue-100 text-blue-700 border-l-2 border-blue-600' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'); ?>"
                       :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                       x-tooltip="sidebarCollapsed ? '<?php echo e(__('frontend.dashboard')); ?>' : ''">
                        <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                             :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                            <svg class="w-5 h-5 <?php echo e(request()->routeIs('client.dashboard') ? 'text-blue-600' : 'group-hover:text-blue-600'); ?> transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span x-show="!sidebarCollapsed" x-cloak 
                            ...
                            <?php echo e(__('frontend.dashboard')); ?>
                    ...
                    <!-- AI Assistant -->
                    <a href="<?php echo e(route('ai.assistant')); ?>" 
                       class="menu-item group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 relative overflow-hidden shadow-depth <?php echo e(request()->routeIs('ai.*') ? 'bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700 border-l-2 border-blue-600' : 'text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50 hover:text-blue-600'); ?>"
                       :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                       x-tooltip="sidebarCollapsed ? 'ProGineous AI' : ''">
                        <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                             :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                            <svg class="w-5 h-5 <?php echo e(request()->routeIs('ai.*') ? 'text-blue-600' : 'group-hover:text-blue-600'); ?> transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span x-show="!sidebarCollapsed" x-cloak
                            ...
                            <?php echo e(app()->getLocale() == 'ar' ? 'جديد' : 'NEW'); ?>
                    ...
                    <div x-data="{ hostingOpen: false }">
                        <button @click="hostingOpen = !hostingOpen" 
                                ...
                                :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                                x-tooltip="sidebarCollapsed ? '<?php echo e(__('frontend.hosting')); ?>' : ''">
                            <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                                 :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                        ...
                        <div x-show="hostingOpen && !sidebarCollapsed" x-cloak
                             x-collapse
                             class="mt-2 space-y-1 <?php echo e(app()->getLocale() == 'ar' ? 'pr-6' : 'pl-6'); ?>">
                            
                            <!-- Shared Hosting -->
                            <a href="<?php echo e(route('client.hosting.index')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 dark:text-gray-400 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 rounded-lg transition-colors <?php echo e(request()->routeIs('client.hosting.index') || request()->routeIs('client.hosting.show') ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : ''); ?>">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- Cloud Hosting -->
                            <a href="<?php echo e(route('client.hosting.cloud')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 dark:text-gray-400 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 rounded-lg transition-colors <?php echo e(request()->routeIs('client.hosting.cloud') ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : ''); ?>">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"/>
                                </svg>
                                <?php echo e(__('frontend.cloud_hosting')); ?>

                            </a>
                            
                            <!-- Reseller Hosting -->
                            <a href="<?php echo e(route('client.hosting.reseller')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 dark:text-gray-400 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 rounded-lg transition-colors <?php echo e(request()->routeIs('client.hosting.reseller*') ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : ''); ?>">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                </svg>
                                <?php echo e(__('frontend.reseller_hosting')); ?>

                            </a>
                            
                            <!-- WordPress Hosting -->
                            <a href="<?php echo e(route('client.hosting.index')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 dark:text-gray-400 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 rounded-lg transition-colors">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> transition-colors" fill="currentColor" viewBox="0 0 97.75 97.75">
                            ...
                            <!-- VPS Hosting -->
                            <a href="<?php echo e(route('client.hosting.vps')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 dark:text-gray-400 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 rounded-lg transition-colors <?php echo e(request()->routeIs('client.hosting.vps') ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : ''); ?>">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01"/>
                                </svg>
                                <?php echo e(__('frontend.vps_hosting')); ?>

                            </a>
                            
                            <!-- Dedicated Servers -->
                            <a href="<?php echo e(route('client.hosting.dedicated')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 dark:text-gray-400 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 rounded-lg transition-colors <?php echo e(request()->routeIs('client.hosting.dedicated*') ? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20' : ''); ?>">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
                                </svg>
                                <?php echo e(__('frontend.dedicated_servers')); ?>
                    ...
                    <a href="#" 
                       ...
                       :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                       x-tooltip="sidebarCollapsed ? '<?php echo e(__('frontend.business_email')); ?>' : ''">
                        <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                             :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                    ...
                    <div x-data="{ domainsOpen: false }">
                        <button @click="domainsOpen = !domainsOpen" 
                                class="menu-item group w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 shadow-depth text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                                :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                                x-tooltip="sidebarCollapsed ? '<?php echo e(__('frontend.domains')); ?>' : ''">
                            <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                                 :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                        ...
                        <div x-show="domainsOpen && !sidebarCollapsed" x-cloak
                            ...
                            <!-- My Domains -->
                            <a href="<?php echo e(route('client.domains.index')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors <?php echo e(request()->routeIs('client.domains.*') ? 'bg-blue-50 text-blue-600' : ''); ?>">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 transition-colors <?php echo e(request()->routeIs('client.domains.*') ? 'text-blue-600' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"/>
                                </svg>
                                <?php echo e(app()->getLocale() == 'ar' ? 'نطاقاتي' : 'My Domains'); ?>

                            </a>
                            
                            <!-- New Domain -->
                            <a href="<?php echo e(route('domains.search')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                                </svg>
                                <?php echo e(app()->getLocale() == 'ar' ? 'نطاق جديد' : 'New Domain'); ?>

                            </a>
                            
                            <!-- Transfer Domain -->
                            <a href="<?php echo e(route('domains.transfer')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-data="{ billingOpen: false }">
                        <button @click="billingOpen = !billingOpen" 
                                class="menu-item group w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 shadow-depth text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                                :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                                x-tooltip="sidebarCollapsed ? '<?php echo e(app()->getLocale() == 'ar' ? 'الفواتير' : 'Billing'); ?>' : ''">
                            <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                                 :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                            ...
                            <span x-show="!sidebarCollapsed" x-cloak 
                                  ...
                                  x-transition:leave-end="opacity-0 transform translate-x-4"
                                  class="flex-1 whitespace-nowrap <?php echo e(app()->getLocale() == 'ar' ? 'mr-3 text-right' : 'ml-3 text-left'); ?>">
                                <?php echo e(app()->getLocale() == 'ar' ? 'الفواتير' : 'Billing'); ?>
                        ...
                        <div x-show="billingOpen && !sidebarCollapsed" x-cloak
                            ...
                            <!-- My Invoices -->
                            <a href="<?php echo e(route('client.invoices')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>
                                </svg>
                                <?php echo e(app()->getLocale() == 'ar' ? 'فواتيري' : 'My Invoices'); ?>

                            </a>
                            
                            <!-- Wallet -->
                            <a href="<?php echo e(route('client.wallet')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                                </svg>
                                <?php echo e(app()->getLocale() == 'ar' ? 'المحفظة' : 'Wallet'); ?>

                            </a>
                            
                            <!-- Add Funds -->
                            <a href="<?php echo e(route('client.wallet.add-funds')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
                                </svg>
                                <?php echo e(app()->getLocale() == 'ar' ? 'إضافة رصيد' : 'Add Funds'); ?>
                    ...
                    <div x-data="{ supportOpen: false }">
                        <button @click="supportOpen = !supportOpen" 
                                class="menu-item group w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 shadow-depth text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                                :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                                x-tooltip="sidebarCollapsed ? '<?php echo e(__('frontend.support')); ?>' : ''">
                            <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                                 :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                            ...
                            <span x-show="!sidebarCollapsed" x-cloak 
                                  ...
                                  x-transition:leave-end="opacity-0 transform translate-x-4"
                                  class="flex-1 whitespace-nowrap <?php echo e(app()->getLocale() == 'ar' ? 'mr-3 text-right' : 'ml-3 text-left'); ?>">
                                <?php echo e(__('frontend.support')); ?>
                        ...
                        <div x-show="supportOpen && !sidebarCollapsed" x-cloak
                            ...
                            <button @click="$dispatch('open-support-pin-modal')" class="w-full group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                ...
                                <?php echo e(app()->getLocale() == 'ar' ? 'رقم الدعم السري' : 'Support PIN'); ?>

                            </button>
                            
                            <!-- Tickets -->
                            <a href="<?php echo e(route('client.tickets.index')); ?>" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors <?php echo e(request()->routeIs('client.tickets.*') ? 'text-blue-600 bg-blue-50' : ''); ?>">
                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2'); ?> group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/>
                                </svg>
                                <?php echo e(app()->getLocale() == 'ar' ? 'التذاكر' : 'Tickets'); ?>
                            ...
                            <a href="#" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                ...
                                <?php echo e(app()->getLocale() == 'ar' ? 'الإعلانات' : 'Announcements'); ?>
                            ...
                            <a href="#" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                ...
                                <?php echo e(app()->getLocale() == 'ar' ? 'قاعدة المعرفة' : 'Knowledgebase'); ?>
                            ...
                            <a href="#" class="group flex items-center px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                ...
                                <?php echo e(app()->getLocale() == 'ar' ? 'حالة الشبكة' : 'Network Status'); ?>
                    ...
                    <a href="<?php echo e(route('settings.index')); ?>" 
                       class="menu-item group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 shadow-depth <?php echo e(request()->routeIs('settings.index') ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'); ?>"
                       :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                       x-tooltip="sidebarCollapsed ? '<?php echo e(__('frontend.account_settings')); ?>' : ''">
                        <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                             :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                            <svg class="w-5 h-5 group-hover:text-blue-600 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span x-show="!sidebarCollapsed" x-cloak 
                              ...
                              x-transition:leave-end="opacity-0 transform translate-x-4"
                              class="flex-1 whitespace-nowrap <?php echo e(app()->getLocale() == 'ar' ? 'mr-3 text-right' : 'ml-3 text-left'); ?>">
                            <?php echo e(__('frontend.account_settings')); ?>
                ...
                <div class="px-3 py-4 border-t border-white/10">
                    <a href="<?php echo e(route('home')); ?>" 
                       ...
                       :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                       x-tooltip="sidebarCollapsed ? '<?php echo e(app()->getLocale() == 'ar' ? 'الصفحة الرئيسية' : 'Home'); ?>' : ''">
                        <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                             :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                        ...
                        <span x-show="!sidebarCollapsed" x-cloak 
                              ...
                              x-transition:leave-end="opacity-0 transform translate-x-4"
                              class="flex-1 whitespace-nowrap <?php echo e(app()->getLocale() == 'ar' ? 'mr-3 text-right' : 'ml-3 text-left'); ?>">
                            <?php echo e(app()->getLocale() == 'ar' ? 'الصفحة الرئيسية' : 'Home'); ?>
                    ...
                    <a href="#" 
                       ...
                       :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                       x-tooltip="sidebarCollapsed ? '<?php echo e(app()->getLocale() == 'ar' ? 'استثمر معنا' : 'Invest'); ?>' : ''">
                        <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                             :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                            <img src="<?php echo e(asset('assets/images/1money-svgrepo-com.svg')); ?>" 
                                 alt="Invest" 
                        ...
                        <span x-show="!sidebarCollapsed" x-cloak 
                              ...
                              x-transition:leave-start="opacity-100 transform translate-x-0"
                              x-transition:leave-end="opacity-0 transform translate-x-4"
                              class="flex-1 whitespace-nowrap text-gray-900 font-bold <?php echo e(app()->getLocale() == 'ar' ? 'mr-3 text-right' : 'ml-3 text-left'); ?>">
                            <?php echo e(app()->getLocale() == 'ar' ? 'استثمر مع Pro Gineous' : 'Invest with Pro Gineous'); ?>

                        </span>
                    </a>
                    
                    <!-- Affiliates Button -->
                    <a href="<?php echo e(route('client.affiliate')); ?>" 
                       ...
                       :class="sidebarCollapsed ? 'justify-center px-0' : ''"
                       x-tooltip="sidebarCollapsed ? '<?php echo e(app()->getLocale() == 'ar' ? 'التسويق بالعمولة' : 'Affiliates'); ?>' : ''">
                        <div class="flex items-center justify-center w-6 h-6 flex-shrink-0" 
                             :class="sidebarCollapsed ? 'mx-auto' : '<?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>'">
                        ...
                        <span x-show="!sidebarCollapsed" x-cloak 
                              ...
                              x-transition:leave-end="opacity-0 transform translate-x-4"
                              class="flex-1 whitespace-nowrap text-gray-900 font-bold <?php echo e(app()->getLocale() == 'ar' ? 'mr-3 text-right' : 'ml-3 text-left'); ?>">
                            <?php echo e(app()->getLocale() == 'ar' ? 'التسويق بالعمولة' : 'Affiliates'); ?>
        ...
        <div class="flex-1 flex flex-col min-h-screen overflow-x-hidden"
             :class="sidebarCollapsed && window.innerWidth >= 1024 ? '<?php echo e(app()->getLocale() == 'ar' ? 'mr-16' : 'ml-16'); ?>' : '<?php echo e(app()->getLocale() == 'ar' ? 'mr-0 lg:mr-64' : 'ml-0 lg:ml-64'); ?>'">
                        ...
                        <div class="flex items-center gap-3 sm:gap-4 lg:gap-5 min-w-0 flex-1">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <h1 class="hidden lg:block text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent truncate">
                                    <?php echo $__env->yieldContent('page-title', __('frontend.dashboard')); ?>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-shrink-0">
                            ...
                            <div x-data="{ languageOpen: false }" class="relative">
                                ...
                                <div x-show="languageOpen" x-cloak
                                     ...
                                     class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'left-0' : 'right-0'); ?> mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-xl z-50 overflow-hidden">
                                    
                                    <!-- Arabic Option -->
                                    <a href="<?php echo e(route('language.switch', 'ar')); ?>" 
                                       class="flex items-center space-x-3 <?php echo e(app()->getLocale() == 'ar' ? 'space-x-reverse' : ''); ?> px-4 py-3 text-sm transition-all duration-200 <?php echo e(app()->getLocale() == 'ar' ? 'bg-blue-600/20 text-blue-900 border-l-2 border-blue-500' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
                                    ...
                                    <a href="<?php echo e(route('language.switch', 'en')); ?>" 
                                       class="flex items-center space-x-3 <?php echo e(app()->getLocale() == 'ar' ? 'space-x-reverse' : ''); ?> px-4 py-3 text-sm transition-all duration-200 <?php echo e(app()->getLocale() == 'en' ? 'bg-blue-600/20 text-blue-900 border-l-2 border-blue-500' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
                                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129"/>
                                        </svg>
                            ...
                            <div class="relative" x-data="{ notificationsOpen: false }">
                                ...
                                <?php if(isset($unreadNotificationsCount) && $unreadNotificationsCount > 0): ?>
                                    <span class="pulse-blue absolute -top-1 <?php echo e(app()->getLocale() == 'ar' ? '-left-1' : '-right-1'); ?> h-4 w-4 bg-red-500 rounded-full flex items-center justify-center shadow-lg">
                                        <span class="text-[10px] text-white font-bold leading-none"><?php echo e($unreadNotificationsCount); ?></span>
                                    </span>
                                <?php endif; ?>
                                ...
                                <div x-show="notificationsOpen" x-cloak
                                     ...
                                     class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'left-0' : 'right-0'); ?> mt-2 w-80 sm:w-96 bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden">
                                    ...
                                    <div class="px-4 py-3 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50">
                                        <div class="flex items-center justify-between">
                                            <h3 class="text-sm font-bold text-blue-900">
                                                <?php echo e(app()->getLocale() == 'ar' ? 'الإشعارات' : 'Notifications'); ?>

                                            </h3>
                                            <button id="markAllAsReadBtn" class="text-xs text-blue-600 hover:text-blue-700 font-medium">
                                                <?php echo e(app()->getLocale() == 'ar' ? 'تعليم الكل كمقروء' : 'Mark all as read'); ?>
                                            ...
                                            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="hover:bg-gray-50 transition-colors duration-200 border-b border-gray-100 cursor-pointer notification-item
                                                    <?php if(!$notification->read): ?>
                                                        <?php if($notification->type == 'deposit_success'): ?> bg-green-50/50
                                                        <?php elseif($notification->type == 'deposit_failed'): ?> bg-red-50/50
                                                        <?php elseif($notification->type == 'deposit_cancelled'): ?> bg-gray-50/50
                                                        <?php elseif($notification->type == 'deposit_pending'): ?> bg-yellow-50/50
                                                        <?php else: ?> bg-blue-50/50
                                                        <?php endif; ?>
                                                    <?php endif; ?>" 
                                                     data-notification-id="<?php echo e($notification->id); ?>"
                                                     data-is-read="<?php echo e($notification->read ? 'true' : 'false'); ?>">
                                                    <div class="block px-4 py-3">
                                                        <div class="flex items-start gap-3">
                                                            <div class="w-10 h-10 rounded-full 
                                                                <?php if($notification->type == 'transfer_sent'): ?> bg-purple-100
                                                                <?php elseif($notification->type == 'transfer_received'): ?> bg-blue-100
                                                                <?php elseif($notification->type == 'deposit_success'): ?> bg-green-100
                                                                <?php elseif($notification->type == 'deposit_failed'): ?> bg-red-100
                                                                <?php elseif($notification->type == 'deposit_cancelled'): ?> bg-gray-100
                                                                <?php elseif($notification->type == 'deposit_pending'): ?> bg-yellow-100
                                                                <?php else: ?> bg-blue-100
                                                                <?php endif; ?>
                                                                flex items-center justify-center flex-shrink-0">
                                                                <?php if($notification->type == 'transfer_sent'): ?>
                                                                    <svg class="w-5 h-5 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                                                                        <path d="M8 5a1 1 0 100 2h5.586l-1.293 1.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L13.586 5H8zM12 15a1 1 0 100-2H6.414l1.293-1.293a1 1 0 10-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L6.414 15H12z"/>
                                                                    </svg>
                                                                <?php elseif($notification->type == 'transfer_received'): ?>
                                                                    <svg class="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                                                                        <path d="M8 5a1 1 0 100 2h5.586l-1.293 1.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L13.586 5H8zM12 15a1 1 0 100-2H6.414l1.293-1.293a1 1 0 10-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L6.414 15H12z"/>
                                                                    </svg>
                                                                <?php elseif($notification->type == 'deposit_success'): ?>
                                                                    <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                                                    </svg>
                                                                <?php elseif($notification->type == 'deposit_failed'): ?>
                                                                    <svg class="w-5 h-5 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                                                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                                                                    </svg>
                                                                <?php elseif($notification->type == 'deposit_cancelled'): ?>
                                                                    <svg class="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                                                                        <path fill-rule="evenodd" d="M13.477 14.89A6 6 0 015.11 6.524l8.367 8.368zm1.414-1.414L6.524 5.11a6 6 0 018.367 8.367zM18 10a8 8 0 11-16 0 8 8 0 0116 0z" clip-rule="evenodd"/>
                                                                    </svg>
                                                                <?php elseif($notification->type == 'deposit_pending'): ?>
                                                            ...
                                                            <div class="flex-1 min-w-0">
                                                                <p class="text-sm font-semibold text-gray-900 mb-1"><?php echo e($notification->getLocalizedTitle()); ?></p>
                                                                <p class="text-xs text-gray-600"><?php echo e($notification->getLocalizedMessage()); ?></p>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="p-8 text-center">
                                                ...
                                                <p class="text-sm font-medium text-gray-600 mb-1">
                                                    <?php echo e(app()->getLocale() == 'ar' ? 'لا توجد إشعارات' : 'No notifications'); ?>

                                                </p>
                                                <p class="text-xs text-gray-500">
                                                    <?php echo e(app()->getLocale() == 'ar' ? 'سيتم عرض الإشعارات الجديدة هنا' : 'New notifications will appear here'); ?>
                            ...
                            <div class="relative" x-data="{ userDropdown: false }">
                                <button @click="userDropdown = !userDropdown" 
                                    ...
                                    <div class="avatar-glow w-9 h-9 lg:w-10 lg:h-10 rounded-full bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center text-white font-bold text-sm lg:text-base flex-shrink-0">
                                        <?php echo e(strtoupper(substr(auth('client')->user()->name ?? 'C', 0, 1))); ?>

                                    </div>
                                    
                                    <!-- User Info (Hidden on mobile) -->
                                    <div class="hidden lg:block min-w-0">
                                        <p class="text-sm font-semibold text-blue-900 truncate"><?php echo e(auth('client')->user()->name ?? 'العميل'); ?></p>
                                        <p class="text-xs text-gray-600 truncate"><?php echo e(__('frontend.client')); ?></p>
                                    </div>
                                ...
                                <div x-show="userDropdown" x-cloak
                                     ...
                                     class="absolute <?php echo e(app()->getLocale() == 'ar' ? 'left-0' : 'right-0'); ?> mt-2 w-48 bg-white/95 backdrop-blur-sm rounded-xl shadow-xl border border-gray-200 py-2 z-50">
                                    <div class="px-4 py-3 border-b border-gray-200">
                                        <p class="text-sm font-medium text-blue-900"><?php echo e(auth('client')->user()->name ?? __('frontend.client')); ?></p>
                                        <p class="text-xs text-gray-600"><?php echo e(auth('client')->user()->email ?? 'client@example.com'); ?></p>
                                    </div>
                                    <a href="<?php echo e(route('client.profile')); ?>" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors duration-200">
                                        <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
                                        </svg>
                                        <?php echo e(__('frontend.profile')); ?>

                                    </a>
                                    <a href="<?php echo e(route('settings.index')); ?>" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors duration-200">
                                        <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div class="border-t border-gray-200 mt-2">
                                        <form method="POST" action="<?php echo e(route('logout')); ?>" class="w-full">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="flex items-center w-full px-4 py-3 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 transition-colors duration-200 <?php echo e(app()->getLocale() == 'ar' ? 'text-right' : 'text-left'); ?>">
                                                <svg class="w-4 h-4 <?php echo e(app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3'); ?>" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div x-show="open"
                ...
                <div class="p-6">
                    <p class="text-gray-600 text-sm mb-4 text-center">
                        <?php echo e(app()->getLocale() == 'ar' ? 'استخدم هذا الرقم عند التواصل مع فريق الدعم للتحقق من هويتك' : 'Use this PIN when contacting support to verify your identity'); ?>
                    ...
                    <div class="bg-gradient-to-r from-slate-50 to-slate-100 rounded-xl p-6 border border-slate-200">
                        ...
                        <div class="mt-4 flex items-center justify-center gap-2">
                            ...
                            <span class="text-sm" :class="secondsLeft <= 30 ? 'text-amber-600 font-medium' : 'text-gray-500'">
                                <?php echo e(app()->getLocale() == 'ar' ? 'يتغير خلال' : 'Changes in'); ?>: 
                    ...
                    <button @click="copyPin()" 
                        ...
                        <span x-text="copied ? '<?php echo e(app()->getLocale() == 'ar' ? 'تم النسخ' : 'Copied'); ?>' : '<?php echo e(app()->getLocale() == 'ar' ? 'نسخ الرقم' : 'Copy PIN'); ?>'"></span>
                    </button>
                    ...
                    <div class="mt-4 flex items-start gap-2 text-xs text-amber-600 bg-amber-50 rounded-lg p-3">
                        ...
                        <span>
                            <?php echo e(app()->getLocale() == 'ar' ? 'هذا الرقم يتغير كل 15 دقيقة لحمايتك. لا تشاركه مع أي شخص.' : 'This PIN changes every 15 minutes for your security. Never share it with anyone.'); ?>
...
<?php /**PATH C:\laragon\www\resources\views/frontend/client/layout.blade.php ENDPATH**/ ?>