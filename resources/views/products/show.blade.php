...
@section('title', $product->name . ' - ' . __('frontend.configure_product') . ' - ' . config('app.name'))
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                    {{ __('frontend.customize_your_hosting_plan') }}
                </p>
            </div>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-slate-200/50 dark:border-slate-700/50">
                        <form id="configure-form" action="{{ route('cart.add-hosting') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="font-bold text-red-800 dark:text-red-200 mb-1">{{ __('frontend.error') }}</h3>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <label class="flex items-start p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border-2 border-slate-200 dark:border-slate-600 cursor-pointer hover:border-blue-500 dark:hover:border-blue-500 transition-colors has-[:checked]:border-blue-500 has-[:checked]:bg-blue-50 dark:has-[:checked]:bg-blue-900/20">
                                        ...
                                        <div class="{{ app()->getLocale() == 'ar' ? 'mr-3' : 'ml-3' }} flex-1">
                                            <div class="font-bold text-slate-900 dark:text-white mb-1">
                                                {{ __('frontend.new_domain_name') }}
                                            </div>
                                            <div class="text-sm text-slate-600 dark:text-slate-400">
                                                {{ __('frontend.new_domain_name_desc') }}
                                            </div>
                                        </div>
                                    </label>
                                    ...
                                    <label class="flex items-start p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border-2 border-slate-200 dark:border-slate-600 cursor-pointer hover:border-blue-500 dark:hover:border-blue-500 transition-colors has-[:checked]:border-blue-500 has-[:checked]:bg-blue-50 dark:has-[:checked]:bg-blue-900/20">
                                        ...
                                        <div class="{{ app()->getLocale() == 'ar' ? 'mr-3' : 'ml-3' }} flex-1">
                                            <div class="font-bold text-slate-900 dark:text-white mb-1">
                                                {{ __('frontend.existing_domain_name') }}
                                            </div>
                                            <div class="text-sm text-slate-600 dark:text-slate-400">
                                                {{ __('frontend.existing_domain_name_desc') }}
                                            </div>
                                        </div>
                                    </label>
                                </div>
                                ...
                                <div id="new-domain-options" class="mt-4 space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <label class="relative">
                                            ...
                                            <div class="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border-2 border-slate-200 dark:border-slate-600 cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition-all hover:border-blue-400">
                                                <div class="text-center">
                                                    <div class="font-bold text-slate-900 dark:text-white mb-1">
                                                        {{ __('frontend.already_in_cart') }}
                                                    </div>
                                                    <div class="text-xs text-slate-600 dark:text-slate-400">
                                                        {{ __('frontend.select_from_cart') }}
                                                    </div>
                                                </div>
                                            </div>
                                        </label>
                                        ...
                                        <label class="relative">
                                            ...
                                            <div class="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border-2 border-slate-200 dark:border-slate-600 cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition-all hover:border-blue-400">
                                                <div class="text-center">
                                                    <div class="font-bold text-slate-900 dark:text-white mb-1">
                                                        {{ __('frontend.new_purchase') }}
                                                    </div>
                                                    <div class="text-xs text-slate-600 dark:text-slate-400">
                                                        {{ __('frontend.search_new_domain') }}
                                                    </div>
                                                </div>
                                            </div>
                                        </label>
                                    ...
                                    <div id="domains-in-cart" class="mt-4">
                                        ...
                                        @if(count($domainsInCart) > 0)
                                            ...
                                            <select name="cart_domain" id="cart-domain-select" class="w-full px-4 py-3 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 dark:text-white">
                                                <option value="">{{ __('frontend.select_domain') }}</option>
                                                @foreach($domainsInCart as $key => $domain)
                                        ...
                                        @else
                                            <div class="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                                                <p class="text-sm text-amber-800 dark:text-amber-200 flex items-center gap-2">
                                                    ...
                                                    {{ __('frontend.no_domains_in_cart') }}
                                                </p>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div id="search-new-domain" class="mt-4 hidden">
                                        <label class="block text-sm font-bold text-slate-600 dark:text-slate-400 mb-2">
                                            {{ __('frontend.find_a_domain_name') }}
                                        </label>
                                        <div class="flex gap-2">
                                            <input type="text" id="domain-search" placeholder="{{ __('frontend.enter_domain_to_search') }}" class="flex-1 px-4 py-3 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 dark:text-white">
                                        ...
                                        <!-- Free Domain Notice -->
                                        @if(isset($product->free_domain_config) && !empty($product->free_domain_config))
                                        <div class="mt-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                                            <p class="text-sm text-green-800 dark:text-green-200 flex items-center gap-2">
                                                ...
                                                <span>
                                                    {{ __('frontend.free_domain_available') }}
                                                    <strong>
                                                        @if(isset($product->free_domain_config['tlds']))
                                                            {{ implode(', ', array_map(fn($tld) => '.' . $tld, $product->free_domain_config['tlds'])) }}
                                                        @endif
                                                    </strong>
                                                    {{ __('frontend.for_billing_cycles') }}
                                                    <strong>
                                                        @if(isset($product->free_domain_config['terms']))
                                                            {{ implode(', ', array_map(fn($term) => __('frontend.' . $term), $product->free_domain_config['terms'])) }}
                                                        @endif
                                                    </strong>
                                                </span>
                                            </p>
                                ...
                                <div id="existing-domain-input" class="mt-4 hidden">
                                    ...
                                    <p class="mt-2 text-xs text-slate-600 dark:text-slate-400">
                                        {{ __('frontend.existing_domain_note') }}
                                    </p>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    @foreach($pricingData as $cycle => $cycleData)
                                        @php
                                            $price = $cycleData['price'] ?? 0;
                                            $setupFee = $cycleData['setup_fee'] ?? 0;
                                        @endphp
                                        <label class="relative">
                                            <input type="radio" name="billing_cycle" value="{{ $cycle }}" data-price="{{ $price }}" data-setup="{{ $setupFee }}" class="peer sr-only" {{ $cycle == $firstCycle ? 'checked' : '' }} onchange="updatePrice()">
                                            <div class="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border-2 border-slate-200 dark:border-slate-600 cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition-all hover:border-blue-400">
                                                <div class="text-center">
                                                    ...
                                                    @if($setupFee > 0)
                                                        <div class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                                            +${{ number_format($setupFee, 2) }} {{ __('frontend.setup') }}
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            @if(isset($product->datacenter_locations) && !empty($product->datacenter_locations))
                            <div class="mb-8">
                                <label class="block text-lg font-bold text-slate-900 dark:text-white mb-4">
                                    <svg class="w-5 h-5 inline-block {{ app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                    {{ __('frontend.datacenter_location') }}
                                </label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    ...
                                    @foreach($datacenterLocations as $dcKey)
                                        @php
                                            $dcPrice = $datacenterPrices[$dcKey] ?? 0;
                                            $dcInfo = $datacenterInfo[$dcKey] ?? ['name' => ucfirst(str_replace('-', ' ', $dcKey)), 'flag' => 'un', 'country' => ''];
                                        @endphp
                                        <label class="relative cursor-pointer group">
                                            <input type="radio" name="datacenter" value="{{ $dcKey }}" data-dc-price="{{ $dcPrice }}" class="peer sr-only" {{ $dcKey == $firstDatacenter ? 'checked' : '' }} onchange="updateDatacenterPrice()" required>
                                            <div class="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border-2 border-slate-200 dark:border-slate-600 peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition-all hover:border-blue-400 hover:shadow-md">
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-3">
                                                        <span class="fi fi-{{ $dcInfo['flag'] }} text-3xl" style="font-size: 2.5rem; line-height: 1;"></span>
                                                        <div>
                                                    ...
                                                    @if($dcPrice > 0)
                                                        <div class="text-sm font-bold text-blue-600 dark:text-blue-400">
                                                            +${{ number_format($dcPrice, 2) }}/{{ __('frontend.month') }}
                                                        </div>
                                                    @else
                            ...
                            @if($product->enable_cpanel_tiers && $product->cpanelTiers->count() > 0)
                            <div class="mb-8">
                                <label class="block text-lg font-bold text-slate-900 dark:text-white mb-4">
                                    <svg class="w-5 h-5 inline-block {{ app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                                    </svg>
                                    {{ __('frontend.cpanel_accounts') }}
                                </label>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                        ...
                                        <div class="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border-2 border-slate-200 dark:border-slate-600 cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition-all hover:border-blue-400">
                                            <div class="text-center">
                                                <div class="text-2xl font-bold text-slate-900 dark:text-white mb-1">
                                                    {{ $product->base_cpanel_accounts }}
                                                </div>
                                                <div class="text-sm text-slate-600 dark:text-slate-400">
                                                    {{ __('frontend.accounts') }}
                                                </div>
                                    ...
                                    <!-- Additional Tiers -->
                                    @foreach($product->cpanelTiers->sortBy('tier') as $tier)
                                        <label class="relative">
                                            <input type="radio" 
                                                name="cpanel_tier" 
                                                value="{{ $tier->id }}" 
                                                data-tier-price-monthly="{{ $tier->monthly_price }}"
                                                data-tier-price-quarterly="{{ $tier->quarterly_price }}"
                                                data-tier-price-semi-annually="{{ $tier->semi_annually_price }}"
                                                data-tier-price-annually="{{ $tier->annually_price }}"
                                                data-tier-price-biennially="{{ $tier->biennially_price }}"
                                                data-tier-price-triennially="{{ $tier->triennially_price }}"
                                            ...
                                            <div class="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border-2 border-slate-200 dark:border-slate-600 cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition-all hover:border-blue-400">
                                                <div class="text-center">
                                                    ...
                                                    <div class="text-sm font-bold text-blue-600 dark:text-blue-400 mt-2">
                                                        +$<span class="tier-price-display">{{ number_format($tier->monthly_price, 2) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </label>
                            ...
                            <div class="mb-8">
                                <label class="block text-lg font-bold text-slate-900 dark:text-white mb-4">
                                    ...
                                    {{ __('frontend.additional_options') }}
                                </label>
                        ...
                        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 border border-slate-200 dark:border-slate-700">
                            ...
                            <div class="space-y-3 mb-6 pb-6 border-b border-slate-200 dark:border-slate-700">
                                <div class="flex justify-between items-center">
                                    <span class="text-slate-600 dark:text-slate-400">{{ __('frontend.setup_fee') }}</span>
                                    <span class="font-bold text-slate-900 dark:text-white" id="setup-display">{{ __('frontend.free') }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-slate-600 dark:text-slate-400">{{ __('frontend.hosting_price') }}</span>
                                ...
                                <div class="flex justify-between items-center hidden" id="domain-summary-row">
                                    <div class="flex flex-col">
                                        <span class="text-slate-600 dark:text-slate-400">{{ __('frontend.domain') }}</span>
                            ...
                            <div class="mb-6 p-4 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl">
                                <div class="flex justify-between items-center">
                                    <span class="text-white/90 text-sm font-medium">{{ __('frontend.total_today') }}</span>
                            ...
                            <a href="{{ route('hosting.shared') }}" class="block w-full py-3 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-900 dark:text-white text-center font-bold rounded-xl transition-all duration-300">
                            ...
                            <div class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700 space-y-2">
                                <div class="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                                    ...
                                    <span>{{ __('frontend.secure_checkout') }}</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                                    <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                                    </svg>
                                    <span>{{ __('frontend.ssl_encrypted') }}</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
                                    <svg class="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                    <span>{{ __('frontend.money_back_guarantee') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
const freeDomainConfig = @json($product->free_domain_config ?? null);
...
@endphp
const serverNameservers = @json($serverNameserversData);

// Translations for JavaScript
const translations = {
    domainVerified: '{{ __('frontend.domain_verified_existing') }}',
    dnsNameserversPoint: '{{ __('frontend.dns_nameservers_point') }}'
};
...
function searchDomain() {
    ...
    if (!domain) {
        alert('{{ __('frontend.please_enter_domain') }}');
        return;
    }
    ...
    .catch(error => {
        ...
        resultsDiv.innerHTML = '<div class="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-red-800 dark:text-red-200">{{ __('frontend.error_occurred') }}</div>';
    });
}
...
function displayDomainResults(results, searchedDomain) {
    ...
    results.forEach(result => {
        ...
        if (result.available) {
            ...
            const priceText = '<span class="' + priceColor + '">$' + displayPrice.toFixed(2) + '/{{ __('frontend.year') }}</span>';
            ...
            if (showFirstYearNote) {
                noteHtml = '<div class="text-xs text-amber-600 dark:text-amber-400 mt-1 flex items-center gap-1">' +
                    ...
                    '</svg>' +
                    '<span>{{ __('frontend.free_first_year_only') }}</span>' +
                    '</div>';
            }
                ...
                <div class="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-200 dark:border-slate-700 opacity-50">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-red-600 dark:text-red-400">{{ __('frontend.unavailable') }}</div>
                        </div>
                        <span class="text-slate-400">{{ __('frontend.taken') }}</span>
                    </div>
                </div>
            `;
        }
...
function selectDomain(domain, price, tld) {
    ...
    if (price === 0 || price === '0') {
        domainPriceDisplay.innerHTML = '<span class="text-green-600 dark:text-green-400">{{ __('frontend.free') }}</span>';
    } else {
    ...
    const priceDisplay = price === 0 || price === '0' 
        ? '<span class="text-green-600 dark:text-green-400 font-bold">{{ __('frontend.free') }}</span>'
        : '<span class="text-slate-900 dark:text-white">$' + parseFloat(price).toFixed(2) + '/{{ __('frontend.year') }}</span>';
...
function updatePrice() {
    ...
    document.getElementById('setup-display').textContent = setupFee > 0 ? '$' + setupFee.toFixed(2) : '{{ __('frontend.free') }}';
    ...
    if (selectedDomain) {
        ...
        if (selectedTld === 'EXISTING') {
            domainPriceDisplay.innerHTML = '<span class="text-slate-600 dark:text-slate-400">{{ __('frontend.existing') }}</span>';
        }
        // Check if domain is from cart (using FROM_CART marker)
            ...
            if (cartDomainSelect && cartDomainSelect.value === selectedDomain) {
                ...
                if (originalPrice === 0) {
                    domainPriceDisplay.innerHTML = '<span class="text-blue-600 dark:text-blue-400">{{ __('frontend.in_cart') }}</span>';
                } 
                // Re-check if domain qualifies for free domain with current billing cycle
                    ...
                    if (isFreeNow) {
                        ...
                        domainPriceDisplay.innerHTML = '<span class="text-green-600 dark:text-green-400 font-bold">{{ __('frontend.free') }}</span>';
                    } else {
                        // Domain has a price in cart - show "من السلة"
                        domainPriceDisplay.innerHTML = '<span class="text-blue-600 dark:text-blue-400">{{ __('frontend.from_cart') }}</span>';
                    }
                }
            }
        }
    ...
    if (existingDomainInput) {
        ...
        existingDomainInput.addEventListener('input', function() {
            ...
            resultsDiv.innerHTML = '<div class="p-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg">' +
                '<p class="text-slate-600 dark:text-slate-400 text-sm">{{ __('frontend.type_domain_name') }}...</p>' +
            '</div>';
            ...
            verifyTimeout = setTimeout(function() {
                ...
                if (isValid) {
                    ...
                    resultsDiv.innerHTML = '<div class="p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">' +
                        '<p class="text-yellow-800 dark:text-yellow-200 text-sm">{{ __('frontend.invalid_domain_format') }}</p>' +
                    '</div>';
                }
            }, 500);
        });
    ...
    fetch('/domains/check-existing', {
        ...
        .then(data => {
            ...
            if (data.success && data.can_use) {
                ...
                let errorMessage = data.message || '{{ __('frontend.error_verifying_domain') }}';
                let errorIcon = '';
        ...
        .catch(error => {
            ...
            resultsDiv.innerHTML = '<div class="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">' +
                '<p class="text-red-800 dark:text-red-200 text-sm">{{ __('frontend.error_verifying_domain') }}</p>' +
