...
<div class="max-w-3xl mx-auto p-6">
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">{{ __('tickets.open_new_ticket') }}</h1>
                <p class="text-gray-500 text-sm">{{ app()->getLocale() == 'ar' ? 'إنشاء تذكرة نيابة عن العميل' : 'Create a ticket on behalf of a client' }}</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.tickets.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-100">
                <h2 class="text-sm font-semibold text-gray-900 mb-5">{{ app()->getLocale() == 'ar' ? 'اختيار العميل' : 'Select Client' }}</h2>
                
                <div>
                    <label for="client_id" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('crm.client') }} <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
                        <select name="client_id" id="client_id" required
                                class="w-full appearance-none px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all cursor-pointer @error('client_id') border-red-400 bg-red-50 @enderror">
                            <option value="">{{ app()->getLocale() == 'ar' ? 'اختر العميل' : 'Select a client' }}</option>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="priority" id="priority" required
                                    class="w-full appearance-none px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all cursor-pointer @error('priority') border-red-400 bg-red-50 @enderror">
                                <option value="low" {{ old('priority') == 'low' ? 'selected' : '' }}>{{ __('tickets.priority_low') }}</option>
                                <option value="medium" {{ old('priority', 'medium') == 'medium' ? 'selected' : '' }}>{{ __('tickets.priority_medium') }}</option>
                ...
                <div class="mt-5">
                    ...
                    <div class="relative">
                        <select name="assigned_admin_id" id="assigned_admin_id"
                            ...
                            <option value="">{{ app()->getLocale() == 'ar' ? 'تعيين تلقائي لي' : 'Auto-assign to me' }}</option>
            ...
            <div class="p-6 bg-gray-50">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div class="flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <span>{{ app()->getLocale() == 'ar' ? 'سيتم إرسال إشعار للعميل' : 'Client will be notified' }}</span>
                    </div>
                    <button type="submit" 
