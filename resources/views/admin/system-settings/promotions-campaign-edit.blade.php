...
@section('title', __('crm.edit_campaign'))
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-slate-600 dark:text-slate-400">
                    {{ __('crm.edit_promotional_campaign_description') }}
                </p>
            </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800" x-data="{ 
        applyToAll: {{ $campaign->apply_to_all ? 'true' : 'false' }},
        ...
        <form action="{{ route('admin.system-settings.promotions.campaigns.update', $campaign->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="name_en"
                           value="{{ old('name_en', $campaign->name_en) }}"
                           required
                ...
                <div>
                    ...
                    <input type="text" 
                           name="name_ar"
                           value="{{ old('name_ar', $campaign->name_ar) }}"
                           required
                           dir="rtl"
                           class="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-600 focus:border-transparent"
            ...
            <div>
                ...
                <select name="type" 
                        required
                        class="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-600 focus:border-transparent">
                    <option value="seasonal" {{ $campaign->type === 'seasonal' ? 'selected' : '' }}>{{ __('crm.seasonal') }}</option>
                    <option value="product_launch" {{ $campaign->type === 'product_launch' ? 'selected' : '' }}>{{ __('crm.product_launch') }}</option>
                    <option value="loyalty_reward" {{ $campaign->type === 'loyalty_reward' ? 'selected' : '' }}>{{ __('crm.loyalty_reward') }}</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="number" 
                       ...
                       value="{{ old('discount_percentage', $campaign->discount_percentage) }}"
                       required
                       step="1"
                       min="0"
                       max="100"
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    <input type="checkbox" 
                           ...
                           id="apply_to_all"
                           value="1"
                           {{ old('apply_to_all', $campaign->apply_to_all) ? 'checked' : '' }}
                           x-model="applyToAll"
                        ...
                        <div x-show="showSharedHosting" x-transition class="p-4 space-y-2 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array('shared-' . $product->id, old('products', $campaign->products ?? [])) ? 'checked' : '' }}
                        ...
                        <div x-show="showCloudHosting" x-transition class="p-4 space-y-2 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array('cloud-' . $product->id, old('products', $campaign->products ?? [])) ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                        ...
                        <div x-show="showResellerHosting" x-transition class="p-4 space-y-2 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array('reseller-' . $product->id, old('products', $campaign->products ?? [])) ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                        ...
                        <div x-show="showVPS" x-transition class="p-4 space-y-2 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array('vps-' . $plan->id, old('products', $campaign->products ?? [])) ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                        ...
                        <div x-show="showDedicated" x-transition class="p-4 space-y-2 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array('dedicated-' . $plan->id, old('products', $campaign->products ?? [])) ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                        ...
                        <div x-show="showDomains" x-transition class="p-4 space-y-2 border-t border-slate-200 dark:border-slate-700 max-h-96 overflow-y-auto">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array('domain-' . $domain->id, old('products', $campaign->products ?? [])) ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                    ...
                    <div class="flex items-center p-3 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <input type="checkbox" 
                               ...
                               value="monthly"
                               id="cycle_monthly"
                               {{ in_array('monthly', old('billing_cycles', $campaign->billing_cycles ?? [])) ? 'checked' : '' }}
                               class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                    ...
                    <div class="flex items-center p-3 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <input type="checkbox" 
                               ...
                               value="quarterly"
                               id="cycle_quarterly"
                               {{ in_array('quarterly', old('billing_cycles', $campaign->billing_cycles ?? [])) ? 'checked' : '' }}
                               class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                    ...
                    <div class="flex items-center p-3 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <input type="checkbox" 
                               ...
                               {{ in_array('semi-annually', old('billing_cycles', $campaign->billing_cycles ?? [])) ? 'checked' : '' }}
                               class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                    ...
                    <div class="flex items-center p-3 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <input type="checkbox" 
                               ...
                               value="annually"
                               id="cycle_annually"
                               {{ in_array('annually', old('billing_cycles', $campaign->billing_cycles ?? [])) ? 'checked' : '' }}
                               class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                    ...
                    <div class="flex items-center p-3 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <input type="checkbox" 
                               ...
                               value="biennially"
                               id="cycle_biennially"
                               {{ in_array('biennially', old('billing_cycles', $campaign->billing_cycles ?? [])) ? 'checked' : '' }}
                               class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                    ...
                    <div class="flex items-center p-3 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <input type="checkbox" 
                               ...
                               {{ in_array('triennially', old('billing_cycles', $campaign->billing_cycles ?? [])) ? 'checked' : '' }}
                               class="w-4 h-4 text-blue-600 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 rounded focus:ring-blue-500">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start p-4 border-2 border-slate-200 dark:border-slate-700 rounded-lg hover:border-blue-300 dark:hover:border-blue-600 transition-colors">
                        <input type="radio" 
                               ...
                               value="all"
                               id="customer_all"
                               {{ old('customer_type', $campaign->customer_type) === 'all' ? 'checked' : '' }}
                    ...
                    <div class="flex items-start p-4 border-2 border-slate-200 dark:border-slate-700 rounded-lg hover:border-green-300 dark:hover:border-green-600 transition-colors">
                        <input type="radio" 
                               ...
                               value="new"
                               id="customer_new"
                               {{ old('customer_type', $campaign->customer_type) === 'new' ? 'checked' : '' }}
                    ...
                    <div class="flex items-start p-4 border-2 border-slate-200 dark:border-slate-700 rounded-lg hover:border-purple-300 dark:hover:border-purple-600 transition-colors">
                        <input type="radio" 
                               ...
                               {{ old('customer_type', $campaign->customer_type) === 'existing' ? 'checked' : '' }}
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800 rounded-lg">
                        <input type="checkbox" 
                               ...
                               id="once_per_order"
                               value="1"
                               {{ old('once_per_order', $campaign->once_per_order) ? 'checked' : '' }}
                    ...
                    <div class="flex items-start p-4 bg-rose-50 dark:bg-rose-900/10 border border-rose-200 dark:border-rose-800 rounded-lg">
                        <input type="checkbox" 
                               ...
                               id="once_per_client"
                               value="1"
                               {{ old('once_per_client', $campaign->once_per_client) ? 'checked' : '' }}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <textarea name="description_en" 
                              ...
                              required
                              class="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-600 focus:border-transparent"
                              placeholder="Get amazing discounts on all products...">{{ old('description_en', $campaign->description_en) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description_ar" 
                              ...
                              dir="rtl"
                              class="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-600 focus:border-transparent"
                              placeholder="احصل على خصومات مذهلة على جميع المنتجات...">{{ old('description_ar', $campaign->description_ar) }}</textarea>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-slate-200 dark:border-slate-800">
                ...
                <button type="submit" 
                    ...
                    <span>{{ __('crm.update_campaign') }}</span>
                </button>
            </div>
        </form>
    </div>
