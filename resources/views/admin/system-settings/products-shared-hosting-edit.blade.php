...
@section('page-title', __('crm.edit_shared_hosting'))
...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- Form -->
    <form id="shared-hosting-form" action="{{ route('admin.system-settings.products.shared-hosting.update', $product->id) }}" method="POST" class="space-y-6" onsubmit="return validateDomainRequirement()">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden" x-data="pricingForm()">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <!-- DEBUG: Alpine.js Payment Type -->
                    <div class="mb-3 p-3 bg-blue-100 border border-blue-300 rounded text-sm">
                        <strong>🔍 DEBUG - Alpine.js State:</strong><br>
                        <span x-text="'Current paymentType = ' + paymentType" class="font-mono bg-white px-2 py-1 rounded"></span>
                    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="flex items-start p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border-2 border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-all hover:border-blue-500 has-[:checked]:border-blue-500 has-[:checked]:bg-blue-50 dark:has-[:checked]:bg-blue-900/20">
                            <input type="radio" name="free_domain_type" value="reg_transfer" x-model="freeDomainType" {{ old('free_domain_type', $product->free_domain_config['type']) == 'reg_transfer' ? 'checked' : '' }}
                                   class="mt-1 w-4 h-4 text-blue-600 bg-white border-slate-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-slate-800 dark:bg-slate-700 dark:border-slate-600">
                            <div class="{{ app()->getLocale() == 'ar' ? 'mr-3' : 'ml-3' }} flex-1">
                                <div class="text-sm font-medium text-slate-900 dark:text-white">
                        ...
                        <label class="flex items-start p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border-2 border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-all hover:border-blue-500 has-[:checked]:border-blue-500 has-[:checked]:bg-blue-50 dark:has-[:checked]:bg-blue-900/20">
                            <input type="radio" name="free_domain_type" value="reg_transfer_renewal" x-model="freeDomainType" {{ old('free_domain_type', $product->free_domain_config['type']) == 'reg_transfer_renewal' ? 'checked' : '' }}
                                   class="mt-1 w-4 h-4 text-blue-600 bg-white border-slate-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-slate-800 dark:bg-slate-700 dark:border-slate-600">
                            <div class="{{ app()->getLocale() == 'ar' ? 'mr-3' : 'ml-3' }} flex-1">
                                <div class="text-sm font-medium text-slate-900 dark:text-white">
