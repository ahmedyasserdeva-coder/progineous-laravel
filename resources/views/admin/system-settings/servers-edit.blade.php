...
@section('title', __('crm.edit_server'))

@section('page-title', __('crm.edit_server'))
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            <nav class="flex items-center space-x-2 {{ app()->getLocale() == 'ar' ? 'space-x-reverse' : '' }} text-sm">
                ...
                <span class="text-slate-700 dark:text-slate-300 font-medium">{{ __('crm.edit_server') }}</span>
            </nav>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-white">{{ __('crm.edit_server') }}</h2>
                        <p class="text-blue-100 text-sm mt-1">{{ __('crm.edit_server_desc') }}</p>
                    </div>
                </div>
            </div>

            <!-- Form -->
            <form action="{{ route('admin.system-settings.servers.update', $server) }}" method="POST" class="p-6 space-y-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="type" 
                                ...
                                <option value="custom" {{ old('type', $server->type) == 'custom' ? 'selected' : '' }}>{{ __('crm.custom') }}</option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="assigned_ips" 
                                  ...
                                  placeholder="{{ __('crm.assigned_ips_placeholder') }}">{{ old('assigned_ips', $server->assigned_ips) }}</textarea>
                        @error('assigned_ips')
                            <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" 
                                       ...
                                       class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                       placeholder="{{ __('crm.leave_blank_to_keep_current') }}">
                                <button type="button" 
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="api_token" 
                                   name="api_token" 
                                   value="{{ old('api_token', $server->api_token) }}"
                                   autocomplete="off"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nameserver1" 
                                   name="nameserver1" 
                                   value="{{ old('nameserver1', $server->nameserver1) }}"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nameserver1_ip" 
                                   name="nameserver1_ip" 
                                   value="{{ old('nameserver1_ip', $server->nameserver1_ip) }}"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                   placeholder="192.168.1.1">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nameserver2" 
                                   name="nameserver2" 
                                   value="{{ old('nameserver2', $server->nameserver2) }}"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nameserver2_ip" 
                                   name="nameserver2_ip" 
                                   value="{{ old('nameserver2_ip', $server->nameserver2_ip) }}"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nameserver3" 
                                   name="nameserver3" 
                                   value="{{ old('nameserver3', $server->nameserver3) }}"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nameserver3_ip" 
                                   name="nameserver3_ip" 
                                   value="{{ old('nameserver3_ip', $server->nameserver3_ip) }}"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nameserver4" 
                                   name="nameserver4" 
                                   value="{{ old('nameserver4', $server->nameserver4) }}"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nameserver4_ip" 
                                   name="nameserver4_ip" 
                                   value="{{ old('nameserver4_ip', $server->nameserver4_ip) }}"
                                   class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                        ...
                        <label class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                            ...
                            <div class="relative">
                                <input type="checkbox" 
                                       ...
                                       name="status" 
                                       value="1"
                                       {{ old('status', $server->status) ? 'checked' : '' }}
                                       class="sr-only peer">
...
async function testConnection() {
    ...
    const apiTokenValue = document.getElementById('api_token')?.value || '';
    
    // إذا كان كلاهما فارغ، سيقوم Controller باستدعائهما من قاعدة البيانات
    ...
    const formData = {
        ...
        server_id: {{ $server->id }}, // إرسال معرف السيرفر لاستدعاء البيانات من قاعدة البيانات
        _token: '{{ csrf_token() }}'
    };
