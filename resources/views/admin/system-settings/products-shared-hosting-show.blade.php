        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-6">
                ...
                <div>
                    ...
                    @if($product->tagline)
                        <p class="text-blue-100 text-lg">{{ $product->tagline }}</p>
                    @endif
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.system-settings.products.shared-hosting.edit', $product->id) }}" class="flex items-center gap-2 px-5 py-3 bg-white/20 hover:bg-white/30 text-white rounded-lg transition-colors backdrop-blur-sm">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/10 rounded-lg p-6 border border-blue-200 dark:border-blue-800">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-blue-700 dark:text-blue-400">${{ number_format($product->price, 2) }}</p>
                                </div>
                            </div>
                            <div class="pt-3 border-t border-blue-200 dark:border-blue-800">
                                <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full bg-blue-600 text-white">
                ...
                <div class="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        @if($product->datacenter_locations && is_array($product->datacenter_locations) && count($product->datacenter_locations) > 0)
                            <span class="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg text-sm font-medium">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach($product->datacenter_locations as $location)
                            @if(isset($locationMap[$location]))
                                <div class="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-md transition-all">
                                    <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <div class="flex justify-end">
                                        ...
                                        @else
                                            <span class="inline-flex px-3 py-1.5 text-xs font-semibold bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg">
                                                {{ __('crm.included') }}
                                            </span>
                                        @endif
                                    </div>
                ...
                @else
                    ...
                    <div class="text-center py-8">
                        <div class="flex flex-col items-center">
                            ...
                            <a href="{{ route('admin.system-settings.products.shared-hosting.edit', $product->id) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-700">
                        ...
                        <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <form action="{{ route('admin.system-settings.products.shared-hosting.destroy', $product->id) }}" method="POST" onsubmit="return confirm('{{ app()->getLocale() == 'ar' ? 'هل أنت متأكد من حذف هذه الخطة؟ لا يمكن التراجع عن هذا الإجراء.' : 'Are you sure you want to delete this plan? This action cannot be undone.' }}');">
                        @csrf
                        @method('DELETE')
                ...
                <div class="p-6 space-y-3">
                    ...
                    @if($freeDomainEnabled)
                        ...
                        <div class="pb-3 border-b border-slate-200 dark:border-slate-700">
                            ...
                            <span class="inline-flex px-3 py-1 text-sm font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded">
