...
@section('page-title', __('crm.add_reseller_hosting'))
...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-3xl font-bold text-slate-900 dark:text-white mb-2">
                    {{ __('crm.add_reseller_hosting') }}
                </h1>
                <p class="text-slate-600 dark:text-slate-400">
                    {{ __('crm.create_new_reseller_hosting_plan') }}
                </p>
            </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.system-settings.products.reseller-hosting.store') }}" method="POST" class="space-y-6">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label class="flex items-start p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                            <input type="checkbox" name="require_domain" value="1" {{ old('require_domain') ? 'checked' : '' }}
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
            ...
            <div class="p-6 space-y-6" x-data="{ enableCpanelTiers: {{ old('enable_cpanel_tiers', '0') == '1' ? 'true' : 'false' }} }">
                ...
                <div>
                    ...
                    <input type="number" id="base_cpanel_accounts" name="base_cpanel_accounts" value="{{ old('base_cpanel_accounts', '25') }}" min="0" required
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                        ...
                        <div class="flex-1">
                            <label for="enable_cpanel_tiers" class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" id="enable_cpanel_tiers" name="enable_cpanel_tiers" value="1" 
                                       {{ old('enable_cpanel_tiers') == '1' ? 'checked' : '' }}
                            ...
                            <div class="p-4 bg-slate-50 dark:bg-slate-900/50">
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                                    <div>
                                        ...
                                        <input type="number" name="cpanel_50_monthly" value="{{ old('cpanel_50_monthly', '0') }}" min="0" step="0.01"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="cpanel_50_quarterly" value="{{ old('cpanel_50_quarterly', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.semi_annually') }}</label>
                                        <input type="number" name="cpanel_50_semi_annually" value="{{ old('cpanel_50_semi_annually', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.annually') }}</label>
                                        <input type="number" name="cpanel_50_annually" value="{{ old('cpanel_50_annually', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.biennially') }}</label>
                                        <input type="number" name="cpanel_50_biennially" value="{{ old('cpanel_50_biennially', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.triennially') }}</label>
                                        <input type="number" name="cpanel_50_triennially" value="{{ old('cpanel_50_triennially', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                            ...
                            <div class="p-4 bg-slate-50 dark:bg-slate-900/50">
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.monthly') }}</label>
                                        <input type="number" name="cpanel_100_monthly" value="{{ old('cpanel_100_monthly', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.quarterly') }}</label>
                                        <input type="number" name="cpanel_100_quarterly" value="{{ old('cpanel_100_quarterly', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.semi_annually') }}</label>
                                        <input type="number" name="cpanel_100_semi_annually" value="{{ old('cpanel_100_semi_annually', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.annually') }}</label>
                                        <input type="number" name="cpanel_100_annually" value="{{ old('cpanel_100_annually', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.biennially') }}</label>
                                        <input type="number" name="cpanel_100_biennially" value="{{ old('cpanel_100_biennially', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.triennially') }}</label>
                                        <input type="number" name="cpanel_100_triennially" value="{{ old('cpanel_100_triennially', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                            ...
                            <div class="p-4 bg-slate-50 dark:bg-slate-900/50">
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.monthly') }}</label>
                                        <input type="number" name="cpanel_200_monthly" value="{{ old('cpanel_200_monthly', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.quarterly') }}</label>
                                        <input type="number" name="cpanel_200_quarterly" value="{{ old('cpanel_200_quarterly', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.semi_annually') }}</label>
                                        <input type="number" name="cpanel_200_semi_annually" value="{{ old('cpanel_200_semi_annually', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.annually') }}</label>
                                        <input type="number" name="cpanel_200_annually" value="{{ old('cpanel_200_annually', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.biennially') }}</label>
                                        <input type="number" name="cpanel_200_biennially" value="{{ old('cpanel_200_biennially', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.triennially') }}</label>
                                        <input type="number" name="cpanel_200_triennially" value="{{ old('cpanel_200_triennially', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                            ...
                            <div class="p-4 bg-slate-50 dark:bg-slate-900/50">
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.monthly') }}</label>
                                        <input type="number" name="cpanel_300_monthly" value="{{ old('cpanel_300_monthly', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.quarterly') }}</label>
                                        <input type="number" name="cpanel_300_quarterly" value="{{ old('cpanel_300_quarterly', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.semi_annually') }}</label>
                                        <input type="number" name="cpanel_300_semi_annually" value="{{ old('cpanel_300_semi_annually', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.annually') }}</label>
                                        <input type="number" name="cpanel_300_annually" value="{{ old('cpanel_300_annually', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.biennially') }}</label>
                                        <input type="number" name="cpanel_300_biennially" value="{{ old('cpanel_300_biennially', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('crm.triennially') }}</label>
                                        <input type="number" name="cpanel_300_triennially" value="{{ old('cpanel_300_triennially', '0') }}" min="0" step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Auto-calculate cPanel Tier 50 prices
        const cpanel50Monthly = document.querySelector('input[name="cpanel_50_monthly"]');
        if (cpanel50Monthly) {
            cpanel50Monthly.addEventListener('input', function() {
                const monthlyPrice = parseFloat(this.value) || 0;
                document.querySelector('input[name="cpanel_50_quarterly"]').value = (monthlyPrice * 3).toFixed(2);
                document.querySelector('input[name="cpanel_50_semi_annually"]').value = (monthlyPrice * 6).toFixed(2);
                document.querySelector('input[name="cpanel_50_annually"]').value = (monthlyPrice * 12).toFixed(2);
                document.querySelector('input[name="cpanel_50_biennially"]').value = (monthlyPrice * 24).toFixed(2);
                document.querySelector('input[name="cpanel_50_triennially"]').value = (monthlyPrice * 36).toFixed(2);
            });
        }

        // Auto-calculate cPanel Tier 100 prices
        const cpanel100Monthly = document.querySelector('input[name="cpanel_100_monthly"]');
        if (cpanel100Monthly) {
            cpanel100Monthly.addEventListener('input', function() {
                const monthlyPrice = parseFloat(this.value) || 0;
                document.querySelector('input[name="cpanel_100_quarterly"]').value = (monthlyPrice * 3).toFixed(2);
                document.querySelector('input[name="cpanel_100_semi_annually"]').value = (monthlyPrice * 6).toFixed(2);
                document.querySelector('input[name="cpanel_100_annually"]').value = (monthlyPrice * 12).toFixed(2);
                document.querySelector('input[name="cpanel_100_biennially"]').value = (monthlyPrice * 24).toFixed(2);
                document.querySelector('input[name="cpanel_100_triennially"]').value = (monthlyPrice * 36).toFixed(2);
            });
        }

        // Auto-calculate cPanel Tier 200 prices
        const cpanel200Monthly = document.querySelector('input[name="cpanel_200_monthly"]');
        if (cpanel200Monthly) {
            cpanel200Monthly.addEventListener('input', function() {
                const monthlyPrice = parseFloat(this.value) || 0;
                document.querySelector('input[name="cpanel_200_quarterly"]').value = (monthlyPrice * 3).toFixed(2);
                document.querySelector('input[name="cpanel_200_semi_annually"]').value = (monthlyPrice * 6).toFixed(2);
                document.querySelector('input[name="cpanel_200_annually"]').value = (monthlyPrice * 12).toFixed(2);
                document.querySelector('input[name="cpanel_200_biennially"]').value = (monthlyPrice * 24).toFixed(2);
                document.querySelector('input[name="cpanel_200_triennially"]').value = (monthlyPrice * 36).toFixed(2);
            });
        }

        // Auto-calculate cPanel Tier 300 prices
        const cpanel300Monthly = document.querySelector('input[name="cpanel_300_monthly"]');
        if (cpanel300Monthly) {
            cpanel300Monthly.addEventListener('input', function() {
                const monthlyPrice = parseFloat(this.value) || 0;
                document.querySelector('input[name="cpanel_300_quarterly"]').value = (monthlyPrice * 3).toFixed(2);
                document.querySelector('input[name="cpanel_300_semi_annually"]').value = (monthlyPrice * 6).toFixed(2);
                document.querySelector('input[name="cpanel_300_annually"]').value = (monthlyPrice * 12).toFixed(2);
                document.querySelector('input[name="cpanel_300_biennially"]').value = (monthlyPrice * 24).toFixed(2);
                document.querySelector('input[name="cpanel_300_triennially"]').value = (monthlyPrice * 36).toFixed(2);
            });
        }
    });
</script>
