...
@section('page-title', __('crm.add_cloud_hosting'))
...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- Form -->
    <form id="cloud-hosting-form" action="{{ route('admin.system-settings.products.cloud-hosting.store') }}" method="POST" class="space-y-6" onsubmit="return validateDomainRequirement()">
        @csrf
