...
@section('page-title', __('crm.create_new_dedicated_plan'))
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-600 dark:text-slate-400">
            {{ __('crm.create_new_dedicated_plan') }}
        </p>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.system-settings.products.dedicated-plans.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="plan_tagline" id="plan_tagline" value="{{ old('plan_tagline') }}"
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    @error('plan_tagline')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="plan_short_description" id="plan_short_description" rows="3"
                              class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">{{ old('plan_short_description') }}</textarea>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="cpu_type" id="cpu_type" value="{{ old('cpu_type') }}" required
                ...
                <div>
                    ...
                    <input type="number" name="cpu_cores" id="cpu_cores" value="{{ old('cpu_cores', 1) }}" required min="1"
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    @error('cpu_cores')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="cpu_threads" id="cpu_threads" value="{{ old('cpu_threads') }}" min="1"
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    @error('cpu_threads')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="cpu_frequency" id="cpu_frequency" value="{{ old('cpu_frequency') }}"
                           placeholder="3.2 GHz"
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    @error('cpu_frequency')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="number" name="ram_gb" id="ram_gb" value="{{ old('ram_gb', 1) }}" required min="1"
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    @error('ram_gb')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="storage_type" id="storage_type" required
                        ...
                        <option value="SATA" {{ old('storage_type') == 'SATA' ? 'selected' : '' }}>SATA</option>
                    </select>
                    @error('storage_type')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="storage_total_gb" id="storage_total_gb" value="{{ old('storage_total_gb', 10) }}" required min="10"
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white"
                ...
                <div>
                    ...
                    <input type="number" name="disk_count" id="disk_count" value="{{ old('disk_count', 1) }}" min="1"
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white"
                           onchange="updateStorageConfig()">
                    @error('disk_count')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="text" name="storage_config" id="storage_config" value="{{ old('storage_config') }}" required
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="bandwidth" id="bandwidth" value="{{ old('bandwidth', 'Unmetered') }}" required
                ...
                <div>
                    ...
                    <input type="number" name="ipv4_count" id="ipv4_count" value="{{ old('ipv4_count', 1) }}" required min="1"
                           class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    @error('ipv4_count')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <label for="enable_ipv6" class="flex items-center {{ app()->getLocale() == 'ar' ? 'space-x-reverse' : '' }} space-x-2 cursor-pointer">
                        <input type="checkbox" name="enable_ipv6" id="enable_ipv6" value="1" {{ old('enable_ipv6', true) ? 'checked' : '' }}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="monthly_price" id="monthly_price" value="{{ old('monthly_price') }}" required min="0" step="0.01"
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2.5 text-slate-500 dark:text-slate-400">$</span>
                        <input type="number" name="quarterly_price" id="quarterly_price" value="{{ old('quarterly_price') }}" min="0" step="0.01"
                               class="w-full pl-8 pr-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2.5 text-slate-500 dark:text-slate-400">$</span>
                        <input type="number" name="semi_annually_price" id="semi_annually_price" value="{{ old('semi_annually_price') }}" min="0" step="0.01"
                               class="w-full pl-8 pr-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2.5 text-slate-500 dark:text-slate-400">$</span>
                        <input type="number" name="annually_price" id="annually_price" value="{{ old('annually_price') }}" min="0" step="0.01"
                               class="w-full pl-8 pr-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2.5 text-slate-500 dark:text-slate-400">$</span>
                        <input type="number" name="setup_fee" id="setup_fee" value="{{ old('setup_fee', 0) }}" min="0" step="0.01"
                               class="w-full pl-8 pr-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    </div>
                    @error('setup_fee')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="text" name="setup_time" id="setup_time" value="{{ old('setup_time', '24-48 hours') }}"
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2.5 text-slate-500 dark:text-slate-400">$</span>
                        <input type="number" name="cpanel_price" id="cpanel_price" value="{{ old('cpanel_price', 0) }}" min="0" step="0.01"
                               class="w-full pl-8 pr-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    </div>
                    @error('cpanel_price')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2.5 text-slate-500 dark:text-slate-400">$</span>
                        <input type="number" name="plesk_price" id="plesk_price" value="{{ old('plesk_price', 0) }}" min="0" step="0.01"
                               class="w-full pl-8 pr-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:text-white">
                    </div>
                    @error('plesk_price')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="auto_setup" class="flex items-center {{ app()->getLocale() == 'ar' ? 'space-x-reverse' : '' }} space-x-2 cursor-pointer">
                        <input type="checkbox" name="auto_setup" id="auto_setup" value="1" {{ old('auto_setup', true) ? 'checked' : '' }}
                               class="w-5 h-5 text-purple-600 border-slate-300 rounded focus:ring-purple-500 dark:border-slate-600 dark:bg-slate-700">
                ...
                <div>
                    <label for="allow_ipmi" class="flex items-center {{ app()->getLocale() == 'ar' ? 'space-x-reverse' : '' }} space-x-2 cursor-pointer">
                        <input type="checkbox" name="allow_ipmi" id="allow_ipmi" value="1" {{ old('allow_ipmi', true) ? 'checked' : '' }}
                               class="w-5 h-5 text-purple-600 border-slate-300 rounded focus:ring-purple-500 dark:border-slate-600 dark:bg-slate-700">
                ...
                <div>
                    <label for="allow_custom_os" class="flex items-center {{ app()->getLocale() == 'ar' ? 'space-x-reverse' : '' }} space-x-2 cursor-pointer">
                        <input type="checkbox" name="allow_custom_os" id="allow_custom_os" value="1" {{ old('allow_custom_os', true) ? 'checked' : '' }}
                               class="w-5 h-5 text-purple-600 border-slate-300 rounded focus:ring-purple-500 dark:border-slate-600 dark:bg-slate-700">
                ...
                <div>
                    <label for="allow_raid_config" class="flex items-center {{ app()->getLocale() == 'ar' ? 'space-x-reverse' : '' }} space-x-2 cursor-pointer">
                        <input type="checkbox" name="allow_raid_config" id="allow_raid_config" value="1" {{ old('allow_raid_config', true) ? 'checked' : '' }}
                               class="w-5 h-5 text-purple-600 border-slate-300 rounded focus:ring-purple-500 dark:border-slate-600 dark:bg-slate-700">
...
document.addEventListener('DOMContentLoaded', function() {
    // Only auto-fill if storage_config is empty
    if (!document.getElementById('storage_config').value) {
        updateStorageConfig();
    }
});
</script>
