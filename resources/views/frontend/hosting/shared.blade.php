        ...
        <div class="max-w-4xl mx-auto">
            <div class="text-center">
                ...
                <h1 class="text-4xl lg:text-6xl font-bold mb-4" dir="auto">
                    ...
                    <span class="block bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">{{ __('frontend.shared_hosting_hero_highlight') }}</span>
                </h1>
                ...
                <div class="mt-8">
                    <a href="#plans" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white text-lg font-bold rounded-xl shadow-lg hover:shadow-xl transition-all">
                        <span dir="auto">{{ __('frontend.start_now') }}</span>
                ...
                <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-sm border border-green-100 dark:border-green-800/50">
                        ...
                        <span class="text-sm font-semibold text-gray-700 dark:text-gray-300" dir="auto">{{ __('frontend.100_uptime') }}</span>
                    </div>
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-sm border border-green-100 dark:border-green-800/50">
                        <svg class="w-4 h-4 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span class="text-sm font-semibold text-gray-700 dark:text-gray-300" dir="auto">{{ __('frontend.highest_performance') }}</span>
                    </div>
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-sm border border-green-100 dark:border-green-800/50">
                        <svg class="w-4 h-4 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span class="text-sm font-semibold text-gray-700 dark:text-gray-300" dir="auto">{{ __('frontend.cpanel_control') }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 lg:px-8">
        <div class="max-w-6xl mx-auto">
            ...
            @if($plans->count() > 0)
                ...
                @endphp
                <div class="grid grid-cols-1 md:grid-cols-{{ $gridCols }} gap-8 items-start max-w-6xl mx-auto">
                    @foreach($plans as $index => $plan)
                        ...
                        <div id="plan-card-{{ $plan->id }}" class="relative w-full {{ $isPopular ? 'bg-gradient-to-br from-blue-600 to-blue-700 md:-mt-4 md:mb-4' : 'bg-white dark:bg-gray-800' }} rounded-2xl p-8 shadow-xl {{ $isPopular ? '' : 'border-2 border-gray-200 dark:border-gray-700' }} hover:shadow-2xl transition-all">
                            <!-- Popular Badge -->
                            @if($isPopular)
                            ...
                            <div class="text-center mb-6">
                                <h3 class="text-2xl font-bold {{ $isPopular ? 'text-white' : 'text-gray-900 dark:text-white' }} mb-2" dir="auto">
                                    {{ $plan->name }}
                                </h3>
                            ...
                            @if($freeDomainConfig && isset($freeDomainConfig['type']) && in_array($freeDomainConfig['type'], ['reg_transfer', 'first_year']))
                                <div class="mb-6">
                                    <div class="inline-flex items-center justify-center w-full gap-2 px-4 py-2.5 {{ $isPopular ? 'bg-white/10 border-white/30' : 'bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 border-blue-200 dark:border-blue-700' }} rounded-xl border">
                                        <svg class="w-4 h-4 {{ $isPopular ? 'text-white' : 'text-blue-600 dark:text-blue-400' }}" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        </svg>
                                        <div class="flex-1 text-center">
                                            <span class="text-sm font-semibold {{ $isPopular ? 'text-white' : 'text-gray-900 dark:text-white' }}" dir="auto">
                                                {{ __('frontend.free_domain') }}
                                            </span>
                                            @if(isset($freeDomainConfig['tlds']) && is_array($freeDomainConfig['tlds']) && count($freeDomainConfig['tlds']) > 0)
                                                <span class="ml-2 text-xs {{ $isPopular ? 'text-blue-100' : 'text-blue-600 dark:text-cyan-400' }}" dir="ltr">
                                                    (@foreach($freeDomainConfig['tlds'] as $index => $tld){{ $index > 0 ? ', ' : '' }}.{{ strtolower($tld) }}@endforeach)
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <!-- Price Display -->
                            <div class="pricing-display text-center mb-8" data-plan-id="{{ $plan->id }}">
                                <div class="flex items-baseline justify-center gap-2">
                                    <span class="text-5xl font-black {{ $isPopular ? 'text-white' : 'text-blue-600 dark:text-blue-400' }}">
                                        $<span class="price-amount">{{ number_format($plan->pricing['recurring']['monthly']['price'] ?? $plan->price ?? 0, 2) }}</span>
                                    </span>
                                    <span class="text-lg {{ $isPopular ? 'text-blue-100' : 'text-gray-600 dark:text-gray-400' }} price-period" dir="auto">
                                        /{{ __('frontend.month') }}
                                    </span>
                                </div>
                            </div>
                            ...
                            @if($plan->datacenter_locations && is_array($plan->datacenter_locations) && count($plan->datacenter_locations) > 0)
                                ...
                                <div class="mb-6">
                                    <label class="block text-center mb-2">
                                        <span class="text-xs font-semibold {{ $isPopular ? 'text-white' : 'text-gray-600 dark:text-gray-400' }} uppercase" dir="auto">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="absolute top-1/2 -translate-y-1/2 pointer-events-none {{ app()->getLocale() == 'ar' ? 'left-3' : 'right-3' }}">
                                            <svg class="w-4 h-4 {{ $isPopular ? 'text-white' : 'text-gray-500 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"></path>
                                            </svg>
                                        </div>
                                    </div>
                            ...
                            <!-- Features List -->
                            <ul class="space-y-4 mb-8" id="features-list-{{ $plan->id }}">
                                @if(is_array($features) && count($features) > 0)
                                    @foreach($features as $featureIndex => $feature)
                                        <li class="flex items-start gap-3 {{ $featureIndex >= 6 ? 'hidden feature-extra-' . $plan->id : '' }}" data-plan-id="{{ $plan->id }}">
                                            <svg class="w-5 h-5 {{ $isPopular ? 'text-white' : 'text-green-500' }} flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                            </svg>
                                            <span class="text-base {{ $isPopular ? 'text-white' : 'text-gray-700 dark:text-gray-300' }}" dir="auto">
                            ...
                            @if(is_array($features) && count($features) > 6)
                                <div class="text-center mb-6">
                                    <button 
                                        ...
                                        class="inline-flex items-center gap-2 px-4 py-2 {{ $isPopular ? 'bg-white/20 hover:bg-white/30 text-white' : 'bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300' }} rounded-lg text-sm font-medium transition-all"
                                    >
                                        <span id="toggle-text-{{ $plan->id }}">{{ __('frontend.show_more') }}</span>
                                        <svg id="toggle-icon-{{ $plan->id }}" class="w-4 h-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- CTA Button -->
                            <a href="{{ route('products.show', $plan->id) }}" class="block w-full text-center px-6 py-4 {{ $isPopular ? 'bg-white text-blue-600 hover:bg-gray-50' : 'bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white' }} font-bold text-base rounded-xl shadow-lg hover:shadow-xl transition-all">
