...
@section('title', __('frontend.shared_hosting') . ' - ' . __('frontend.best_shared_hosting_provider'))

@section('meta_description', __('frontend.shared_hosting_meta_desc') ?? 'استضافة مشتركة بأفضل الأسعار مع مساحة تخزين غير محدودة، دومين مجاني، SSL مجاني، cPanel، وأداء عالي. ابدأ موقعك الآن مع Pro Gineous.')

@section('meta_keywords', __('frontend.shared_hosting_keywords') ?? 'استضافة مشتركة, استضافة مواقع, shared hosting, web hosting, استضافة رخيصة, دومين مجاني, SSL مجاني, cPanel, استضافة سريعة, استضافة آمنة, Pro Gineous')

@push('meta')
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="{{ __('frontend.shared_hosting') }} - {{ __('frontend.best_shared_hosting_provider') ?? 'Pro Gineous' }}">
    <meta property="og:description" content="{{ __('frontend.shared_hosting_meta_desc') ?? 'استضافة مشتركة بأفضل الأسعار مع مساحة تخزين غير محدودة، دومين مجاني، SSL مجاني، وأداء عالي' }}">
    <meta property="og:image" content="{{ asset('assets/image.png') }}">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt" content="{{ __('frontend.shared_hosting') }} - Pro Gineous">
    ...
    <meta property="twitter:title" content="{{ __('frontend.shared_hosting') }} - {{ __('frontend.best_shared_hosting_provider') ?? 'Pro Gineous' }}">
    <meta property="twitter:description" content="{{ __('frontend.shared_hosting_meta_desc') ?? 'استضافة مشتركة بأفضل الأسعار مع مساحة تخزين غير محدودة' }}">
    <meta property="twitter:image" content="{{ asset('assets/image.png') }}">
    <meta property="twitter:image:alt" content="{{ __('frontend.shared_hosting') }} - Pro Gineous">
    <meta name="twitter:site" content="@ProGineous">
    <meta name="twitter:creator" content="@ProGineous">

    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="{{ __('frontend.shared_hosting') }} - Pro Gineous">
    <meta itemprop="description" content="{{ __('frontend.shared_hosting_meta_desc') ?? 'استضافة مشتركة بأفضل الأسعار' }}">
    <meta itemprop="image" content="{{ asset('assets/image.png') }}">
...
<section class="relative isolate overflow-hidden py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 dark:from-slate-950 dark:via-blue-950/30 dark:to-purple-950/20">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
        <div class="max-w-7xl xl:max-w-6xl 2xl:max-w-5xl mx-auto">
            
            <div class="w-full grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 xl:gap-12 items-center">
                <!-- Left Content -->
                <div class="w-full text-center lg:text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} order-2 lg:order-1 {{ app()->getLocale() == 'ar' ? 'lg:pr-0' : 'lg:pl-0' }}">
                    <!-- Trust Badge -->
                    <div class="mb-4 sm:mb-6 md:mb-8 inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-blue-50 dark:bg-blue-900/20 px-2.5 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 animate-fade-in-up mx-auto lg:{{ app()->getLocale() == 'ar' ? 'mr-0' : 'ml-0' }}">
                        <div class="flex -space-x-1.5 sm:-space-x-2">
                            <div class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 border-2 border-white dark:border-gray-800 flex items-center justify-center">
                                <svg class="w-2 h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                </svg>
                            </div>
                            <div class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 border-2 border-white dark:border-gray-800 flex items-center justify-center">
                                <svg class="w-2 h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"/>
                                </svg>
                            </div>
                            <div class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full bg-gradient-to-br from-blue-400 to-blue-500 border-2 border-white dark:border-gray-800 flex items-center justify-center">
                                <svg class="w-2 h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd"/>
                                </svg>
                            </div>
                        </div>
                        <span class="text-[10px] sm:text-xs md:text-sm font-semibold text-blue-600 dark:text-blue-400" dir="auto">
                            {{ __('frontend.trusted_by') }} <span class="text-gray-900 dark:text-white">50,000+</span> {{ __('frontend.customers') }}
                        </span>
                    </div>

                    <!-- Main Title -->
                    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight leading-tight animate-fade-in-up animation-delay-200" dir="auto">
                        <span class="block text-gray-900 dark:text-white">{{ __('frontend.shared_hosting_hero_title') }}</span>
                        <span class="block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{{ __('frontend.shared_hosting_hero_highlight') }}</span>
                    </h1>
                    
                    <!-- Subtitle -->
                    <p class="mt-3 sm:mt-4 md:mt-6 text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-xl mx-auto lg:{{ app()->getLocale() == 'ar' ? 'mr-0' : 'ml-0' }} animate-fade-in-up animation-delay-400" dir="auto">
                        {{ __('frontend.shared_hosting_hero_subtitle') }}
                    </p>

                    <!-- CTA Buttons -->
                    <div class="mt-5 sm:mt-6 md:mt-10 flex flex-col sm:flex-row items-center lg:{{ app()->getLocale() == 'ar' ? 'justify-end' : 'justify-start' }} justify-center gap-2.5 sm:gap-3 md:gap-4 animate-fade-in-up animation-delay-600">
                        <a href="#plans" class="group relative inline-flex items-center justify-center gap-2 sm:gap-2.5 md:gap-3 px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm sm:text-base md:text-lg font-bold rounded-xl md:rounded-2xl shadow-lg sm:shadow-xl md:shadow-2xl shadow-blue-600/50 hover:shadow-blue-600/70 hover:scale-105 transition-all duration-300 overflow-hidden w-full sm:w-auto">
                            ...
                            <span class="relative" dir="auto">{{ __('frontend.start_now') }}</span>
                            <svg class="relative w-4 h-4 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                            </svg>
                        </a>
                        
                        <a href="#features" class="group inline-flex items-center justify-center gap-2 sm:gap-2.5 md:gap-3 px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm sm:text-base md:text-lg font-bold rounded-xl md:rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-blue-600 dark:hover:border-blue-500 hover:shadow-xl transition-all duration-300 w-full sm:w-auto">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span dir="auto">{{ __('frontend.watch_demo') }}</span>
                        </a>
                    </div>

                    <!-- Trust Indicators Pills -->
                    <div class="mt-4 sm:mt-6 md:mt-8 flex flex-wrap items-center lg:{{ app()->getLocale() == 'ar' ? 'justify-end' : 'justify-start' }} justify-center gap-2 sm:gap-3 md:gap-4 animate-fade-in-up animation-delay-800">
                        <div class="inline-flex items-center gap-1 sm:gap-1.5 md:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 bg-green-50 dark:bg-green-900/20 rounded-full">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-[10px] sm:text-xs md:text-sm font-semibold text-gray-700 dark:text-gray-300" dir="auto">{{ __('frontend.100_uptime') }}</span>
                        </div>
                        <div class="inline-flex items-center gap-1 sm:gap-1.5 md:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 bg-green-50 dark:bg-green-900/20 rounded-full">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-[10px] sm:text-xs md:text-sm font-semibold text-gray-700 dark:text-gray-300" dir="auto">{{ __('frontend.highest_performance') }}</span>
                        </div>
                        <div class="inline-flex items-center gap-1 sm:gap-1.5 md:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 bg-green-50 dark:bg-green-900/20 rounded-full">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-[10px] sm:text-xs md:text-sm font-semibold text-gray-700 dark:text-gray-300" dir="auto">{{ __('frontend.true_stability') }}</span>
                        </div>
                        <div class="inline-flex items-center gap-1 sm:gap-1.5 md:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 bg-green-50 dark:bg-green-900/20 rounded-full">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-[10px] sm:text-xs md:text-sm font-semibold text-gray-700 dark:text-gray-300" dir="auto">{{ __('frontend.data_protection') }}</span>
                        </div>
                        <div class="inline-flex items-center gap-1 sm:gap-1.5 md:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 bg-green-50 dark:bg-green-900/20 rounded-full">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-[10px] sm:text-xs md:text-sm font-semibold text-gray-700 dark:text-gray-300" dir="auto">{{ __('frontend.cpanel_control') }}</span>
                        </div>
                    </div>
                </div>

                <!-- Right Illustration -->
                <div class="w-full relative order-1 lg:order-2 animate-fade-in-up animation-delay-400 px-2 sm:px-0 flex items-center justify-center">
                    <div class="relative mx-auto" style="width: 100%; max-width: 380px; max-height: 420px;">
                        <!-- Shared Hosting Package Card -->
                        <div class="relative perspective-1000">
                            <!-- Main Package Card -->
                            <div class="relative transform-gpu hover:rotate-y-6 transition-all duration-700 ease-out" style="transform-style: preserve-3d;">
                                <!-- Glowing Background -->
                                <div class="absolute inset-0 bg-gradient-to-br from-blue-500/30 via-purple-500/30 to-pink-500/30 rounded-lg sm:rounded-xl md:rounded-2xl blur-lg sm:blur-xl animate-pulse"></div>
                                
                                <!-- Main Card -->
                                <div class="relative bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 shadow-lg sm:shadow-xl border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-xl">
                                    <!-- Header -->
                                    <div class="text-center mb-2 sm:mb-3 md:mb-4">
                                        <div class="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 aspect-square bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg sm:rounded-xl md:rounded-2xl shadow-md sm:shadow-lg shadow-blue-500/50 mb-2 sm:mb-2.5 md:mb-3 rotate-3 hover:rotate-0 transition-transform duration-300">
                                            <svg class="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"/>
                                            </svg>
                                        </div>
                                        <h3 class="text-sm sm:text-base md:text-lg lg:text-xl font-black text-gray-900 dark:text-white mb-1">{{ __('frontend.shared_hosting') }}</h3>
                                        <p class="text-[9px] sm:text-[10px] md:text-xs text-gray-500 dark:text-gray-400">{{ __('frontend.perfect_for_websites') }}</p>
                                    </div>

                                    <!-- Features Grid -->
                                    <div class="space-y-1.5 sm:space-y-2 md:space-y-2.5 mb-2.5 sm:mb-3 md:mb-4">
                                        <!-- Unlimited Storage -->
                                        <div class="group flex items-center gap-1.5 sm:gap-2 md:gap-3 p-1.5 sm:p-2 md:p-2.5 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-md sm:rounded-lg md:rounded-xl border border-blue-200/50 dark:border-blue-700/50 hover:scale-105 transition-transform duration-300">
                                            <div class="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 aspect-square bg-gradient-to-br from-blue-500 to-cyan-500 rounded-md sm:rounded-lg flex items-center justify-center shadow-sm sm:shadow-md shadow-blue-500/30">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="text-[10px] sm:text-xs md:text-sm font-black bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent truncate">{{ __('frontend.unlimited_storage') }}</div>
                                                <div class="text-[8px] sm:text-[9px] md:text-[10px] text-gray-600 dark:text-gray-400 truncate">{{ __('frontend.ssd_nvme') }}</div>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                                </svg>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Unlimited Bandwidth -->
                                        <div class="group flex items-center gap-1.5 sm:gap-2 md:gap-3 p-1.5 sm:p-2 md:p-2.5 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-md sm:rounded-lg md:rounded-xl border border-purple-200/50 dark:border-purple-700/50 hover:scale-105 transition-transform duration-300">
                                            <div class="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 aspect-square bg-gradient-to-br from-purple-500 to-pink-500 rounded-md sm:rounded-lg flex items-center justify-center shadow-sm sm:shadow-md shadow-purple-500/30">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clip-rule="evenodd"/>
                                                </svg>
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="text-[10px] sm:text-xs md:text-sm font-black bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent truncate">{{ __('frontend.unlimited_bandwidth') }}</div>
                                                <div class="text-[8px] sm:text-[9px] md:text-[10px] text-gray-600 dark:text-gray-400 truncate">{{ __('frontend.unmetered_traffic') }}</div>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        ...
                                        <!-- Free SSL -->
                                        <div class="group flex items-center gap-1.5 sm:gap-2 md:gap-3 p-1.5 sm:p-2 md:p-2.5 bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 rounded-md sm:rounded-lg md:rounded-xl border border-emerald-200/50 dark:border-emerald-700/50 hover:scale-105 transition-transform duration-300">
                                            <div class="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 aspect-square bg-gradient-to-br from-emerald-500 to-green-500 rounded-md sm:rounded-lg flex items-center justify-center shadow-sm sm:shadow-md shadow-emerald-500/30">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"/>
                                                </svg>
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="text-[10px] sm:text-xs md:text-sm font-black bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent truncate">{{ __('frontend.free_ssl_certificate') }}</div>
                                                <div class="text-[8px] sm:text-[9px] md:text-[10px] text-gray-600 dark:text-gray-400 truncate">{{ __('frontend.secure_your_site') }}</div>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        ...
                                        <!-- cPanel -->
                                        <div class="group flex items-center gap-1.5 sm:gap-2 md:gap-3 p-1.5 sm:p-2 md:p-2.5 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-md sm:rounded-lg md:rounded-xl border border-orange-200/50 dark:border-orange-700/50 hover:scale-105 transition-transform duration-300">
                                            <div class="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 aspect-square bg-gradient-to-br from-orange-500 to-amber-500 rounded-md sm:rounded-lg flex items-center justify-center shadow-sm sm:shadow-md shadow-orange-500/30">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/>
                                                </svg>
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="text-[10px] sm:text-xs md:text-sm font-black bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent truncate">{{ __('frontend.cpanel_included') }}</div>
                                                <div class="text-[8px] sm:text-[9px] md:text-[10px] text-gray-600 dark:text-gray-400 truncate">{{ __('frontend.easy_management') }}</div>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                    ...
                                    <!-- Bottom Badge -->
                                    <div class="flex items-center justify-center gap-1 sm:gap-1.5 md:gap-2 p-1.5 sm:p-2 md:p-2.5 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-md sm:rounded-lg md:rounded-xl border border-green-200/50 dark:border-green-700/50">
                                        <div class="relative">
                                            <div class="w-2 h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3 bg-green-500 rounded-full animate-pulse"></div>
                                            <div class="absolute inset-0 w-2 h-2 sm:w-2.5 sm:h-2.5 md:w-3 md:h-3 bg-green-500 rounded-full animate-ping"></div>
                                        </div>
                                        <div class="text-[9px] sm:text-[10px] md:text-xs font-black text-gray-900 dark:text-white">{{ __('frontend.ready_to_start') }}</div>
                                        <div class="text-xs sm:text-sm md:text-base lg:text-lg font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">{{ __('frontend.now') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="absolute -z-10 -top-8 sm:-top-10 md:-top-20 -right-8 sm:-right-10 md:-right-20 w-32 h-32 sm:w-40 sm:h-40 md:w-60 md:h-60 lg:w-80 lg:h-80 bg-gradient-to-br from-blue-400/30 via-purple-400/30 to-pink-400/30 rounded-full blur-xl sm:blur-2xl md:blur-3xl animate-pulse"></div>
                        <div class="absolute -z-10 -bottom-8 sm:-bottom-10 md:-bottom-20 -left-8 sm:-left-10 md:-left-20 w-32 h-32 sm:w-40 sm:h-40 md:w-60 md:h-60 lg:w-80 lg:h-80 bg-gradient-to-br from-cyan-400/30 via-blue-400/30 to-purple-400/30 rounded-full blur-xl sm:blur-2xl md:blur-3xl animate-pulse" style="animation-delay: 1s"></div>
                        
                        <!-- Orbiting Dots - Hidden on small screens -->
                        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] -z-10 hidden md:block">
                            <div class="absolute top-0 left-1/2 w-2 h-2 sm:w-3 sm:h-3 bg-blue-500 rounded-full shadow-lg shadow-blue-500/50 animate-ping"></div>
                            <div class="absolute bottom-0 left-1/2 w-2 h-2 sm:w-3 sm:h-3 bg-purple-500 rounded-full shadow-lg shadow-purple-500/50 animate-ping" style="animation-delay: 0.5s"></div>
                            <div class="absolute top-1/2 left-0 w-2 h-2 sm:w-3 sm:h-3 bg-pink-500 rounded-full shadow-lg shadow-pink-500/50 animate-ping" style="animation-delay: 1s"></div>
                            <div class="absolute top-1/2 right-0 w-2 h-2 sm:w-3 sm:h-3 bg-cyan-500 rounded-full shadow-lg shadow-cyan-500/50 animate-ping" style="animation-delay: 1.5s"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" aria-hidden="true">
        <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-blue-500 to-purple-600 opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div>
</section>

<!-- Pricing Plans Section -->
<section id="plans" class="py-16 sm:py-20 lg:py-24 bg-gray-50 dark:bg-gray-800">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        <div class="max-w-7xl xl:max-w-6xl 2xl:max-w-5xl mx-auto">
        <!-- Section Header -->
        <div class="text-center mb-8 md:mb-10 lg:mb-12 xl:mb-16">
            <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-3 md:mb-4 lg:mb-6 px-4" dir="auto">
                {{ __('frontend.choose_your_plan') }}
            </h2>
            <p class="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto px-4" dir="auto">
                {{ __('frontend.choose_plan_desc') }}
            </p>
        </div>
        ...
        <div class="flex justify-center mb-8 md:mb-10 lg:mb-12 px-4">
            <div class="w-full sm:w-auto sm:min-w-[280px] md:min-w-[320px] lg:min-w-[360px]">
                ...
                <div class="relative">
                    <!-- Label -->
                    <label class="block text-center mb-2.5">
                        <span class="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide" dir="auto">
                            {{ __('frontend.select_billing_period') ?? 'اختر فترة الدفع' }}
                        </span>
                    </label>
                    ...
                    <div class="relative">
                        <select 
                            ...
                            class="w-full appearance-none {{ app()->getLocale() == 'ar' ? 'text-right pr-4 sm:pr-5 pl-12' : 'text-left pl-4 sm:pl-5 pr-12' }} py-3 sm:py-3.5 text-sm sm:text-base font-semibold text-gray-900 dark:text-white bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl shadow-md hover:shadow-xl hover:border-blue-400 dark:hover:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500/30 focus:border-blue-500 dark:focus:border-blue-400 transition-all duration-300 cursor-pointer"
                            dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}"
                        >
                            @foreach($billingPeriods as $period => $data)
                                <option value="{{ $period }}" {{ $loop->first ? 'selected' : '' }}>
                                    {{ $data['label'] }}
                                    @if($data['discount'])
                                        • {{ __('frontend.save_up_to') }} {{ $data['discount'] }}
                                    @endif
                                </option>
                            @endforeach
                        </select>
                        ...
                        <!-- Custom Arrow Icon -->
                        <div class="absolute top-1/2 -translate-y-1/2 pointer-events-none {{ app()->getLocale() == 'ar' ? 'left-4' : 'right-4' }}">
                    ...
                    <!-- Decorative Element -->
                    <div class="absolute -top-1 {{ app()->getLocale() == 'ar' ? 'left-1/2 -translate-x-1/2' : 'left-1/2 -translate-x-1/2' }} w-12 h-0.5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"></div>
                </div>
            </div>
        </div>
        ...
        @if($plans->count() > 0)
            ...
            @endphp
            <div class="grid grid-cols-1 md:grid-cols-{{ $gridCols }} auto-cols-max gap-4 sm:gap-6 md:gap-6 lg:gap-8 items-start justify-items-center max-w-7xl mx-auto" style="align-items: flex-start;">
                    @foreach($plans as $index => $plan)
                        @php
                            $isPopular = $index == 1 && $plans->count() >= 3; // Middle plan is popular
                            
                            // Check features based on language
                            $currentLocale = app()->getLocale();
                            
                            if ($currentLocale === 'ar' && $plan->features_list_ar) {
                                // Use Arabic features if available
                        ...
                        <div id="plan-card-{{ $plan->id }}" class="relative w-full max-w-[380px] {{ $isPopular ? 'bg-gradient-to-br from-blue-600 to-indigo-700 md:scale-105' : 'bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700' }} rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300" style="align-self: flex-start;">
                            <!-- Popular Badge -->
                            @if($isPopular)
                                <div class="absolute -top-3 md:-top-4 left-1/2 transform -translate-x-1/2">
                                    <span class="inline-block px-4 md:px-6 py-1.5 md:py-2 bg-yellow-400 text-gray-900 font-bold text-xs md:text-sm rounded-full shadow-lg">
                            ...
                            <div class="text-center mb-4 md:mb-6">
                                <h3 class="text-xl md:text-2xl font-bold {{ $isPopular ? 'text-white' : 'text-gray-900 dark:text-white' }} mb-2" dir="auto">
                                    {{ $plan->name }}
                                </h3>
                                
                                <!-- Plan Tagline (if exists) -->
                                @if($plan->tagline)
                                    <p class="text-sm font-semibold {{ $isPopular ? 'text-yellow-300' : 'text-blue-600 dark:text-blue-400' }} mb-2" dir="auto">
                                        {{ $plan->tagline }}
                                    </p>
                                @endif
                                ...
                                @if($plan->short_description)
                                    <p class="text-sm {{ $isPopular ? 'text-blue-100' : 'text-gray-600 dark:text-gray-400' }}" dir="auto">
                            ...
                            @if($freeDomainConfig && isset($freeDomainConfig['type']) && in_array($freeDomainConfig['type'], ['reg_transfer', 'first_year']))
                                <div class="text-center mb-4">
                                    <div class="inline-flex items-center gap-2 px-4 py-2 {{ $isPopular ? 'bg-white/20 backdrop-blur-sm' : 'bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20' }} rounded-full border {{ $isPopular ? 'border-white/30' : 'border-emerald-200 dark:border-emerald-700' }}">
                                        <svg class="w-4 h-4 {{ $isPopular ? 'text-yellow-300' : 'text-emerald-600 dark:text-emerald-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"></path>
                                        </svg>
                                        <span class="text-xs font-bold {{ $isPopular ? 'text-white' : 'text-emerald-700 dark:text-emerald-300' }}" dir="auto">
                                            {{ __('frontend.free_domain') }}
                                            @if(isset($freeDomainConfig['terms']) && in_array('annually', $freeDomainConfig['terms']))
                                                <span class="text-[10px] opacity-80">({{ __('frontend.first_year') }})</span>
                                            @endif
                                        </span>
                                    </div>
                                    ...
                                    @if(isset($freeDomainConfig['tlds']) && is_array($freeDomainConfig['tlds']) && count($freeDomainConfig['tlds']) > 0)
                                        <div class="mt-2 flex flex-wrap items-center justify-center gap-1.5">
                                            @foreach($freeDomainConfig['tlds'] as $tld)
                                                <span class="inline-flex items-center gap-1 px-2.5 py-1 text-[10px] md:text-xs font-semibold {{ $isPopular ? 'bg-white/10 text-white border-white/20' : 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700' }} rounded-md border">
                                                    <svg class="w-2.5 h-2.5 md:w-3 md:h-3 {{ $isPopular ? 'text-yellow-300' : 'text-emerald-500' }}" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                                    </svg>
                                                    .{{ strtolower($tld) }}
                                                </span>
                            ...
                            <!-- Price Display -->
                            <div class="pricing-display text-center mb-6 md:mb-8" data-plan-id="{{ $plan->id }}">
                                <div class="flex items-center justify-center gap-1 md:gap-2">
                                    <span class="text-3xl md:text-4xl lg:text-5xl font-black {{ $isPopular ? 'text-white' : 'text-blue-600 dark:text-blue-400' }}">
                                        $<span class="price-amount">{{ number_format($plan->pricing['recurring']['monthly']['price'] ?? $plan->price ?? 0, 2) }}</span>
                                    </span>
                                    <span class="text-sm md:text-base {{ $isPopular ? 'text-blue-100' : 'text-gray-600 dark:text-gray-400' }} price-period" dir="auto">
                                        /{{ __('frontend.month') }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <script>
                                window.planPrices_{{ $plan->id }} = {
                                    monthly: parseFloat({{ $plan->pricing['recurring']['monthly']['price'] ?? $plan->price ?? 0 }}),
                                    quarterly: parseFloat({{ $plan->pricing['recurring']['quarterly']['price'] ?? (($plan->pricing['recurring']['monthly']['price'] ?? $plan->price ?? 0) * 3) }}),
                                    semiannually: parseFloat({{ $plan->pricing['recurring']['semi_annually']['price'] ?? (($plan->pricing['recurring']['monthly']['price'] ?? $plan->price ?? 0) * 6) }}),
                                    annually: parseFloat({{ $plan->pricing['recurring']['annually']['price'] ?? (($plan->pricing['recurring']['monthly']['price'] ?? $plan->price ?? 0) * 12) }}),
                                    biennially: parseFloat({{ $plan->pricing['recurring']['biennially']['price'] ?? (($plan->pricing['recurring']['monthly']['price'] ?? $plan->price ?? 0) * 24) }}),
                                    triennially: parseFloat({{ $plan->pricing['recurring']['triennially']['price'] ?? (($plan->pricing['recurring']['monthly']['price'] ?? $plan->price ?? 0) * 36) }})
                                };
                                
                                // Store datacenter prices
                                window.datacenterPrices_{{ $plan->id }} = {
                                    @if($plan->datacenter_price && is_array($plan->datacenter_price))
                                        @foreach($plan->datacenter_price as $location => $price)
                                            '{{ $location }}': parseFloat({{ $price ?? 0 }}),
                                        @endforeach
                                    @endif
                                };
                                
                                console.log('Plan {{ $plan->id }} ({{ $plan->name }}) prices loaded:', window.planPrices_{{ $plan->id }});
                                console.log('Plan {{ $plan->id }} datacenter prices:', window.datacenterPrices_{{ $plan->id }});
                            </script>

                            <!-- Datacenter Location Selector -->
                            @if($plan->datacenter_locations && is_array($plan->datacenter_locations) && count($plan->datacenter_locations) > 0)
                                @php
                                    $datacenterInfo = [
                                ...
                                <div class="mb-6 md:mb-8">
                                    <label class="block text-center mb-2.5">
                                        <span class="text-xs font-semibold {{ $isPopular ? 'text-white' : 'text-gray-600 dark:text-gray-400' }} uppercase tracking-wide" dir="auto">
                                            <svg class="w-4 h-4 inline-block {{ $isPopular ? 'text-yellow-300' : 'text-blue-500 dark:text-blue-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                            {{ __('frontend.select_datacenter') ?? 'اختر موقع مركز البيانات' }}
                                        </span>
                                    </label>
                                    
                                    <div class="relative">
                                        <select 
                                            id="datacenter_{{ $plan->id }}"
                                            name="datacenter"
                                            onchange="updatePriceWithDatacenter({{ $plan->id }})"
                                            class="w-full appearance-none {{ app()->getLocale() == 'ar' ? 'text-right pr-4 pl-12' : 'text-left pl-4 pr-12' }} py-3 text-sm font-semibold {{ $isPopular ? 'bg-white text-gray-900 border-white/50 hover:border-yellow-300 focus:border-yellow-400 shadow-lg' : 'bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600 focus:border-blue-500' }} border-2 rounded-xl focus:outline-none focus:ring-4 {{ $isPopular ? 'focus:ring-yellow-300/30' : 'focus:ring-blue-500/30' }} transition-all duration-300 cursor-pointer"
                                            dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}"
                                        >
                                            @foreach($plan->datacenter_locations as $location)
                                                @if(isset($datacenterInfo[$location]))
                                                    <option value="{{ $location }}" class="{{ $isPopular ? 'bg-white text-gray-900' : '' }}">
                                                        {{ $datacenterInfo[$location]['flag'] }} 
                                                        {{ app()->getLocale() == 'ar' ? $datacenterInfo[$location]['name_ar'] : $datacenterInfo[$location]['name_en'] }}
                                                        @if(isset($plan->datacenter_price[$location]) && $plan->datacenter_price[$location] > 0)
                                                            (+${{ $plan->datacenter_price[$location] }}/{{ __('frontend.month') }})
                                                        @endif
                                                    </option>
                                                @endif
                                            @endforeach
                                        ...
                                        <!-- Custom Arrow Icon -->
                                        <div class="absolute top-1/2 -translate-y-1/2 pointer-events-none {{ app()->getLocale() == 'ar' ? 'left-4' : 'right-4' }}">
                                            <svg class="w-4 h-4 {{ $isPopular ? 'text-gray-600' : 'text-gray-500 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"></path>
                                            </svg>
                                        </div>
                                    </div>
                            ...
                            <ul class="space-y-3 md:space-y-4 mb-6" id="features-list-{{ $plan->id }}">
                                @if(is_array($features) && count($features) > 0)
                                    @foreach($features as $featureIndex => $feature)
                                        <li class="flex items-start gap-2 md:gap-3 {{ $featureIndex >= 6 ? 'hidden feature-extra-' . $plan->id : '' }}" data-plan-id="{{ $plan->id }}">
                                            <svg class="w-4 h-4 md:w-5 md:h-5 {{ $isPopular ? 'text-yellow-400' : 'text-green-500' }} flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                            </svg>
                                            <span class="text-sm md:text-base {{ $isPopular ? 'text-white' : 'text-gray-700 dark:text-gray-300' }}" dir="auto">
                                                {{ is_array($feature) ? (app()->getLocale() == 'ar' ? ($feature['ar'] ?? $feature['en']) : ($feature['en'] ?? $feature['ar'])) : $feature }}
                                            </span>
                                        </li>
                                    @endforeach
                                @endif
                            ...
                            @if(is_array($features) && count($features) > 6)
                                <div class="text-center mb-4 md:mb-6">
                                    <button 
                                        onclick="toggleFeatures({{ $plan->id }})" 
                                        id="toggle-btn-{{ $plan->id }}"
                                        class="inline-flex items-center gap-2 px-3 md:px-4 py-2 {{ $isPopular ? 'bg-white/10 hover:bg-white/20 text-white border-white/30' : 'bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600' }} border rounded-lg text-xs md:text-sm font-medium transition-all duration-200"
                                    >
                                        <span id="toggle-text-{{ $plan->id }}">{{ __('frontend.show_more') }}</span>
                                        <svg id="toggle-icon-{{ $plan->id }}" class="w-3 h-3 md:w-4 md:h-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('products.show', $plan->id) }}" class="block w-full text-center px-4 md:px-6 py-3 md:py-4 {{ $isPopular ? 'bg-white text-blue-600' : 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white' }} font-bold text-sm md:text-base rounded-lg md:rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">{{ __('frontend.no_plans_available') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('frontend.no_plans_available_desc') }}</p>
                </div>
            @endif
    </div>
</section>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 border border-blue-100 dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
                ...
                <div class="flex items-start gap-3 md:gap-4 p-4 md:p-5 bg-white dark:bg-gray-800/50 rounded-xl md:rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="flex-1">
                        <h3 class="text-base md:text-lg font-bold text-gray-900 dark:text-white mb-1" dir="auto">
                            {{ __('frontend.free_ai_website_builder') }}
                        </h3>
                        <p class="text-sm md:text-base text-gray-600 dark:text-gray-400" dir="auto">
                            {{ __('frontend.easy_management') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 md:gap-4 p-4 md:p-5 bg-white dark:bg-gray-800/50 rounded-xl md:rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="flex-1">
                        <h3 class="text-base md:text-lg font-bold text-gray-900 dark:text-white mb-1" dir="auto">
                            {{ __('frontend.domain_privacy_protection') }}
                        </h3>
                        <p class="text-sm md:text-base text-gray-600 dark:text-gray-400" dir="auto">
                            {{ __('frontend.data_protection') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 md:gap-4 p-4 md:p-5 bg-white dark:bg-gray-800/50 rounded-xl md:rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="flex-1">
                        <h3 class="text-base md:text-lg font-bold text-gray-900 dark:text-white mb-1" dir="auto">
                            {{ __('frontend.free_auto_ssl') }}
                        </h3>
                        <p class="text-sm md:text-base text-gray-600 dark:text-gray-400" dir="auto">
                            {{ __('frontend.secure_your_site') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 md:gap-4 p-4 md:p-5 bg-white dark:bg-gray-800/50 rounded-xl md:rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="flex-1">
                        <h3 class="text-base md:text-lg font-bold text-gray-900 dark:text-white mb-1" dir="auto">
                            {{ __('frontend.free_cdn') }}
                        </h3>
                        <p class="text-sm md:text-base text-gray-600 dark:text-gray-400" dir="auto">
                            {{ __('frontend.true_stability') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 md:gap-4 p-4 md:p-5 bg-white dark:bg-gray-800/50 rounded-xl md:rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="flex-1">
                        <h3 class="text-base md:text-lg font-bold text-gray-900 dark:text-white mb-1" dir="auto">
                            {{ __('frontend.free_website_migration') }}
                        </h3>
                        <p class="text-sm md:text-base text-gray-600 dark:text-gray-400" dir="auto">
                            {{ __('frontend.move_site_hassle_free') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                ...
                <div class="mb-6 md:mb-8">
                    ...
                    <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3" dir="auto">
                        {{ __('frontend.ai_website_building') }}
                    </h2>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2" dir="auto">
                                {{ __('frontend.create_website_needs') }}
                            </h3>
                            <p class="text-sm md:text-base text-gray-600 dark:text-gray-400" dir="auto">
                                {{ __('frontend.create_website_needs_desc') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2" dir="auto">
                                {{ __('frontend.save_time_automation') }}
                            </h3>
                            <p class="text-sm md:text-base text-gray-600 dark:text-gray-400" dir="auto">
                                {{ __('frontend.save_time_automation_desc') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2" dir="auto">
                                {{ __('frontend.no_special_skills') }}
                            </h3>
                            <p class="text-sm md:text-base text-gray-600 dark:text-gray-400" dir="auto">
                                {{ __('frontend.no_special_skills_desc') }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-gray-900 dark:to-gray-900 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 border border-emerald-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2" dir="auto">
                                {{ __('frontend.automatic_patching') }}
                            </h3>
                            <p class="text-sm md:text-base text-gray-700 dark:text-gray-400" dir="auto">
                                {{ __('frontend.automatic_patching_desc') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2" dir="auto">
                                {{ __('frontend.proactive_defence') }}
                            </h3>
                            <p class="text-sm md:text-base text-gray-700 dark:text-gray-400" dir="auto">
                                {{ __('frontend.proactive_defence_desc') }}
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="group bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                <div class="mb-6">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white mb-3" dir="auto">
                        {{ __('frontend.turnback_time_autobackup') }}
                    </h3>
                    <p class="text-base text-gray-600 dark:text-gray-400" dir="auto">
                        {{ __('frontend.turnback_time_autobackup_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                <div class="mb-6">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white mb-3" dir="auto">
                        {{ __('frontend.build_website_ai') }}
                    </h3>
                    <p class="text-base text-gray-600 dark:text-gray-400" dir="auto">
                        {{ __('frontend.build_website_ai_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                <div class="mb-6">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white mb-3" dir="auto">
                        {{ __('frontend.deliver_content_fast') }}
                    </h3>
                    <p class="text-base text-gray-600 dark:text-gray-400" dir="auto">
                        {{ __('frontend.deliver_content_fast_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-700 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                <div class="mb-6">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white mb-3" dir="auto">
                        {{ __('frontend.free_cloud_storage_eu') }}
                    </h3>
                    <p class="text-base text-gray-600 dark:text-gray-400" dir="auto">
                        {{ __('frontend.free_cloud_storage_eu_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-700 hover:shadow-2xl hover:scale-105 transition-all duration-300 md:col-span-2 lg:col-span-1">
                <div class="mb-6">
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-white mb-3" dir="auto">
                        {{ __('frontend.sustainable_eu_datacenter') }}
                    </h3>
                    <p class="text-base text-gray-600 dark:text-gray-400" dir="auto">
                        {{ __('frontend.sustainable_eu_datacenter_desc') }}
                    </p>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div class="text-center mb-12 sm:mb-16">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">
                {{ __('frontend.shared_hosting_features') }}
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3">
                            {{ __('frontend.free_ssl_certificates') }}
                        </h3>
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.free_ssl_certificates_desc') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-750 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:scale-105">
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3">
                            {{ __('frontend.24_7_live_support') }}
                        </h3>
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.24_7_live_support_desc') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-750 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:scale-105">
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3">
                            {{ __('frontend.wordpress_and_cpanel') }}
                        </h3>
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.wordpress_and_cpanel_desc') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-gradient-to-br from-orange-50 to-red-50 dark:from-gray-800 dark:to-gray-750 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:scale-105">
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3">
                            {{ __('frontend.personalized_email_service') }}
                        </h3>
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.personalized_email_service_desc') }}
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div class="text-center mb-16">
            <div class="inline-flex items-center justify-center px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-full mb-6">
                <svg class="w-5 h-5 text-indigo-600 dark:text-indigo-400 {{ app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                </svg>
                <span class="text-indigo-600 dark:text-indigo-400 font-semibold">{{ __('frontend.pro_gineous_technology') }}</span>
            </div>
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                {{ __('frontend.zero_downtime_hosting') }}
            </h2>
            <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-300">
                {{ __('frontend.zero_downtime_subtitle') }}
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-indigo-200 dark:hover:border-indigo-700 hover:-translate-y-2">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        {{ __('frontend.uptime_guarantee') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.uptime_guarantee_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-700 hover:-translate-y-2">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        {{ __('frontend.redundant_infrastructure') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.redundant_infrastructure_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-green-200 dark:hover:border-green-700 hover:-translate-y-2">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        {{ __('frontend.instant_failover') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.instant_failover_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-orange-200 dark:hover:border-orange-700 hover:-translate-y-2">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        {{ __('frontend.load_balancing') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.load_balancing_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-purple-200 dark:hover:border-purple-700 hover:-translate-y-2">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        {{ __('frontend.proactive_monitoring') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.proactive_monitoring_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-teal-200 dark:hover:border-teal-700 hover:-translate-y-2">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        {{ __('frontend.business_continuity') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.business_continuity_desc') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-16 text-center">
            <div class="inline-flex items-center gap-3 px-6 py-3 bg-white dark:bg-gray-800 rounded-full shadow-lg">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-gray-700 dark:text-gray-300 font-semibold">{{ __('frontend.uptime_guarantee') }}</span>
                </div>
                <span class="text-gray-400">•</span>
                <span class="text-indigo-600 dark:text-indigo-400 font-bold">{{ __('frontend.pro_gineous_powered') }}</span>
            </div>
        </div>
    </div>
    </div>
...
<section class="py-16 sm:py-20 lg:py-24 bg-white dark:bg-gray-900">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div class="text-center mb-12 sm:mb-16">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">
                {{ __('frontend.price_comparison_title') }}
            </h2>
            <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-300">
                {{ __('frontend.price_comparison_subtitle') }}
            </p>
        </div>
            ...
            <div class="w-full">
                <div class="overflow-hidden shadow-xl rounded-2xl border border-gray-200 dark:border-gray-700">
                    <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-800 dark:to-gray-750">
                            <tr>
                                <th scope="col" class="px-4 py-4 text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wide">
                                    {{ __('frontend.hosting_provider') }}
                                </th>
                                <th scope="col" class="px-2 py-4 text-center text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wide">
                                    {{ __('frontend.starting_price') }}
                                </th>
                                <th scope="col" class="px-2 py-4 text-center text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wide">
                                    {{ __('frontend.renewal_price') }}
                                </th>
                                <th scope="col" class="px-2 py-4 text-center text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wide">
                                    {{ __('frontend.storage') }}
                                </th>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-2 border-indigo-500">
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="text-lg font-bold text-gray-900 dark:text-white">{{ __('frontend.pro_gineous') }}</div>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                                                {{ __('frontend.best_value') }}
                                            </span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-2 py-3 whitespace-nowrap text-center">
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-400">{{ __('frontend.per_month') }}</div>
                                </td>
                                <td class="px-2 py-3 whitespace-nowrap text-center">
                                ...
                                <td class="px-2 py-3 whitespace-nowrap text-center">
                                    <div class="text-lg font-bold text-gray-900 dark:text-white">30 {{ __('frontend.days') }}</div>
                                </td>
                            </tr>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-750">
                                ...
                                <td class="px-2 py-3 whitespace-nowrap text-center">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">30 {{ __('frontend.days') }}</div>
                                </td>
                            </tr>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        {{ __('frontend.price_comparison_note') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:hidden space-y-6 mb-12">
            ...
            <div class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-6 border-2 border-indigo-500 shadow-xl">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white">{{ __('frontend.pro_gineous') }}</h3>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                                {{ __('frontend.best_value') }}
                            </span>
                        </div>
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600 dark:text-gray-400">{{ __('frontend.starting_price') }}</span>
                        <span class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">$10.00{{ __('frontend.per_month') }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600 dark:text-gray-400">{{ __('frontend.renewal_price') }}</span>
                        <span class="text-lg font-semibold text-gray-900 dark:text-white">$10.00{{ __('frontend.per_month') }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600 dark:text-gray-400">{{ __('frontend.storage') }}</span>
                        <span class="font-semibold text-gray-900 dark:text-white">70GB SSD</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600 dark:text-gray-400">{{ __('frontend.free_domain') }}</span>
                        <svg class="w-6 h-6 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/>
                        </svg>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600 dark:text-gray-400">{{ __('frontend.money_back_guarantee') }}</span>
                        <span class="font-bold text-gray-900 dark:text-white">30 {{ __('frontend.days') }}</span>
                    </div>
                </div>
            </div>
            ...
            @foreach($competitors as $provider)
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-10 h-10 bg-{{ $provider['color'] }}-100 dark:bg-{{ $provider['color'] }}-900/30 rounded-lg flex items-center justify-center">
                        <span class="text-{{ $provider['color'] }}-600 dark:text-{{ $provider['color'] }}-400 font-bold">{{ substr($provider['name'], 0, 1) }}</span>
                    </div>
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-400">{{ __('frontend.starting_price') }}</span>
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $provider['start'] }}{{ __('frontend.per_month') }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-400">{{ __('frontend.renewal_price') }}</span>
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $provider['renewal'] }}{{ __('frontend.per_month') }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600 dark:text-gray-400">{{ __('frontend.storage') }}</span>
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $provider['storage'] }}</span>
                    </div>
                </div>
            </div>
            @endforeach
...
<section class="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-850 dark:to-gray-800">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div class="text-center mb-12 sm:mb-16">
            ...
            <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-300">
                {{ __('frontend.compare_our_plans_subtitle') }}
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border-2 border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('frontend.best_for_beginners') }}</p>
                <div class="mb-6">
                    <span class="text-5xl font-extrabold text-indigo-600 dark:text-indigo-400">$10</span>
                    <span class="text-xl text-gray-600 dark:text-gray-400">/{{ __('frontend.month') }}</span>
                </div>
                <a href="{{ route('register') }}?plan=startup" class="block w-full text-center px-6 py-3 text-base font-semibold text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                    {{ __('frontend.choose_plan') }}
                </a>
            </div>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-2xl p-8 shadow-2xl border-2 border-yellow-500 hover:shadow-3xl transition-all duration-300 transform scale-105">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('frontend.best_for_business') }}</p>
                <div class="mb-6">
                    <span class="text-5xl font-extrabold text-yellow-600 dark:text-yellow-400">$13</span>
                    <span class="text-xl text-gray-600 dark:text-gray-400">/{{ __('frontend.month') }}</span>
                </div>
                <a href="{{ route('register') }}?plan=essential" class="block w-full text-center px-6 py-3 text-base font-semibold text-white bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 shadow-lg hover:shadow-xl">
                    {{ __('frontend.choose_plan') }}
                </a>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border-2 border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('frontend.best_for_enterprises') }}</p>
                <div class="mb-6">
                    <span class="text-5xl font-extrabold text-indigo-600 dark:text-indigo-400">$19</span>
                    <span class="text-xl text-gray-600 dark:text-gray-400">/{{ __('frontend.month') }}</span>
                </div>
                <a href="{{ route('register') }}?plan=ultimate" class="block w-full text-center px-6 py-3 text-base font-semibold text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                    {{ __('frontend.choose_plan') }}
                </a>
            </div>
        </div>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4">
                        <h4 class="text-xl font-bold text-white flex items-center">
                            <svg class="w-6 h-6 {{ app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"/>
                            </svg>
                            {{ __('frontend.resources_performance') }}
                        </h4>
                    </div>
                    <div class="divide-y divide-gray-200 dark:divide-gray-700">
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.storage_space') }}</div>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.ram_memory') }}</div>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.cpu_cores') }}</div>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.bandwidth') }}</div>
                            <div class="text-center text-gray-900 dark:text-white font-medium">{{ __('frontend.unlimited') }}</div>
                            <div class="text-center bg-yellow-50 dark:bg-yellow-900/10 -mx-4 px-4 py-2 text-gray-900 dark:text-white font-medium">{{ __('frontend.unlimited') }}</div>
                            <div class="text-center text-gray-900 dark:text-white font-medium">{{ __('frontend.unlimited') }}</div>
                        </div>
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.performance_boost') }}</div>
                            <div class="text-center text-gray-900 dark:text-white font-medium">{{ __('frontend.up_to_2x') }}</div>
                            <div class="text-center bg-yellow-50 dark:bg-yellow-900/10 -mx-4 px-4 py-2 text-gray-900 dark:text-white font-medium">{{ __('frontend.up_to_5x') }}</div>
                            <div class="text-center text-gray-900 dark:text-white font-medium">{{ __('frontend.up_to_10x') }}</div>
                        </div>
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.monthly_visits') }}</div>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <div class="bg-gradient-to-r from-blue-600 to-cyan-600 px-6 py-4">
                        <h4 class="text-xl font-bold text-white flex items-center">
                            ...
                            {{ __('frontend.websites_email') }}
                        </h4>
                    </div>
                    <div class="divide-y divide-gray-200 dark:divide-gray-700">
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.number_of_websites') }}</div>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.email_accounts') }}</div>
                            <div class="text-center text-gray-900 dark:text-white font-medium">150</div>
                            <div class="text-center bg-yellow-50 dark:bg-yellow-900/10 -mx-4 px-4 py-2 text-gray-900 dark:text-white font-medium">200</div>
                            <div class="text-center text-gray-900 dark:text-white font-medium">350</div>
                        </div>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
                        <h4 class="text-xl font-bold text-white flex items-center">
                            ...
                            {{ __('frontend.advanced_features') }}
                        </h4>
                    </div>
                    <div class="divide-y divide-gray-200 dark:divide-gray-700">
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.free_cdn') }}</div>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.auto_backup') }}</div>
                            <div class="text-center">
                                <svg class="w-6 h-6 text-red-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"/>
                                </svg>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.cloud_storage') }}</div>
                            <div class="text-center">
                                <svg class="w-6 h-6 text-red-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"/>
                                </svg>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.dedicated_ip') }}</div>
                            <div class="text-center">
                                <svg class="w-6 h-6 text-red-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"/>
                                </svg>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.wordpress_ai_tools') }}</div>
                            <div class="text-center">
                                <svg class="w-6 h-6 text-red-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"/>
                                </svg>
                        ...
                        <div class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-750">
                            <div class="font-semibold text-gray-900 dark:text-white">{{ __('frontend.priority_support') }}</div>
                            <div class="text-center">
                                <svg class="w-6 h-6 text-red-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"/>
                                </svg>
                ...
                <div>
                    <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4">
                        <h4 class="text-xl font-bold text-white flex items-center">
                            ...
                            {{ __('frontend.included_all_plans') }}
                        </h4>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-start">
                                <svg class="w-5 h-5 text-green-500 {{ app()->getLocale() == 'ar' ? 'ml-2' : 'mr-2' }} mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/>
                                </svg>
                                <span class="text-sm text-gray-700 dark:text-gray-300">{{ __('frontend.' . $feature) }}</span>
                            </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="lg:hidden space-y-6 mt-12">
            <div class="text-center mb-6">
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">{{ __('frontend.all_plans_include') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('frontend.premium_features_included') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
                <div class="grid grid-cols-1 gap-3">
                    @foreach($standardFeatures as $feature)
                    <div class="flex items-start">
                        <svg class="w-5 h-5 text-green-500 {{ app()->getLocale() == 'ar' ? 'ml-3' : 'mr-3' }} mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/>
                        </svg>
                        <span class="text-sm text-gray-700 dark:text-gray-300">{{ __('frontend.' . $feature) }}</span>
                    </div>
                ...
                <div class="order-1 lg:order-2">
                    <div class="relative">
                        ...
                        <div class="relative bg-gradient-to-br from-blue-600 to-purple-700 rounded-2xl p-8 text-white">
                            ...
                            <h3 class="text-2xl font-bold mb-2">{{ __('frontend.blade_enclosure') }}</h3>
                            <p class="text-blue-100">{{ __('frontend.state_of_art_infrastructure') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div>
                    <div class="relative">
                        ...
                        <div class="relative bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl p-8 text-white">
                            ...
                            <h3 class="text-2xl font-bold mb-2">{{ __('frontend.developer_friendly') }}</h3>
                            <p class="text-green-100">{{ __('frontend.latest_software_versions') }}</p>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="inline-flex items-center justify-center px-4 py-2 mb-4 text-sm font-semibold text-green-600 bg-green-100 dark:bg-green-900/30 dark:text-green-400 rounded-full">
                        ...
                        {{ __('frontend.for_developers') }}
                    </div>
                    <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white mb-6">
                        {{ __('frontend.develop_with_ease') }}
                    </h2>
                    <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                        {{ __('frontend.develop_with_ease_desc') }}
                    </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1">
                    <div class="inline-flex items-center justify-center px-4 py-2 mb-4 text-sm font-semibold text-purple-600 bg-purple-100 dark:bg-purple-900/30 dark:text-purple-400 rounded-full">
                        ...
                        {{ __('frontend.security_reliability') }}
                    </div>
                    <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white mb-6">
                        {{ __('frontend.hosting_you_can_trust') }}
                    </h2>
                    <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                        {{ __('frontend.hosting_you_can_trust_desc') }}
                    </p>
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-1">{{ __('frontend.hosting_guarantee') }}</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('frontend.highest_quality_commitment') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="w-10 h-10 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-1">{{ __('frontend.account_isolation') }}</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('frontend.no_noisy_neighbor') }}</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="w-10 h-10 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 dark:text-white mb-1">{{ __('frontend.continuous_monitoring') }}</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('frontend.security_updates_2fa') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    <div class="relative">
                        ...
                        <div class="relative bg-gradient-to-br from-purple-600 to-pink-700 rounded-2xl p-8 text-white">
                            ...
                            <h3 class="text-2xl font-bold mb-2">{{ __('frontend.pro_gineous_guarantee') }}</h3>
                            <p class="text-purple-100">{{ __('frontend.excellence_in_hosting') }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full max-w-6xl xl:max-w-5xl 2xl:max-w-4xl mx-auto">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    {{ __('frontend.why_pro_gineous_desc') }}
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">
                        {{ __('frontend.expert_support_247') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.expert_support_247_desc') }}
                    </p>
                </div>
                ...
                <div class="group bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">
                        {{ __('frontend.uptime_guarantee_999') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.uptime_guarantee_999_desc') }}
                    </p>
                </div>
                ...
                <div class="group bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">
                        {{ __('frontend.lightning_fast_speed') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.lightning_fast_speed_desc') }}
                    </p>
                </div>
                ...
                <div class="group bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.daily_backups_desc') }}
                    </p>
                </div>
                ...
                <div class="group bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">
                        {{ __('frontend.easy_website_management') }}
                    </h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                        {{ __('frontend.easy_website_management_desc') }}
                    </p>
                </div>
                ...
                <div class="inline-flex flex-col sm:flex-row items-center gap-4 bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex-1 text-center sm:{{ app()->getLocale() == 'ar' ? 'text-right' : 'text-left' }}">
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            {{ __('frontend.join_thousands_customers') }}
                        </p>
                    </div>
                    <div class="flex-shrink-0">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        <div class="w-full max-w-4xl xl:max-w-3xl 2xl:max-w-3xl mx-auto">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white mb-6">
                    {{ __('frontend.frequently_asked_questions') }}
                </h2>
                <p class="text-lg text-gray-600 dark:text-gray-300">
                    {{ __('frontend.faq_desc') }}
                </p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_what_is_shared_hosting') }}
                        </span>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_what_is_shared_hosting_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_good_for_small_business') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_good_for_small_business_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_how_to_setup_account') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_how_to_setup_account_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_how_to_use_cpanel') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_how_to_use_cpanel_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_wordpress_compatible') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_wordpress_compatible_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_how_to_migrate') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_how_to_migrate_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_shared_vs_vps_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_server_location') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_server_location_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_which_plan_to_choose') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_which_plan_to_choose_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_is_secure_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_how_many_websites') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_how_many_websites_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_shared_vs_dedicated') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_shared_vs_dedicated_answer') }}
                        </p>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                        <span class="font-bold text-gray-900 dark:text-white text-lg flex-1 {{ app()->getLocale() == 'ar' ? 'ml-4' : 'mr-4' }}">
                            {{ __('frontend.faq_email_services') }}
                        </span>
                        <svg :class="{ 'rotate-180': open }" class="w-6 h-6 text-blue-600 dark:text-blue-400 transform transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-5">
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ __('frontend.faq_email_services_answer') }}
                        </p>
                    </div>
                </div>
            ...
            <div class="mt-12 text-center">
                <p class="text-gray-600 dark:text-gray-300 mb-6">
                    {{ __('frontend.faq_still_have_questions') }}
                </p>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
        ...
        <div class="text-center">
            ...
            <p class="text-xl text-blue-100 mb-12" dir="auto">
                {{ __('frontend.start_hosting_today') }}
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="#" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-bold rounded-xl border-2 border-white/30 hover:bg-white/20 transition-all duration-300">
                    ...
                    <span dir="auto">{{ __('frontend.contact_sales') }}</span>
                </a>
            </div>
        </div>
        </div>
...
function toggleFeatures(planId) {
    ...
    if (isHidden) {
        toggleText.textContent = '{{ __("frontend.show_less") }}';
        toggleIcon.style.transform = 'rotate(180deg)';
    } else {
        toggleText.textContent = '{{ __("frontend.show_more") }}';
        ...
        if (prices && prices[period]) {
            ...
            switch(period) {
                case 'monthly':
                    ...
                    periodText = '{{ __("frontend.per_month") }}';
                    break;
                case 'quarterly':
                    displayPrice = totalPrice + datacenterTotalCost;
                    periodText = '{{ __("frontend.per_quarter") }}';
                    break;
                case 'semiannually':
                    displayPrice = totalPrice + datacenterTotalCost;
                    periodText = '{{ __("frontend.per_6months") }}';
                    break;
                case 'annually':
                    displayPrice = totalPrice + datacenterTotalCost;
                    periodText = '{{ __("frontend.per_year") }}';
                    break;
                case 'biennially':
                    displayPrice = totalPrice + datacenterTotalCost;
                    periodText = '{{ __("frontend.per_2years") }}';
                    break;
                case 'triennially':
                    displayPrice = totalPrice + datacenterTotalCost;
                    periodText = '{{ __("frontend.per_3years") }}';
                    break;
            }
